...
ms.workload:
- cplusplus
ms.openlocfilehash: ddedce01fad8fd294e0b29fcc0008e8b18516cfd
...
---
# <a name="db"></a>DB
Ayırır ve isteğe bağlı olarak depolama baytını her biri için başlatır `initializer`. `DB` bir eş anlamlı olduğundan [bayt](../../assembler/masm/byte-masm.md)  
