...
---
# <a name="data"></a>.DATA
İle kullanıldığında [. MODEL](../../assembler/masm/dot-model.md), yakın veri kesimi başlatılmış verileri (kesim adı _DATA) başlatır.  
...
## <a name="see-also"></a>Ayrıca Bkz.  
 ...
 [. VERİ MU?](../../assembler/masm/dot-data-q.md)   
