---
title: Çalışma zamanı işleçleri | Microsoft Docs
ms.custom: ''
ms.date: 08/30/2018
ms.technology:
- cpp-masm
...
ms.locfileid: "43675984"
---
# <a name="run-time-operators"></a>Çalışma Zamanı İşleçleri

Microsoft makro Çevirici dil çalışma zamanı işleçleri hakkında daha fazla bilgi için bkz: [işleçler başvurusu](../../assembler/masm/operators-reference.md).
