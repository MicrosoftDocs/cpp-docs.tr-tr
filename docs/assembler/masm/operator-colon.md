...
Varsayılan kesimi geçersiz kılmaları *ifade* ile `segment`. `segment` Segment kaydı, grup adı, segment adı veya segment ifade olabilir. *İfade* bir sabit olmalıdır.  
