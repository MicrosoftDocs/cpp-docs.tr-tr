---
title: __Asm bloklarında derleme dili kullanma | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
ms.locfileid: "32050441"
---
# <a name="using-assembly-language-in-asm-blocks"></a>__asm Bloklarında Derleme Dili Kullanma
## <a name="microsoft-specific"></a>Microsoft'a Özgü  
 Satır içi derleyicisi çok diğer birleştiricileri ortak sahiptir. Örneğin, içinde MASM yasal herhangi bir ifade kabul eder. Bu bölümde assembly dili özelliklerinde kullanımını açıklar `__asm` engeller.  
