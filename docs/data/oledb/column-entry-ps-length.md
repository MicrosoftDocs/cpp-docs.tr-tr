...
## <a name="remarks"></a>Açıklamalar  
 Kesinlik ve ölçek bağlamak istediğiniz sütunun belirtmenize olanak tanır. Bu makrosu destekleyen *uzunluğu* değişkeni. Aşağıdaki konumlarda kullanılır:  
