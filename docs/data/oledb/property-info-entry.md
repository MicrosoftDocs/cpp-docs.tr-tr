...
## <a name="remarks"></a>Açıklamalar  
 Özellik değeri türü bu makrosu ayarlar `DWORD` ATLDB içinde tanımlanmış bir varsayılan değer. H. Bir değerine özellik ayarlamak için kullanın [PROPERTY_INFO_ENTRY_VALUE](../../data/oledb/property-info-entry-value.md). Ayarlamak için [VARTYPE](http://msdn.microsoft.com/en-us/317b911b-1805-402d-a9cb-159546bc88b4) ve [DBPROPFLAGS](https://msdn.microsoft.com/en-us/library/ms724342.aspx) aynı anda özelliği için kullanmak [PROPERTY_INFO_ENTRY_EX](../../data/oledb/property-info-entry-ex.md).  
