---
title: CCatalogs, Ccatalogınfo | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "33091592"
---
# <a name="ccatalogs-ccataloginfo"></a>CCatalogs, CCatalogInfo
Çağrı typedef sınıfı **CCatalogs** parametre sınıfı uygulamak için **Ccatalogınfo**.  
...
## <a name="remarks"></a>Açıklamalar  
 ...
 Bu sınıf, kataloglar DBMS erişilebilir ile ilişkili fiziksel öznitelikleri tanımlar.  
  
 Aşağıdaki tabloda, sınıf veri üyeleri ve bunların karşılık gelen OLE DB sütunlarını listeler. Bkz: [CATALOGS satır kümesi](https://msdn.microsoft.com/en-us/library/ms721241.aspx) içinde *OLE DB Programcının Başvurusu* şemayı ve sütunları hakkında daha fazla bilgi.  
