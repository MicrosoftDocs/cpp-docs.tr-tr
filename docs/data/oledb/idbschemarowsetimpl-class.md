...
Şema satır kümeleri hakkında daha fazla bilgi için bkz: [şema satır kümeleri](/previous-versions/windows/desktop/ms712921) içinde *OLE DB Programcının Başvurusu*.
...
Şema satır kümeleri hakkında daha fazla bilgi için bkz. [IDBSchemaRowset](/previous-versions/windows/desktop/ms713686) içinde *OLE DB Programcının Başvurusu* Windows SDK.
...
*rgPropertySets*<br/>
[in] Bir dizi [DBPROPSET](/previous-versions/windows/desktop/ms714367) yapıları ayarlanan özellikleri belirtin.
...
*rgPropertySets*<br/>
[daraltma/genişletme] Bir dizi [DBPROPSET](/previous-versions/windows/desktop/ms714367) yapılar yeni oluşturulan şeması satır kümesi üzerinde ayarlamak için.
...
Bkz: [IDBSchemaRowset::GetRowset](/previous-versions/windows/desktop/ms722634) Windows SDK içinde.
...
Bu yöntem, sağlayıcı tarafından desteklenen tüm şema satır kümeleri bir dizi döndürür. Bkz: [IDBSchemaRowset::GetSchemas](/previous-versions/windows/desktop/ms719605) Windows SDK içinde.
