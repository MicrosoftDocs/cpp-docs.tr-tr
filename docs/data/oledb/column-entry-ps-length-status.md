...
## <a name="remarks"></a>Açıklamalar  
 Kesinlik ve ölçek bağlamak istediğiniz sütunun belirtmenize olanak tanır. Uzunluğu ve durumu değişkenlerini destekle istediğinizde bu makrosu kullanın. Aşağıdaki konumlarda kullanılır:  
