---
title: Ierrorrecordsımpl::getrecordcount | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
#### <a name="parameters"></a>Parametreler  
 Bkz: [IErrorRecords::GetRecordCount](https://msdn.microsoft.com/en-us/library/ms722724.aspx) içinde *OLE DB Programcının Başvurusu*.  
