---
title: Idbınitializeımpl::Initialize | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "33100336"
---
# <a name="idbinitializeimplinitialize"></a>IDBInitializeImpl::Initialize
Veri kaynağı nesnesi özellik desteği hazırlayarak başlatır.  
...
## <a name="remarks"></a>Açıklamalar  
 Bkz: [IDBInitialize::Initialize](https://msdn.microsoft.com/en-us/library/ms718026.aspx) içinde *OLE DB Programcının Başvurusu*.  
