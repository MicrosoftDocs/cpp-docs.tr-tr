---
title: CForeignKeys, Cforeignkeysınfo | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "33098341"
---
# <a name="cforeignkeys-cforeignkeysinfo"></a>CForeignKeys, CForeignKeysInfo
Çağrı typedef sınıfı **CForeignKeys** parametre sınıfı uygulamak için **Cforeignkeysınfo**.  
...
## <a name="remarks"></a>Açıklamalar  
 ...
 Bu sınıf Kataloğu'nda belirli bir kullanıcı tarafından tanımlanan yabancı anahtar sütunlarını tanımlar.  
  
 Aşağıdaki tabloda, sınıf veri üyeleri ve bunların karşılık gelen OLE DB sütunlarını listeler. Bkz: [FOREIGN_KEYS satır kümesi](https://msdn.microsoft.com/en-us/library/ms711276.aspx) içinde *OLE DB Programcının Başvurusu* şemayı ve sütunları hakkında daha fazla bilgi.  
