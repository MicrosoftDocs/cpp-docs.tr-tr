...
ms.locfileid: "33096918"
---
# <a name="crowsetreleaserows"></a>CRowset::ReleaseRows
Çağrıları [IRowset::ReleaseRows](https://msdn.microsoft.com/en-us/library/ms719771.aspx) geçerli satır tanıtıcısı serbest bırakmak için.  
