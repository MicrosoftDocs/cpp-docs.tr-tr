...
- Kayıt kümesini parametreleştirme. Fiili çalışma zamanı parametre değeri, sonra filtre belirtin. Daha fazla bilgi için [kayıt kümesi: Kayıt Kümesini Parametreleştirme (ODBC)](../data/odbc/recordset-parameterizing-a-recordset-odbc.md)
