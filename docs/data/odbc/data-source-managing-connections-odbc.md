...
2.  Üzerinde **DSN dosyası** sekmesinde **Ekle**.  
  
3.  İçinde **yeni veri kaynağı oluştur** iletişim kutusu, bir Excel sürücüsünü seçin ve ardından **sonraki**.  
  
4.  Tıklayın **Gözat**ve veri kaynağı olarak kullanılacak dosya adını seçin.  
...
2.  İçinde **ODBC Microsoft Excel Kurulumu** iletişim kutusunda, veritabanı sürümünü ve çalışma kitabını seçin.  
...
2.  Çağrı, `OpenEx` veya `Open` üye işlevi.  
...
2.  Yeniden kullanmak istemiyorsanız nesneyi yok edin.  
...
2.  Çağrı nesneyi yok etmek yerine kendi `OpenEx` veya `Open` yeniden üye işlevi.  
