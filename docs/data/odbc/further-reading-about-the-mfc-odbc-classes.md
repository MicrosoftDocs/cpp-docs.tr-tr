---
title: MFC ODBC sınıfları hakkında daha fazla okuma | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
-   [İşlem (ODBC)](../../data/odbc/transaction-odbc.md)  
 ...
 Okumaya başlamak için iyi bir yer olan [kayıt kümesi (ODBC)](../../data/odbc/recordset-odbc.md).  
