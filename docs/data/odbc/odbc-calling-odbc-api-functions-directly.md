---
title: 'ODBC: ODBC API işlevlerini doğrudan çağırma'
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "59026389"
---
# <a name="odbc-calling-odbc-api-functions-directly"></a>ODBC: ODBC API işlevlerini doğrudan çağırma
...
Bu adımlar hakkında daha fazla bilgi için bkz. [açık veritabanı bağlantısı (ODBC)](/sql/odbc/microsoft-open-database-connectivity-odbc) SDK'sı MSDN belgelerinde.
