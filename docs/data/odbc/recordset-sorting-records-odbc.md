...
3.  Bir filtre, kilitleme modu veya parametreleri gibi gereken diğer seçeneklerini ayarlayın.  
  
4.  Çağrı `Open` yeni nesne için (veya `Requery` var olan bir nesne için).  
