...
> [!NOTE]
> Visual Studio 2015 kullanıyorsanız bkz. [ınstall çoklu platform mobil uygulama geliştirme için Visual C++ (Visual studio 2015)](install-visual-cpp-for-cross-platform-mobile-development.md?view=vs-2015)
