---
title: auto_handle üyeleri | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
ms.locfileid: "33106251"
---
# <a name="autohandle-members"></a>auto_handle Üyeleri
Üyeleri `auto_handle`.  
...
## <a name="see-also"></a>Ayrıca Bkz.  
 [auto_handle sınıfı](../dotnet/auto-handle-class.md)   
