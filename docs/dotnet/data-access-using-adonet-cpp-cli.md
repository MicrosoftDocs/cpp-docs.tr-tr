---
title: ADO.NET kullanarak veri erişim (C + +/ CLI) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
|Bölüm|Açıklama|  
|-------------|-----------------|  
|[ADO.NET](/dotnet/framework/data/adonet/index)|ADO.NET, veri erişim hizmetleri için .NET Programcı kullanıma sınıfları kümesi genel bir bakış sağlar.|  
