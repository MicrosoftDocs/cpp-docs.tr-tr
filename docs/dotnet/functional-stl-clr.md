...
|[böler (STL/CLR)](../dotnet/divides-stl-clr.md)|Functor bölün.|  
|[equal_to (STL/CLR)](../dotnet/equal-to-stl-clr.md)|Karşılaştırma functor eşit.|  
|[büyük (STL/CLR)](../dotnet/greater-stl-clr.md)|Büyük karşılaştırma functor.|  
|[greater_equal (STL/CLR)](../dotnet/greater-equal-stl-clr.md)|Büyük veya eşit karşılaştırma functor.|  
|[daha az (STL/CLR)](../dotnet/less-stl-clr.md)|Daha az karşılaştırma functor.|  
...
|[(STL/CLR)](../dotnet/minus-stl-clr.md)|Functor çıkarın.|  
|[mod (STL/CLR)](../dotnet/modulus-stl-clr.md)|Modulus functor.|  
|[çarpar (STL/CLR)](../dotnet/multiplies-stl-clr.md)|Functor çarpın.|  
...
|[artı (STL/CLR)](../dotnet/plus-stl-clr.md)|Functor ekleyin.|  
