...
## <a name="remarks"></a>Açıklamalar  
 Üye işlevi boş denetimli dizisi için true değerini döndürür. Eşdeğer olan [deque::size (STL/CLR)](../dotnet/deque-size-stl-clr.md)`() == 0`. Deque boş olup olmadığını sınamak için kullanın.  
