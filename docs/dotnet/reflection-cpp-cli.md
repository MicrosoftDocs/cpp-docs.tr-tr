...
## <a name="example-enumeration-of-types"></a>Örnek: numaralandırma türleri
...
## <a name="example-inspection-of-assemblies"></a>Örnek: inceleme derlemeleri
