...
|[Kopyala (STL/CLR)](../dotnet/copy-stl-clr.md)|İleri yönde yineleme bir hedef aralığı için bir kaynak aralığı değerleri kopyalar.|  
...
|[eşit (STL/CLR)](../dotnet/equal-stl-clr.md)|İki aralıkları, öğe karşılaştırır.|  
...
|[Bul (STL/CLR)](../dotnet/find-stl-clr.md)|Belirtilen bir değerin ilk oluşum konumunu döndürür.|  
...
|[(STL/CLR) oluştur](../dotnet/generate-stl-clr.md)|Değerleri dizisindeki her öğe için bir işlev nesnesi tarafından üretilen değerler atar.|  
...
|[(STL/CLR) içerir](../dotnet/includes-stl-clr.md)|Bir sıralanmış aralık ikinci bir sıralanmış aralıktaki tüm öğeleri içeren olup olmadığını sınar.|  
...
|[Uyumsuzluk (STL/CLR)](../dotnet/mismatch-stl-clr.md)|İki aralıkları öğe karşılaştırır ve bir fark oluştuğu ilk konumunu döndürür.|  
...
|[Bölüm (STL/CLR)](../dotnet/partition-stl-clr.md)|Birli koşul karşılamak bu öğeleri karşılamayı başarısız olmuş öncesinde, bir aralıktaki öğeleri düzenler.|  
...
|[Kaldır (STL/CLR)](../dotnet/remove-stl-clr.md)|Kalan öğelerin sırasını etkilemeden arasında belirli bir aralık belirtilen bir değeri siler ve yeni bir aralık belirtilen değerinin boş sonunu döndürür.|  
...
|[Ters (STL/CLR)](../dotnet/reverse-stl-clr.md)|Bir aralık içindeki öğelerin sırasını tersine çevirir.|  
...
|[Döndür (STL/CLR)](../dotnet/rotate-stl-clr.md)|İki bitişik aralık içindeki öğeleri birbiriyle değiştirir.|  
...
|[Arama (STL/CLR)](../dotnet/search-stl-clr.md)|Öğeleri verili bir öğe dizisi içindekilerle eşit olan veya öğeleri verili bir dizi öğe için ikili bir koşula göre belirtildiği şekilde denk olan bir hedef aralığındaki dizinin ilk geçtiği yeri arar.|  
...
|[Sırala (STL/CLR)](../dotnet/sort-stl-clr.md)|Belirtilen bir aralıktaki öğeleri azalmayan şekilde veya bir ikili koşul tarafından belirtilen bir sıralama ölçütüne göre düzenler.|  
...
|[takas (STL/CLR)](../dotnet/swap-stl-clr.md)|İlk nesnenin içeriğini ikinci nesneye ve ikinci nesneni içeriğini birinciye atayarak, nesnelerin iki türü arasındaki öğelerin değerlerini birbiriyle değiştirir.|  
...
|[Dönüşüm (STL/CLR)](../dotnet/transform-stl-clr.md)|Belirtilen işlev nesnesini bir kaynak aralıktaki her bir öğeye veya iki kaynak aralıktaki bir öğe çiftine uygular ve işlev nesnenin dönüş değerlerini bir hedef aralığa kopyalar.|  
|[benzersiz (STL/CLR)](../dotnet/unique-stl-clr.md)|Belirli bir aralıktaki birbirine bitişik yinelenen öğeleri kaldırır.|  
