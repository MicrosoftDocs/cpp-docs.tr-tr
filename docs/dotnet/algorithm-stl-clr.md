...
|İşlev|Açıklama|  
|--------------|-----------------|  
|[adjacent_find (STL/CLR)](#adjacent_find)|Eşit iki bitişik öğeleri arar.|  
|[binary_search (STL/CLR)](#binary_search)|Bir sıralanmış sırası belirli bir değeri içerip içermediğini sınar.|  
|[copy (STL/CLR)](#copy)|İleri yönde yineleme bir hedef aralığı için bir kaynak aralığı değerleri kopyalar.|  
|[copy_backward (STL/CLR)](#copy_backward)|Geriye dönük yönde yineleme bir hedef aralığı için kaynak aralık değerleri kopyalar.|  
...
|[equal (STL/CLR)](#equal)|İki aralıkları, öğe karşılaştırır.|  
|[equal_range (STL/CLR)](#equal_range)|Sıralı değerler arar ve belirli bir öğenin tüm eşit değerlerin bir değişkene sınırlandırmak iki konumlarını döndürür.|  
|[fill (STL/CLR)](#fill)|Aynı yeni değeri belirtilen bir aralıktaki her öğeye atar.|  
|[fill_n (STL/CLR)](#fill_n)|Yeni bir değer bir aralık başına öğeleri belirli bir öğesiyle belirtilen sayıda atar.|  
|[find (STL/CLR)](#find)|Belirtilen bir değerin ilk oluşum konumunu döndürür.|  
|[find_end (STL/CLR)](#find_end)|Belirtilen sıra için aynı olan bir aralıkta son değişkene döndürür.|  
|[find_first_of (STL/CLR)](#find_first_of)|Öğe verilen aralığını herhangi birinin ilk a geçişi için bir aralığı arar.|  
|[find_if (STL/CLR)](#find_if)|İlk öğenin konumunu burada öğesi belirtilen bir koşula uygun değerleri bir dizi döndürür.|  
|[for_each (STL/CLR)](#for_each)|Belirtilen işlev nesnesi değerleri dizisindeki her öğesine uygular ve işlev nesnesi döndürür.|  
|[generate (STL/CLR)](#generate)|Değerleri dizisindeki her öğe için bir işlev nesnesi tarafından üretilen değerler atar.|  
|[generate_n (STL/CLR)](#generate_n)|Belirtilen sayıda öğeyi işlevi nesnesine tarafından üretilen değerler atar.|  
|[includes (STL/CLR)](#includes)|Bir sıralanmış aralık ikinci bir sıralanmış aralıktaki tüm öğeleri içeren olup olmadığını sınar.|  
|[inplace_merge (STL/CLR)](#inplace_merge)|İki ardışık sıralanmış aralıkları öğeleri tek bir sıralanmış aralığına birleştirir.|  
|[iter_swap (STL/CLR)](#iter_swap)|Belirtilen yineleyicilerin bir çifti tarafından başvurulan iki değeri birbiriyle değiştirir.|  
|[lexicographical_compare (STL/CLR)](#lexicographical_compare)|İki dizileri, hangi iki daha düşük bir dizidir tanımlayan öğe, karşılaştırır.|  
|[lower_bound (STL/CLR)](#lower_bound)|Belirtilen değere eşit veya daha büyük bir değere sahip sıralı değerlerin ilk öğenin konumunu bulur.|  
|[make_heap (STL/CLR)](#make_heap)|Öğeleri belirtilen bir aralıktan ilk öğe öbek üzerinde en büyük olduğu yığına dönüştürür.|  
|[max (STL/CLR)](#max))|İki nesneyi karşılaştırır ve büyük iki döndürür.|  
|[max_element (STL/CLR)](#max_element)|En büyük öğeyi değerlerin belirtilen sırayla bulur.|  
|[Merge (STL/CLR)](#merge))|İki sıralanmış kaynak aralığı tüm öğeleri bir tek, sıralanmış hedef aralığına birleştirir.|  
|[min (STL/CLR)](#min)|İki nesneyi karşılaştırır ve küçük iki döndürür.|  
|[min_element (STL/CLR)](#min_element)|En küçük öğeyi değerlerin belirtilen sırayla bulur.|  
|[mismatch (STL/CLR)](#mismatch)|İki aralıkları öğe karşılaştırır ve bir fark oluştuğu ilk konumunu döndürür.|  
|[next_permutation (STL/CLR)](#next_permutation)|Böylece özgün sıralama varsa lexicographically sonraki büyük nesne tarafından değiştirilir bir aralıkta öğeleri yeniden sıralar.|  
|[nth_element (STL/CLR)](#nth_element)|Öğeleri doğru bulma, bir dizi bölümler `n`th öğesi dizisi böylece, önünde tüm öğeleri değerden küçük veya bu değere eşit olan ve onu izleyen tüm öğeleri değerinden büyük veya ona eşit.|  
|[partial_sort (STL/CLR)](#partial_sort)|Belirtilen sayıda küçük öğeyi bir aralıkta nondescending düzeni içinde düzenler.|  
|[partial_sort_copy (STL/CLR)](#partial_sort_copy)|Kaynak aralığı öğeleri sıralı şekilde öğelerini bir kaynak aralığından bir hedef aralığına kopyalar.|  
|[partition (STL/CLR)](#partition)|Birli koşul karşılamak bu öğeleri karşılamayı başarısız olmuş öncesinde, bir aralıktaki öğeleri düzenler.|  
|[pop_heap (STL/CLR)](#pop_heap)|En büyük öğeyi yığın Önden sonuna taşır ve yeni bir öbek kalan öğelerden oluşturur.|  
|[prev_permutation (STL/CLR)](#prev_permutation)|Böylece özgün sıralama varsa lexicographically önceki büyük nesne tarafından değiştirilir öğelerinin bir dizisini yeniden sıralar.|  
|[push_heap (STL/CLR)](#push_heap)|Aralığın sonundaki bir öğeyi aralıktaki önceki öğeleri içeren mevcut yığına ekler.|  
|[random_shuffle (STL/CLR)](#random_shuffle)|Bir dizi yeniden düzenler `N` birini aralığına öğelerinde `N`! olası düzenlemeleri rastgele seçilmiş.|  
|[remove (STL/CLR)](#remove)|Kalan öğelerin sırasını etkilemeden arasında belirli bir aralık belirtilen bir değeri siler ve yeni bir aralık belirtilen değerinin boş sonunu döndürür.|  
|[remove_copy (STL/CLR)](#remove_copy)|Belirtilen bir değeri öğeleri, kalan öğelerin sırasını etkilemeden kopyalanmaz dışında öğelerini hedef aralığı için bir kaynak aralığından kopyalar.|  
|[remove_copy_if (STL/CLR)](#remove_copy_if)|Kalan öğelerin sırasını etkilemeden bir koşulu karşılayan olanlar dışında bir hedef aralığı kaynak aralığından öğelerine kopyalar.|  
|[remove_if (STL/CLR)](#remove_if)|Kalan öğelerin sırasını etkilemeden bir koşul belirli bir aralıktan karşılamak öğeleri siler. biçimindeki telefon numarasıdır.|  
|[replace (STL/CLR)](#replace)|Yeni bir değer belirli bir değerle eşleşen öğeleri bir aralıkta yerini alır.|  
|[replace_copy (STL/CLR)](#replace_copy)|Yeni bir değer belirli bir değerle eşleşen öğeleri değiştirme hedef aralığı, bir kaynak aralıktan öğelerine kopyalar.|  
...
|[reverse_copy (STL/CLR)](#reverse_copy)|Bir hedef aralığına kopyalarken bir kaynak aralıkta öğelerin sırasını tersine çevirir.|  
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `adjacent_find`. Daha fazla bilgi için bkz: [adjacent_find](../standard-library/algorithm-functions.md#adjacent_find).
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `fill`. Daha fazla bilgi için bkz: [dolgu](../standard-library/algorithm-functions.md#fill). 
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `fill_n`. Daha fazla bilgi için bkz: [fill_n](../standard-library/algorithm-functions.md#fill_n).  
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `find`. Daha fazla bilgi için bkz: [Bul](../standard-library/algorithm-functions.md#find). 
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `find_end`. Daha fazla bilgi için bkz: [find_end](../standard-library/algorithm-functions.md#find_end).  
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `find_if`. Daha fazla bilgi için bkz: [find_if](../standard-library/algorithm-functions.md#find_if). 
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `generate`. Daha fazla bilgi için bkz: [oluşturmak](../standard-library/algorithm-functions.md#generate).  
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `generate_n`. Daha fazla bilgi için bkz: [generate_n](../standard-library/algorithm-functions.md#generate_n).  
 
## <a name="includes"></a> (STL/CLR) içerir
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `iter_swap`. Daha fazla bilgi için bkz: [iter_swap](../standard-library/algorithm-functions.md#iter_swap).  
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `push_heap`. Daha fazla bilgi için bkz: [push_heap](../standard-library/algorithm-functions.md#push_heap).  
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `remove_copy`. Daha fazla bilgi için bkz: [remove_copy](../standard-library/algorithm-functions.md#remove_copy).  
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `reverse`. Daha fazla bilgi için bkz: [ters](../standard-library/algorithm-functions.md#reverse).  

## <a name="reverse_copy"></a> reverse_copy (STL/CLR)
Bir hedef aralığına kopyalarken bir kaynak aralıkta öğelerin sırasını tersine çevirir.  
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `reverse_copy`. Daha fazla bilgi için bkz: [reverse_copy](../standard-library/algorithm-functions.md#reverse_copy).  
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `rotate`. Daha fazla bilgi için bkz: [döndürme](../standard-library/algorithm-functions.md#rotate).  
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `rotate_copy`. Daha fazla bilgi için bkz: [rotate_copy](../standard-library/algorithm-functions.md#rotate_copy).  
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `set_difference`. Daha fazla bilgi için bkz: [set_difference](../standard-library/algorithm-functions.md#set_difference).
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `sort_heap`. Daha fazla bilgi için bkz: [sort_heap](../standard-library/algorithm-functions.md#sort_heap).  
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `swap`. Daha fazla bilgi için bkz: [takas](http://msdn.microsoft.com/Library/b471a2de-035e-4aff-b1c7-345d85d93972).  
...
### <a name="remarks"></a>Açıklamalar  
 Bu işlev C++ Standart Kitaplığı işlevi ile aynı şekilde davranır `swap_ranges`. Daha fazla bilgi için bkz: [swap_ranges](../standard-library/algorithm-functions.md#swap_ranges).  
