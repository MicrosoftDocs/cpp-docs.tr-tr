---
title: Dosya işleme ve t-O (C + +/ CLI) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
.NET Framework kullanılarak çeşitli dosya işlemlerini gösterir.  
 ...
 Aşağıdaki konular tanımlanan sınıflar kullanımını göstermek <xref:System.IO> çeşitli gerçekleştirmek için ad alanı dosya işlemi.  
