---
title: 'Nasıl yapılır: C + başvuruları izleme kullanmak +/ CLI | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
ms.locfileid: "33132472"
---
# <a name="how-to-use-tracking-references-in-ccli"></a>Nasıl yapılır: C++/CLI Üzerinde İzleme Başvurularını Kullanma
Bu makalede izleme başvurusu (%) C + kullanmayı gösterir +/ CLI ortak dil çalışma zamanı (CLR) türleri başvuruya göre geçirin.  
  
## <a name="to-pass-clr-types-by-reference"></a>CLR Türleri başvuruya göre geçirmek için  
 Aşağıdaki örnek izleme başvurusu CLR Türleri başvuruya göre geçirmek için nasıl kullanılacağını gösterir.  
...
```  
 ...
 Sonraki örnek döndürür alma izleme başvurusu adresini gösterir bir [interior_ptr (C + +/ CLI)](../windows/interior-ptr-cpp-cli.md)ve değiştirme ve izleme başvurusu verilere gösterilmektedir.  
...
## <a name="tracking-references-and-interior-pointers"></a>İzleme başvuruları ve iç işaretçiler  
 Aşağıdaki kod örneği, izleme başvuruları ve iç işaretçiler arasında dönüştürme olduğunu gösterir.  
...
## <a name="tracking-references-and-value-types"></a>İzleme başvuruları ve değer türleri  
 Bu örnek bir değer türü izleme başvuru aracılığıyla basit kutulama gösterir:  
...
```  
 ...
 Sonraki örnek izleme başvurularını ve değer türleri için yerel başvuruları olabileceğini gösterir.  
...
```  
 ...
 Aşağıdaki örnek, izleme başvuruları değer türleri ve yerel türleri ile birlikte kullanabileceğiniz gösterir.  
...
```  
 ...
 Bu örnek, bir değer türü izleme başvuru atık toplanan yığında bağlayabilirsiniz göstermektedir:  
...
## <a name="template-functions-that-take-native-value-or-reference-parameters"></a>Yerel alan şablon işlevleri, değer veya başvuru parametreleri  
 Bir şablon işlevi imzada izleme başvurusu kullanarak işlevi parametresi türü yerel olan, CLR değeri veya CLR başvuru tarafından çağrılabilir emin olun.  
