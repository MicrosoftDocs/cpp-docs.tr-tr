...
2.  ' Nde proje düğümüne sağ tıklayarak bunu yapabilirsiniz, mfcmifc80.dll'ye bir başvuru ekleyin **Çözüm Gezgini**u seçerek **Ekle**, **başvuru**, öğesine göz atarak Microsoft Visual Studio 10.0\VC\atlmfc\lib.  
  
3.  UserControl1.Designer.cs açın ve aşağıdaki deyimi kullanarak:  
  
    ```  
    using Microsoft.VisualC.MFC;  
    ```  
  
4.  Ayrıca, UserControl1.Designer.cs'te şu satırı değiştirin:  
...
5.  Bu sınıf tanımının ilk satırı olarak ekleyin `UserControl1`:  
  
    ```  
    private ICommandSource m_CmdSrc;  
    ```  
  
6.  Eklemek için aşağıdaki yöntem tanımlarını `UserControl1` (MFC denetiminin Kimliğini sonraki adımda oluşturacağız):  
...
7.  Oluşturduğunuz MFC uygulamasını açınız [nasıl yapılır: kullanıcı Denetim ve konak MDI görünümü oluşturma](../dotnet/how-to-create-the-user-control-and-host-mdi-view.md).  
  
8.  Açacak bir menü seçeneği ekleyin `singleMenuHandler`.  
...
## <a name="see-also"></a>Ayrıca Bkz.  
 [MFC görünümü olarak bir Windows Forms kullanıcı denetimi barındırma](../dotnet/hosting-a-windows-forms-user-control-as-an-mfc-view.md)   
