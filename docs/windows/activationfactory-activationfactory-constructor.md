---
title: ActivationFactory::ActivationFactory Oluşturucusu | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33854944"
---
# <a name="activationfactoryactivationfactory-constructor"></a>ActivationFactory::ActivationFactory Oluşturucusu
ActivationFactory sınıfı başlatır.  
