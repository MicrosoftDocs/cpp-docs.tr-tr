...
Yeniden dağıtılabilir Visual yüklenmesini etkinleştirmek için birleştirme modüllerini kullanabilirsiniz C++ DLL'leri %SYSTEMROOT%\system32\ klasörüne. (Visual Studio kendisi bu tekniği kullanır.) Bununla birlikte, yüklemeyi yapan kullanıcı yönetici haklarına sahip değilse, bu klasöre yükleme başarısız olur.
