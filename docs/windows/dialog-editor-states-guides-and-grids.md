---
title: İletişim kutusu Düzenleyicisi durumları (Kılavuzlar ve Izgaralar) (C++) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
- [Kılavuzdaki Denetimleri Hizalama](../windows/aligning-controls-on-a-guide.md)

- [Kılavuzları Devre Dışı Bırakma](../windows/disabling-guides.md)
