...
## <a name="resources"></a>Kaynaklar  
 Visual C++ tüm Visual Studio sürümlerinde bulunur. Visual Studio hakkında daha fazla bilgi için bkz: [Visual Studio](http://www.visualstudio.com/) Web sitesi.  
  
 İçin [!INCLUDE[win81](../misc/includes/win81_md.md)], DirectX Windows SDK'da yer almaktadır. Ekstra bir şey indirmek zorunda değilsiniz. Daha fazla bilgi için bkz: [DirectX SDK nerede?](http://msdn.microsoft.com/library/windows/desktop/ee663275.aspx).  
