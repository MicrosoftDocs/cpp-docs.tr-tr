---
title: "Oluşturma, taşıma ve düzenleme araç çubuğu düğmeleri | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
-   [Araç çubuğu kaynağı düğmeleri kopyalama](../windows/copying-buttons-from-a-toolbar.md)  
