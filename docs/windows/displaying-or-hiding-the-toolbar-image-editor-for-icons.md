---
title: Görüntüleme veya gizleme (simgeler için görüntü Düzenleyicisi) araç | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
### <a name="to-display-or-hide-the-image-editor-toolbar"></a>Görüntü Düzenleyicisi araç gizleyin veya gösterin için  
  
1.  Üzerinde **Görünüm** menüsünü tıklatın **araç çubukları** ardından **görüntü Düzenleyicisi**.  
