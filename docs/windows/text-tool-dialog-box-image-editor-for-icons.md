---
title: Metin aracı iletişim kutusu (simgeler için görüntü Düzenleyicisi) (C++)
ms.date: 11/04/2016
f1_keywords:
- vc.editors.texttool
helpviewer_keywords:
...
ms.locfileid: "50553653"
---
# <a name="text-tool-dialog-box-c-image-editor-for-icons"></a>Metin aracı iletişim kutusu (simgeler için görüntü Düzenleyicisi) (C++)
...
Açılır [metin aracı yazı tipi iletişim kutusu](../windows/text-tool-font-dialog-box-image-editor-for-icons.md), hangi değiştirebilirsiniz yazı tipini, stili veya imleç yazı tipi boyutu. Değişiklikleri görüntülenen metni uygulanır **metin** alan.
