---
title: 'Simgeler ve İmleçler: Görüntü kaynakları (simgeler için görüntü Düzenleyicisi C++) görüntüleme cihazları için'
ms.date: 11/04/2016
f1_keywords:
- vc.editors.icon
...
ms.locfileid: "55849952"
---
# <a name="icons-and-cursors-image-resources-for-display-devices-c-image-editor-for-icons"></a>Simgeler ve İmleçler: Görüntü kaynakları (simgeler için görüntü Düzenleyicisi C++) görüntüleme cihazları için
