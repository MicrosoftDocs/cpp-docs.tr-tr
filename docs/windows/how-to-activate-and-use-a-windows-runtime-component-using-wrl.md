...
> [!NOTE]
>  Bu örnek, bir yerleşik Windows çalışma zamanı bileşeni etkinleştirir. Benzer şekilde etkinleştirebilirsiniz kendi bileşen oluşturmayı öğrenmek için bkz: [izlenecek yol: bir temel Windows çalışma zamanı bileşeni oluşturma](../windows/walkthrough-creating-a-basic-windows-runtime-component-using-wrl.md).  
