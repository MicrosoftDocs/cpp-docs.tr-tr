...
|-------------|----------|-----------------|  
|Format.AlignBottoms|CTRL + SHIFT + AŞAĞI OK|Baskın denetimi ile seçilen denetimleri alt kenarları hizalar.|  
...
|Format.AlignTops|CTRL + SHIFT + YUKARI OK|Üst kenarları Seçili denetimleri baskın denetimi ile hizalar.|  
...
|Format.SpaceDown|ALT + AŞAĞI OK|Seçili denetimleri dikey olarak eşit boşluk|  
