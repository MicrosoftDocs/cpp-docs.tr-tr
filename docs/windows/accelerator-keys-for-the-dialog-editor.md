---
title: Hızlandırıcı tuşları (C++) iletişim kutusu Düzenleyicisi için | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "44313578"
---
# <a name="accelerator-keys-for-the-dialog-editor-c"></a>Kısayol tuşları için iletişim kutusu Düzenleyicisi (C++)
