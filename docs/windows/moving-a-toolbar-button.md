---
title: Araç çubuğu düğmesini taşıma | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33876910"
---
# <a name="moving-a-toolbar-button"></a>Araç Çubuğu Düğmesini Taşıma
### <a name="to-move-a-toolbar-button"></a>Araç çubuğu düğmesini taşıma  
  
1.  İçinde **araç çubuğu görünümü** bölmesinde, araç çubuğunda yeni konumuna taşımak istediğiniz düğmeyi sürükleyin.  
