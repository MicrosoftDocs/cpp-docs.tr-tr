---
title: Basma düğmelerini iletişim kutusunun alt ve sağ düzenleme | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1.  Bir veya daha fazla düğmeler seçin.  
  
2.  Gelen **biçimi** menüsünde seçin **düğmeleri düzenleme**ve ardından aşağıdaki düzenlemeleri birini seçin:  
  
    -   **Sağ**: basma düğmelerini iletişim kutusunun sağ köşesine hizalar.  
  
    -   **Alt**: basma düğmelerini iletişim kutusunun alt köşesine hizalar.  
  
         Bir düğme dışında bir denetim seçerseniz, konumuna etkilenmez.  
