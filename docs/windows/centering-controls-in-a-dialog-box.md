...
### <a name="to-center-controls-in-a-dialog-box"></a>Merkezi bir iletişim kutusu denetimleri için  
  
1.  Denetim veya yeniden düzenlemek istediğiniz denetimleri seçin.  
  
2.  Gelen **biçimi** menüsünde seçin **Center iletişim**ve ardından aşağıdaki düzenlemeleri birini seçin:  
  
    -   **Dikey**: dikey olarak iletişim kutusunda denetimleri merkezleri.  
  
    -   **Yatay**: iletişim kutusunda yatay denetimleri merkezleri.  
