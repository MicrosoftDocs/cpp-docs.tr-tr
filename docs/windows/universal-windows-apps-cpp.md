...
|[C++'ta Windows çalışma zamanı bileşenleri oluşturma](/windows/uwp/winrt-components/creating-windows-runtime-components-in-cpp)|Diğer evrensel Windows platformu uygulamaları ve bileşenleri tüketebileceği DLL'leri oluşturmayı açıklar.|  
