---
title: Birden çok denetim ekleme | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1.  Tutarken **CTRL** anahtar, bir denetim seçin [araç penceresi](/visualstudio/ide/reference/toolbox).  
  
2.  Yayın **CTRL** anahtar ve özel denetim eklemek istediğiniz kadar olarak iletişim kutusuna tıklayın.  
  
3.  Tuşuna **ESC** denetimleri yerleştirme durdurmak için.  
