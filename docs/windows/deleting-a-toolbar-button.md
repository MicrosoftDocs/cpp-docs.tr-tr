---
title: Araç çubuğu düğmesi silme | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
---
# <a name="deleting-a-toolbar-button"></a>Araç Çubuğu Düğmesi Silme
### <a name="to-delete-a-toolbar-button"></a>Araç çubuğu düğmesi silmek için  
  
1.  Araç çubuğu düğmesini seçin ve araç çubuğundan sürükleyin.  
