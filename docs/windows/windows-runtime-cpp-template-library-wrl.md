...
## <a name="getting-started"></a>Başlarken  
 ...
 Nasıl kullanılacağını gösterir [Ixmlhttprequest2](http://msdn.microsoft.com/bbc11c4a-aecf-4d6d-8275-3e852e309908) ve [Ixmlhttprequest2callback](http://msdn.microsoft.com/aa4b3f4c-6e28-458b-be25-6cce8865fc71) bir UWP uygulamasında bir web hizmetine HTTP GET ve POST istekleri göndermek için görevleri ile birlikte arabirimleri.  
