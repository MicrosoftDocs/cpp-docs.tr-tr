---
title: öznitelik (C++ COM özniteliği) | Microsoft Docs
ms.custom: ''
ms.date: 10/03/2018
ms.technology:
- cpp-windows
...
> [!NOTE]
> **Özniteliği** özniteliği artık kullanım dışı.  Ortak dil çalışma zamanı özniteliğini kullan `System.Attribute` için doğrudan kullanıcı tanımlı attirbutes oluşturmak için. Daha fazla bilgi için [kullanıcı tanımlı öznitelikler](../user-defined-attributes-cpp-component-extensions.md).

Tanımladığınız bir [özel öznitelik](custom-attributes-cpp.md) yerleştirerek **özniteliği** yönetilen bir sınıf veya yapı tanımı özniteliği. Sınıf özel öznitelik adıdır. Örneğin:
...
Olası öznitelik parametre türleri listesi için bkz. [özel öznitelikler](custom-attributes-cpp.md).

Bkz: [kullanıcı tanımlı öznitelikler](../user-defined-attributes-cpp-component-extensions.md) öznitelik hedefleri hakkındaki bir tartışmaya.
