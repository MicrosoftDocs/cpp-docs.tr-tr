---
title: Gruplara Göre Öznitelikler
...
.NET Framework uygulamanız için özel öznitelikler tanımlama hakkında daha fazla bilgi için bkz: [kullanıcı tanımlı öznitelikler](../../extensions/user-defined-attributes-cpp-component-extensions.md).
