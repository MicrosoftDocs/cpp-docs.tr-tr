...
İlk Oluşturucu boş bir nesneye hangi insert oluşturur varsayılan oluşturucudur. İkinci oluşturucu belirtir [__nullptr](../nullptr-cpp-component-extensions.md), boş bir nesneye açıkça oluşturulur.
