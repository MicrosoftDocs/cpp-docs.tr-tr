---
title: Renk başka yerde kullanmak üzere (simgeler için görüntü Düzenleyicisi) görüntüden | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1. Üzerinde **görüntü Düzenleyicisi** araç çubuğu (veya **görüntü** menüsünde **Araçları** komut), tıklayın **rengi seçin** aracı.
