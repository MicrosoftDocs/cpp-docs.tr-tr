---
title: (Simgeler için görüntü Düzenleyicisi) farklı görüntüleme cihazı için görüntü ekleme | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1.  Üzerinde **görüntü** menüsünde tıklatın **yeni cihaz görüntüsü** (veya sağ **görüntü Düzenleyicisi** bölmesi ve seçin **yeni cihaz görüntüsü** gelen kısayol menüsü).  
  
2.  Eklemek istediğiniz resim türünü seçin. Tıklatarak **özel** büyüklüğü kullanılabilir değil ve varsayılan listeye bir simge oluşturmak için.  
