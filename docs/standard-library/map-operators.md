---
description: 'Daha fazla bilgi edinin: &lt; eşleme &gt; işleçleri'
...
## <a name="operatorlt-multimap"></a><a name="op_lt_multimap"></a> işleç &lt; (multimap)
...
## <a name="operatorgt-multimap"></a><a name="op_gt_multimap"></a> işleç &gt; (multimap)
