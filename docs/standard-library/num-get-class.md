...
### <a name="parameters"></a>Parametreler  
 ...
 `_Iosbase`  
 [İos_base](../standard-library/ios-base-class.md) , bayrakları dönüştürme işlemi tarafından kullanılır.  
  
 `_State`  
 Hangi failbit durumuna (bkz [ios_base::iostate](../standard-library/ios-base-class.md#iostate)) hata yapması üzerine eklenir.  
