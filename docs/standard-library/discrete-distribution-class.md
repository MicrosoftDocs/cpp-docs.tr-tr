...
### <a name="parameters"></a>Parametreler  
*firstW*  
 Dağıtım oluşturmak üzere listedeki ilk yineleyici.  
  
*lastW*  
 İçinden (olmayan-yineleyiciler ucu için boş bir öğenin kullandığından dahil) dağıtım oluşturmak listedeki son yineleyici.  
