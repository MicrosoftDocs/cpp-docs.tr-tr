...
|[Geri](#back)||  
|[başlayın](#begin)|Dize ilk öğe adresleme yineleyici döndürür.|  
...
|||  
|-|-|  
|[+= işleci](#op_add_eq)|Karakterleri dizeye ekler.|  
|[işleç =](#op_eq)|Yeni karakter değeri bir dize içeriğini atar.|  
