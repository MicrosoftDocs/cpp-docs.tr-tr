...
### <a name="parameters"></a>Parametreler  
 ...
 `str`  
 Türünde bir nesne [basic_string](../standard-library/basic-string-class.md).  
...
### <a name="parameters"></a>Parametreler  
 `_Off`  
 Göreli olarak için arama konumunu `_Way`. Daha fazla bilgi için bkz: [basic_stringbuf::off_type](#off_type).  
  
 `_Way`  
 Uzaklık işlemleri için başlangıç noktası. Bkz: [ios_base::seekdir](../standard-library/ios-base-class.md#seekdir) olası değerler için.  
  
 `_Mode`  
 İşaretçi konumunun modunu belirtir. Varsayılan konumlar yazma ve okuma değiştirmek izin vermektir. Daha fazla bilgi için bkz: [ios_base::openmode](../standard-library/ios-base-class.md#openmode).  
...
### <a name="parameters"></a>Parametreler  
 `other`  
 İçeriği takas basic_stringbuf bu basic_stringbuf ile.  
...
### <a name="parameters"></a>Parametreler  
 `other`  
 Yerel ayar nitelikler dahil olmak üzere içerikleri işlecinin sol tarafındaki stringbuf atanacak basic_stringbuf.  
