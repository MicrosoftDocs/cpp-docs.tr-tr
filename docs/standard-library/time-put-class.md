...
|[yerleştirme](#put)|Bir dizi olarak saat ve tarih bilgilerini çıkarır `CharType`s.|  
...
### <a name="parameters"></a>Parametreler  
 `next`  
 Çıktı yineleyici burada dizisini temsil eden saat ve tarih karakter olan eklenecek.  
  
 `_Iosbase`  
 Kullanılmayan.  
  
 `_Pt`  
 Çıkış olan saat ve tarih bilgileri.  
  
 `_Fmt`  
 Çıktı biçimi. Bkz: [strftime, wcsftime, _strftime_l, _wcsftime_l](../c-runtime-library/reference/strftime-wcsftime-strftime-l-wcsftime-l.md) yönelik geçerli değerler.  
  
 `_Mod`  
 Biçim için değiştiricisi. Bkz: [strftime, wcsftime, _strftime_l, _wcsftime_l](../c-runtime-library/reference/strftime-wcsftime-strftime-l-wcsftime-l.md) yönelik geçerli değerler.  
...
### <a name="parameters"></a>Parametreler  
 ...
 `first`  
 Biçimlendirme dizesi çıktısı için başlangıcı. Bkz: [strftime, wcsftime, _strftime_l, _wcsftime_l](../c-runtime-library/reference/strftime-wcsftime-strftime-l-wcsftime-l.md) yönelik geçerli değerler.  
  
 `last`  
 Çıkış için biçimlendirme dize sonu. Bkz: [strftime, wcsftime, _strftime_l, _wcsftime_l](../c-runtime-library/reference/strftime-wcsftime-strftime-l-wcsftime-l.md) yönelik geçerli değerler.  
