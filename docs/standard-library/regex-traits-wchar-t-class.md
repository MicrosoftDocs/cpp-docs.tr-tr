---
title: "regex_traits&lt;wchar_t&gt; sınıfı | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="remarks"></a>Açıklamalar  
 Bir şablon sınıfı açık alt uzmanlaşması sınıftır [regex_traits](../standard-library/regex-traits-class.md) türündeki öğeler için `wchar_t` (Bu tür nesneler işlemek kitaplık işlevleri özelliklerden yararlanabilirsiniz böylece).  
