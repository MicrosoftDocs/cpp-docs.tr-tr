---
title: "negative_binomial_distribution sınıfı | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
ms.author: corob
manager: ghogen
ms.openlocfilehash: a3d5e3b04a86e6e82cccdc2da93d6a1f379010a4
...
Yapı param_type {  
   ...
   param_type (result_type k = 1, çift p = 0,5); result_type k() const; const çift p();
