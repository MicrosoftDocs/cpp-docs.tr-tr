...
*Kapsayıcı* kapsayıcı türü olan öğeler tarafından ekleneceği ön bir `front_insert_iterator`.
...
*_Cont* kapsayıcı nesnede `front_insert_iterator` öğeleri eklemektir.
