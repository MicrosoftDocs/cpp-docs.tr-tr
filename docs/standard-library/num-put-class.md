...
### <a name="parameters"></a>Parametreler  
 ...
 `_Iosbase`  
 Çıktı biçimlendirmesi bayrakları ve çıktı punctuate için kullanılan numpunct modeli ile yerel ayar içeren akış belirtilmiş.  
  
 `_Fill`  
 Aralığı için kullanılan karakter.  
  
 `val`  
 Sayı veya çıkış olacak Boolean türü.  
...
### <a name="parameters"></a>Parametreler  
 ...
 `_Iosbase`  
 Çıktı biçimlendirmesi bayrakları ve çıktı punctuate için kullanılan numpunct modeli ile yerel ayar içeren akışı belirtilmiş.  
