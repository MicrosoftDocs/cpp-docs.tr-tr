...
### <a name="parameters"></a>Parametreler  
 `complexNum`  
 Karmaşık, modül belirlenecek numarası.  
  
### <a name="return-value"></a>Dönüş Değeri  
 Karmaşık sayıyı mod.  
  
### <a name="remarks"></a>Açıklamalar  
 *Modulus* karmaşık sayıyı temsil eden vektör uzunluğu ölçüsü, karmaşık sayısıdır. Karmaşık bir sayının modulus bir + BI sqrt (bir<sup>2</sup> + b<sup>2</sup>) yazılı &#124; bir BI &#124; +. *Norm* karmaşık bir sayının bir + BI (bir<sup>2</sup> + b<sup>2</sup>) mod karmaşık bir sayının karekökünü kendi norm gelir.  
...
### <a name="parameters"></a>Parametreler  
 `complexNum`  
 Karmaşık, bağımsız değişken belirlenecek numarası.  
...
### <a name="parameters"></a>Parametreler  
 `complexNum`  
 Karmaşık, karmaşık çiftini döndürülen sayı.  
...
### <a name="parameters"></a>Parametreler  
 `complexNum`  
 Kosinüsü belirlenen karmaşık sayı.  
...
### <a name="parameters"></a>Parametreler  
 `complexNum`  
 Karmaşık sayı, hiperbolik kosinüsü belirlenir.  
...
### <a name="parameters"></a>Parametreler  
 `complexNum`  
 Karmaşık, gerçek bölüm ayıklanacak numarası.  
...
### <a name="parameters"></a>Parametreler  
 `complexNum`  
 Doğal logaritmasını belirlenen karmaşık sayı.  
...
### <a name="parameters"></a>Parametreler  
 `complexNum`  
 Temel 10 logaritmasını belirlenen karmaşık sayı.  
...
### <a name="parameters"></a>Parametreler  
 `complexNum`  
 Karmaşık olan norm belirlenecek numarası.  
  
### <a name="return-value"></a>Dönüş Değeri  
 Karmaşık sayıyı norm.  
  
### <a name="remarks"></a>Açıklamalar  
 Karmaşık bir sayının norm *+ bi* olan *(bir*<sup>2</sup> *+ b*<sup>2</sup>*).* Karmaşık bir sayının norm kendi modulus kare olur. Modulus karmaşık bir sayının karmaşık sayıyı temsil eden vektör uzunluğu ölçüsüdür. Karmaşık bir sayının modulus *+ bi* olan `sqrt` *(bir*<sup>2</sup> *+ b*<sup>2</sup> *),* yazılmış *&#124; bir BI &#124; +.*  
...
### <a name="parameters"></a>Parametreler  
 *_Modulus*  
 Giriş karmaşık sayı mod.  
  
 *_Argument*  
 Giriş karmaşık sayı bağımsız değişkeni.  
...
### <a name="parameters"></a>Parametreler  
 `complexNum`  
 Karmaşık kare kökünü bulunacak numarası.  
...
## <a name="see-also"></a>Ayrıca Bkz.  
 [\<karmaşık >](../standard-library/complex.md)
