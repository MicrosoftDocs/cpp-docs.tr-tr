...
### <a name="parameters"></a>Parametreler  
 `left`  
 Karmaşık sayı veya nesne için eşitsizlik sınanacak kendi parametre türü.  
...
### <a name="parameters"></a>Parametreler  
 `left`  
 İlk iki karmaşık sayı veya bir karmaşık tarafından çarpılacağı numarası için parametre türü bir sayı * işlemi.  
  
 `right`  
 İkinci iki karmaşık sayı veya bir karmaşık tarafından çarpılacağı numarası için parametre türü bir sayı * işlemi.  
...
### <a name="parameters"></a>Parametreler  
 `left`  
 İlk iki karmaşık sayı veya karmaşık sayıyı tarafından eklenecek için parametre türü numarası + işlemi.  
  
 `right`  
 İkinci iki karmaşık sayı veya karmaşık sayıyı tarafından eklenecek için parametre türü numarası + işlemi.  
...
### <a name="parameters"></a>Parametreler  
 `left`  
 İlk iki karmaşık sayı veya işlemiyle çıkarılır için karmaşık bir sayının için parametre türü bir sayı.  
  
 `right`  
 İkinci iki karmaşık sayı veya işlemiyle çıkarılır için karmaşık bir sayının için parametre türü bir sayı.  
...
### <a name="parameters"></a>Parametreler  
 `left`  
 Karmaşık sayı veya pay payda ile bölünüp bir karmaşık numarası için parametre türü bir sayı / işlemi.  
  
 `right`  
 Karmaşık sayı veya payda ile pay ayırmak için kullanılacak olan karmaşık bir sayının için parametre türü bir sayı / işlemi.  
...
### <a name="parameters"></a>Parametreler  
 `Ostr`  
 Karmaşık sayıyı girilen çıkış akışı.  
  
 `right`  
 Çıkış akışı girdiğiniz karmaşık sayı  
