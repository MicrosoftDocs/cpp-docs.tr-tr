...
Şablon işlevi aşırı yüklerini **< <** [basic_string](../standard-library/basic-string-class.md) sınıf şablonu bir nesne *Str* ekleyin *\_OSTR*. İşlev etkin bir şekilde `_Ostr.write( str.c_str, str.size )`döndürüyor.
