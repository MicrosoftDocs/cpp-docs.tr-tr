 ...
 *Türü*  
 ...
 `Container`  
 Sıranın uygulamak için kullanılan temel kapsayıcı türü.  
...
|[anında iletme](#push)|Bir öğe için arkası ekler `queue`.|  
...
### <a name="parameters"></a>Parametreler  
 `val`  
 Sıranın arkasına eklenen öğesi.  
...
### <a name="parameters"></a>Parametreler  
 `right`  
 **Const** oluşturulan sıra olduğu bir kopyasını olması için kapsayıcı.  
