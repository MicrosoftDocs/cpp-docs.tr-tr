...
|Ad|Açıklama|  
|----------|-----------------|  
|[Al](#get)|Depolanan sonucu alır *zaman uyumsuz durum ilişkili*.|  
...
### <a name="parameters"></a>Parametreler  
 `Right`  
 A [gelecekteki](../standard-library/future-class.md) veya `shared_future` nesnesi.  
