...
*İlke* A [başlatma](../standard-library/future-enums.md#launch) değeri.
...
*Errno* A [future_errc](../standard-library/future-enums.md#future_errc) raporlanan hatayı tanımlayan bir değer.
...
*Sol* sol `promise` nesne.

*Sağ* sağ `promise` nesne.
