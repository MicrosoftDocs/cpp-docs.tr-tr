...
### <a name="parameters"></a>Parametreler  
 `left`  
 Eşitsizlik için sınanacak nesnelerinden biri.  
  
 `right`  
 Eşitsizlik için sınanacak nesnelerinden biri.  
  
 `Ty1`  
 Sol paylaşılan işaretçiyi tarafından denetlenen türü.  
...
### <a name="parameters"></a>Parametreler  
 `left`  
 Bir nesnenin eşitlik için test edilmelidir.  
...
### <a name="parameters"></a>Parametreler  
 ...
 `Ty1`  
 Sol işaretçiyi tarafından denetlenen türü.  
