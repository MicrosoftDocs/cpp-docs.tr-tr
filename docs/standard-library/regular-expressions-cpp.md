...
- "bir{2}" "a" veya hedef sırası "aaa" hedef sırası "aa" ancak hedef sırası eşleşir.

- "bir{2,}" hedef sırası "aa", "aaa" hedef sırası ve benzeri eşleşir, ancak hedef sırası eşleşmiyor "a".
