...
Bir çıkış akışı ile ilişkilendirilmiş dosyayı açtığınızda, genellikle belirttiğiniz bir **open_mode** bayrağı. Numaralandırmalar içinde olarak tanımlanan bu bayraklar birleştirebilirsiniz `ios` sınıfıyla bit düzeyinde OR ( &#124; ) işleci. Bkz: [ios_base::openmode](../standard-library/ios-base-class.md#openmode) numaralandırıcılar listesi.
...
|[İyi](http://msdn.microsoft.com/Library/77f0aa17-2ae1-48ae-8040-592d301e3972)|Döndürür **true** (kurtarılamaz veya diğer) hata koşulu yok ve dosya sonu bayrağı ayarlı değil.|
