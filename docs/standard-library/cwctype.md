---
description: 'Daha fazla bilgi edinin: &lt; cwctype&gt;'
title: '&lt;cwctype&gt;'
ms.date: 11/04/2016
f1_keywords:
- <cwctype>
...
ms.locfileid: "97324620"
---
# <a name="ltcwctypegt"></a>&lt;cwctype&gt;

Standart C Kitaplığı üst bilgisini içerir \<wctype.h> ve ilgili adları `std` ad alanına ekler.
