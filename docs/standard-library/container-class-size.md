---
title: Kapsayıcı sınıfı::size | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "33842462"
---
# <a name="container-classsize"></a>Kapsayıcı Sınıfı::size
...
Denetimli sırası uzunluğu bakılmaksızın sabit zaman denetimli sırası uzunluğunu döndürür.
