...
#### <a name="parameters"></a>Parametreler  
 ...
 `Traits`  
 İki öğenin değerlerini eşlemde kendi göreli sıralarını belirlemek için sıralama anahtarları olarak karşılaştırabilen bir işlev nesnesi sağlayan tür. Bu bağımsız değişken isteğe bağlıdır ve ikili karşılaştırma `less<Key>` varsayılan değerdir.  
...
### <a name="parameters"></a>Parametreler  
 `key`  
 Öğeleri eşlemesinden eşleştirilmesi için anahtar değeri.  
...
### <a name="parameters"></a>Parametreler  
 `key`  
 Bir öğenin Aranmakta eşlemesinden sıralama anahtarı tarafından eşleştirilmesini anahtar değeri.  
...
### <a name="parameters"></a>Parametreler  
 `right`  
 Bağımsız değişken eşleme öğeleri hedef Haritası takas için sağlama.  
...
### <a name="parameters"></a>Parametreler  
 `key`  
 Bir öğenin Aranmakta eşlemesinden sıralama anahtar değeri ile Karşılaştırılacak bağımsız değişkeni anahtar değeri.  
