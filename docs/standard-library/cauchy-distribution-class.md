...
Bir cauchy açılımı hakkında ayrıntılı bilgi için Wolfram MathWorld bkz [Cauchy açılımı](https://go.microsoft.com/fwlink/p/?linkid=400523).
