---
description: 'Hakkında daha fazla bilgi edinin: is_member_function_pointer sınıfı'
...
ms.locfileid: "97323676"
---
# <a name="is_member_function_pointer-class"></a>is_member_function_pointer Sınıfı
...
Tür değeri, üye işlevi işaretçisi veya üye işlevi işaretçisi ise, yanlış bir değer içeriyorsa tür belirtiminin bir örneği true olarak tutulur  `cv-qualified` .
