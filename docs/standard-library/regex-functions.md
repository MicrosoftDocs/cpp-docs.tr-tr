...
*BidIt*<br/> Alt eşleşmeleri için yineleyici türü. Bu bir ortak durumda `string::const_iterator`, `wstring::const_iterator`, `const char*` veya `const wchar_t*`.
