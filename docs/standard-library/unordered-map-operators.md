...
`left` Türünde bir nesne `unordered_map`.

`right` Türünde bir nesne `unordered_map`.
...
`left` Türünde bir nesne `unordered_multimap`.

`right` Türünde bir nesne `unordered_multimap`.
