---
description: 'Hakkında daha fazla bilgi edinin: remove_extent sınıfı'
...
ms.locfileid: "97159680"
---
# <a name="remove_extent-class"></a>remove_extent Sınıfı
...
Bir örneği `remove_extent<T>` `T1` , *t* formu olduğunda `T1[N]` , yoksa *t* olarak değiştirilmiş bir türü tutar.
