...
description: C++ standart kitaplığı üst bilgi dosyaları, kategorilere ayrılmıştır
ms.date: 08/31/2020
helpviewer_keywords:
...
| Localization (Yerelleştirme) | [\<clocale>](clocale.md), [\<codecvt>](codecvt.md) <sup>11 a</sup>, [\<cvt/wbuffer>](cvt-wbuffer.md) , [\<cvt/wstring>](cvt-wstring.md) ,[\<locale>](locale.md) |
...
| Saat | [\<chrono>](chrono.md)<sup>11</sup>, [\<ctime>](ctime.md) |
...
|Yineleyiciler|[\<iterator>](iterator.md)|
|Localization (Yerelleştirme)|[\<codecvt>](codecvt.md), [\<cvt/wbuffer>](cvt-wbuffer.md), [\<cvt/wstring>](cvt-wstring.md), [\<locale>](locale.md)|
