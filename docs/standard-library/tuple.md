...
|örneği|Açıklama|
|-|-|
|[Tanımlama grubu](../standard-library/tuple-class.md)|Sabit uzunluklu dizi öğe sarmalar.|
...
|[operator >](../standard-library/tuple-operators.md#op_gt)|Karşılaştırma `tuple` büyük nesneler|
