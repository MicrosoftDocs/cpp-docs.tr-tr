...
### <a name="parameters"></a>Parametreler  
 `idx`  
 Dizini olarak depolamak için bir `iword`.  
...
### <a name="parameters"></a>Parametreler  
 `_Prec`  
 Görüntülenecek basamak sayısı veya sabit gösteriminde ondalık basamak sayısı.  
...
### <a name="parameters"></a>Parametreler  
 `_Idx`  
 Dizini olarak depolamak için bir `pword`.  
...
### <a name="parameters"></a>Parametreler  
 `_Sync`  
    Tüm akışları ile eşitlenmiş olup **stdio**.  
