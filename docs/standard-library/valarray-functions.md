...
### <a name="parameters"></a>Parametreler  
 `left`  
 Öğeleri üzerinde üye işlevi tarafından işletilen için olan giriş valarray.  
...
### <a name="parameters"></a>Parametreler  
 `left`  
 Öğeleri y koordinatını arktanjantını bağımsız değişken değerlerini sağlayan sabit bir sayısal veri türü veya giriş valarray.  
  
 `right`  
 Öğeleri x koordinatını için arktanjantını bağımsız değişken değerlerini sağlayan sabit bir sayısal veri türü veya giriş valarray.  
...
### <a name="parameters"></a>Parametreler  
 `left`  
 Giriş valarray exponentiated olacak şekilde her öğe için temel öğeleri sağlayın.  
  
 `right`  
 Öğeleri exponentiated olacak şekilde her öğe için güç kaynağı giriş valarray.  
