...
### <a name="parameters"></a>Parametreler  
 `first`  
 Belirlenecek olan ikinci mesafe olan ilk yineleyici.  
  
 `last`  
 Belirlenecek olan ilk mesafe olan ikinci yineleyici.  
...
### <a name="parameters"></a>Parametreler  
 `_Cont`  
 Bir öğe olan ön sahip olmak kapsayıcı nesnesinin eklenir.  
...
### <a name="parameters"></a>Parametreler  
 `_Cont`  
 Yeni öğeler eklemek için olan kapsayıcı.  
  
 `_Where`  
 Yineleyici ekleme noktası bulunuyor.  
...
### <a name="parameters"></a>Parametreler  
 `_It`  
 Yeni taşıma yineleyici depolanan yineleyici.  
