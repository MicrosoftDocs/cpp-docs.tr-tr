...
#### <a name="parameters"></a>Parametreler  
 `_RealVal`  
 Türü değeri **uzun çift** için yapılandırılan bir karmaşık sayı gerçek parçası.  
  
 `_ImagVal`  
 Türü değeri `long double` yapılandırılan karmaşık sayı sanal kısmı için.  
  
 `complexNum`  
 Karmaşık sayı türü **çift** veya türünde **float** , gerçek ve sanal bölümleri türü bir karmaşık sayı başlatmak için kullanılan `long double` yapılandırılan.  
