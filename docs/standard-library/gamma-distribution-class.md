---
title: "gamma_distribution sınıfı | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Wolfram MathWorld makaleyi gama dağıtımı hakkında ayrıntılı bilgi için bkz [gama dağıtım](http://go.microsoft.com/fwlink/LinkId=401111).  
