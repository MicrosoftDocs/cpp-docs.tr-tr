...
Bir gamma dağılımı hakkında ayrıntılı bilgi için Wolfram MathWorld bkz [Gamma dağılımı](https://go.microsoft.com/fwlink/p/?linkid=401111).
