---
description: 'Daha fazla bilgi edinin: &lt; cmath&gt;'
title: '&lt;cmath&gt;'
ms.date: 11/04/2016
f1_keywords:
- <cmath>
...
ms.locfileid: "97234104"
---
# <a name="ltcmathgt"></a>&lt;cmath&gt;

Standart C Kitaplığı üst bilgisini içerir \<math.h> ve ilgili adları `std` ad alanına ekler.
...
### <a name="associated-legendre-functions"></a>İlişkili Legendre işlevleri
...
### <a name="beta-function"></a>Beta işlevi
...
### <a name="cylindrical-neumann-functions"></a>Silindirik Neumann işlevleri
...
### <a name="spherical-associated-legendre-functions"></a>Küresel ilişkili Legendre işlevleri
...
### <a name="spherical-neumann-functions"></a>Küresel Neumann işlevleri
