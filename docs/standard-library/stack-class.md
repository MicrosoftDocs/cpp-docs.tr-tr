...
#### <a name="parameters"></a>Parametreler  
 ...
 `Container`  
 Yığın uygulamak için kullanılan temel kapsayıcı türü. Varsayılan değer sınıftır `deque`  *\<türü >*.  
...
### <a name="parameters"></a>Parametreler  
 `right`  
 Oluşturulan yığın kopyasını olmasını olduğu kapsayıcı.  
