...
-   Kapsayıcı ayırıcısı nesneyi depoluyorsa *al*, ve *al* dışında yapılan bir çağrı sonucunda aykırı *al***.allocate**, kapsayıcı nesnesinin ortaya çıkan durum tanımlanmamıştır.  
