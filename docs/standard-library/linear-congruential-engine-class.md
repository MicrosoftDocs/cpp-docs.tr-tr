...
#### <a name="parameters"></a>Parametreler  
 ...
 `A`  
 **Çarpan**. **Önkoşul**: bkz Açıklamalar bölümüne.  
  
 `C`  
 **Artırma**. **Önkoşul**: bkz Açıklamalar bölümüne.  
  
 `M`  
 **Modulus**. **Önkoşul**: Açıklamalar bakın.  
...
```  
 ...
 Wikipedia makaleyi doğrusal congruential altyapısı algoritması hakkında ayrıntılı bilgi için bkz: [doğrusal congruential Oluşturucu](http://go.microsoft.com/fwlink/LinkId=402446).  
