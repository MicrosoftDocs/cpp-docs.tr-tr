 ...
 * strTo *  
 ...
 `_Num`  
 Değerler atanması giderek öğe sayısı.  
 ...
 * str2 *  
 ...
 `_Num`  
 Karşılaştırılacak dizelerde öğe sayısı.  
...
### <a name="parameters"></a>Parametreler  
 `_To`  
 Karakter kopyalanan dizisini almak için hedeflenen dize veya karakter dizisi başındaki öğesi.  
  
 `_From`  
 Kopyalanacak kaynak dize veya karakter dizisi başındaki öğesi.  
...
### <a name="parameters"></a>Parametreler  
 ...
 `dest_size`  
 Boyutunu `dest`. Varsa `char_type` olan `char`, sonra da bu boyut bayttır. Varsa `char_type` olan `wchar_t`, bu boyut sözcükleri sonra.  
...
### <a name="parameters"></a>Parametreler  
 ...
 `_Ch2`  
 Eşitlik için test ikinci iki karakter.  
...
### <a name="parameters"></a>Parametreler  
 `_Ch1`  
 İlk iki karakter eşitlik için test **int_type**s.  
  
 `_Ch2`  
 Eşitlik sınanacak ikinci iki karakter `int_type`s.  
...
### <a name="parameters"></a>Parametreler  
 ...
 `_Num`  
 Konum, birinciden sayım sayısı aranacak aralığında.  
  
 `_Ch`  
 Aralığı içinde arama yapılacak karakter.  
...
### <a name="parameters"></a>Parametreler  
 `str`  
 C-ölçülecek uzunluğunu olan dize.  
...
### <a name="parameters"></a>Parametreler  
 `_Ch1`  
 İçin sınanacak ilk iki karakter küçüktür.  
  
 `_Ch2`  
 İçin sınanacak ikinci iki karakter küçüktür.  
...
### <a name="parameters"></a>Parametreler  
 ...
 `dest_size`  
 Boyutunu `dest`. Varsa `char_type` olan `char`, sonra da bu bayttır. Varsa `char_type` olan `wchar_t`, bu sözcükleri olur.  
...
### <a name="parameters"></a>Parametreler  
 `_Ch`  
 Karakter olarak temsil edilen bir `int_type` veya EOF karakter olup test edilmelidir.  
...
### <a name="parameters"></a>Parametreler  
 `_Ch`  
 `int_type` Karakter olarak gösterilemeyecek kadar bir `char_type`.  
...
### <a name="parameters"></a>Parametreler  
 `_Ch`  
 `char_type` Karakter olarak gösterilemeyecek kadar bir `int_type`.  
