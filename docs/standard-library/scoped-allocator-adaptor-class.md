...
### <a name="parameters"></a>Parametreler  
 ...
 `hint`  
 Ayırıcı nesne önce isteği ayrılmış bir nesne adresini bularak yardımcı bir işaretçi.  
...
### <a name="parameters"></a>Parametreler  
 `ptr`  
 Nesne oluşturulması olduğu bellek konuma bir işaretçi.  
  
 `args`  
 Bağımsız değişkenler listesi.  
  
 `first`  
 Bir çift ilk türünde bir nesne.  
  
 `second`  
 Bir çift ikinci türünde bir nesne.  
...
### <a name="parameters"></a>Parametreler  
 `ptr`  
 Nesne yok edilmesi için bir işaretçi.  
...
### <a name="parameters"></a>Parametreler  
 `right`  
 Var olan `scoped_allocator_adaptor`.  
  
 `al`  
 Varolan bir ayırıcı dış ayırıcı kullanılacak.  
  
 `rest`  
 Allocators iç allocators kullanılacak bir listesi.  
