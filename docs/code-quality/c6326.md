---
description: 'Hakkında daha fazla bilgi edinin: C6326'
title: C6326
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
Aşağıdaki kod, C++ 17 kullanarak bu uyarıyı düzeltmek için bir yol gösterir `if constexpr` .
