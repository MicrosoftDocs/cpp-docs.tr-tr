---
title: '#yönergesi (C/C++) | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
`#define` *tanımlayıcı* `(` *tanımlayıcı*iyileştirilmiş`,`*...*  `,` *tanımlayıcı*iyileştirilmiş`)`*belirteç dizesinde*iyileştirilmiş  
