...
|`div_t``ldiv_t`ve `lldiv_t` yapılar|Sırasıyla [div](../c-runtime-library/reference/div.md), [ldiv](../c-runtime-library/reference/ldiv-lldiv.md)ve [lldiv](../c-runtime-library/reference/ldiv-lldiv.md)tarafından döndürülen değerleri depolayın.|STDLIB.H|
