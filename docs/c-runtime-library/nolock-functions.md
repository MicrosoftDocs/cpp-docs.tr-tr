...
ms.locfileid: "32391580"
---
# <a name="nolock-functions"></a>_nolock İşlevleri

Bu, tüm kilitleme gerçekleştirmeyin işlevlerdir. Bunlar, en yüksek performans gerektiren kullanıcılar için sağlanır. Daha fazla bilgi için bkz: [birden çok iş parçacıklı kitaplık performansı](../c-runtime-library/multithreaded-libraries-performance.md).

 _Nolock işlevleri yalnızca programınız gerçekten tek iş parçacıklı ise veya kendi kilitleme varsa kullanın.

## <a name="no-lock-routines"></a>Kilit yordamları
