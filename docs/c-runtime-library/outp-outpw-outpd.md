...
ms.locfileid: "74988378"
---
# <a name="outp-outpw-_outp-_outpw-_outpd"></a>outp, outpw, _outp, _outpw _outpd

Bir bağlantı noktasında, bir bayt (`outp`, `_outp`), bir sözcük (`outpw`, `_outpw`) veya çift bir sözcüğe (`_outpd`) çıkış verir.
...
Bu işlevler doğrudan bir g/ç bağlantı noktasına yazdıklarından, Kullanıcı kodunda kullanılamaz. Bu işletim sistemlerindeki G/Ç bağlantı noktalarını kullanma hakkında bilgi için, MSDN'de "Win32'de Seri İletişimleri" aratın.
