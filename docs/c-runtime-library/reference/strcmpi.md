...
ms.locfileid: "32406413"
---
# <a name="strcmpi"></a>strcmpi

Bu POSIX işlevi kullanım dışıdır. ISO C++ uyumluluğunu kullanmak [_stricmp](stricmp-wcsicmp-mbsicmp-stricmp-l-wcsicmp-l-mbsicmp-l.md) yerine.