...
Tamsayı bir dizeye dönüştürür. Bu işlevlerin daha güvenli sürümleri kullanılabilir; bkz: [_itoa_s, _i64toa_s, _ui64toa_s, _itow_s, _i64tow_s, _ui64tow_s](../../c-runtime-library/reference/itoa-s-i64toa-s-ui64toa-s-itow-s-i64tow-s-ui64tow-s.md).  
...
## <a name="remarks"></a>Açıklamalar  
 `_itoa`, `_i64toa`, Ve `_ui64toa` işlevleri Dönüştür rakamı verilen `value` bağımsız değişkeni null olarak sonlandırılan bir karakter dizesine ve sonucu depolar (en fazla 33 karakterler için `_itoa` ve 65 için `_i64toa` ve `_ui64toa`) içinde `str`. Varsa `radix` eşittir 10 ve `value` olan negatif saklı dizenin ilk karakter eksi işareti'dir ( `-` ). `_itow`, `_i64tow`, ve `_ui64tow` joker karakter sürümleri `_itoa`, `_i64toa`, ve `_ui64toa`sırasıyla.  
