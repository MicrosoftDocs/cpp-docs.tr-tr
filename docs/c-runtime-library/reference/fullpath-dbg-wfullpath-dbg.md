...
**_Fullpath_dbg** ve **_wfullpath_dbg** işlevleri aynı **_fullpath** ve **_wfullpath** dışında **_DEBUG** olan tanımlı, bu işlevleri hata ayıklama sürümü kullanma **malloc**, **_malloc_dbg**, NULL ilk parametre olarak aktarılırsa bellek ayıramadı. Hata ayıklama özellikleri hakkında bilgi için **_malloc_dbg**, bkz: [_malloc_dbg](malloc-dbg.md).
