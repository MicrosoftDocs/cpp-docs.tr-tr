---
description: 'Hakkında daha fazla bilgi edinin: sinyal'
title: sinyal
ms.date: 04/12/2018
api_name:
- signal
...
**Sinyal** işlevi, bir işlemin işletim sisteminden bir kesme sinyali işlemek için çeşitli yollarla seçim yapmasına olanak sağlar. *SIG* bağımsız değişkeni, **sinyalin** yanıt verdiği kesmede yapılır; Bu, SIGNAL. H içinde tanımlanan aşağıdaki bildirim sabitlerinden biri olmalıdır.
