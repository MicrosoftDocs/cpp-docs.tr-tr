...
ms.locfileid: "32406699"
---
# <a name="strdup-wcsdup"></a>strdup, wcsdup

Bu POSIX işlevler kullanım dışı bırakılmıştır. ISO C++ uyumluluğunu kullanmak [_strdup, _wcsdup, _mbsdup](strdup-wcsdup-mbsdup.md) yerine.