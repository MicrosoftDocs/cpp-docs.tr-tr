...
ms.locfileid: "70942875"
---
# <a name="_controlfp_s"></a>_controlfp_s

Kayan nokta denetim sözcüğünü alır ve ayarlar. [_Control87, _controlfp, \__control87_2](control87-controlfp-control87-2.md) 'in bu sürümü, [CRT 'daki güvenlik özellikleri](../../c-runtime-library/security-features-in-the-crt.md)bölümünde açıklandığı gibi güvenlik geliştirmeleri içerir.
...
**_Control87** ve **_controlfp_s** arasındaki fark, denormal değerlerini nasıl değerlendirdikleri. Intel (x86), x64 ve ARM platformları için **_control87** , denormal OPERAND özel durum maskesini ayarlayabilir ve temizleyebilir. **_controlfp_s** , denormal OPERAND özel durum maskesini değiştirmez. Bu örnek, farkı göstermektedir:
...
Maske sabiti (*maske*) ve yeni denetim değerleri (*newControl*) Için olası değerler aşağıdaki onaltılık değerler tablosunda gösterilmiştir. Onaltılık değerleri açıkça sağlamak yerine, aşağıda listelenen taşınabilir sabitleri ( **_Mcw_em**, **_em_geçersiz**vb.) Bu işlevlere bağımsız değişkenler olarak kullanın.
...
**_Mcw_em** maskesi için, Temizleme, donanım özel durumuna izin veren özel durumu ayarlar; Bu ayar özel durumu gizler. **_Em_yetersizliği** veya **_Em_overflow** oluşursa, sonraki kayan nokta yönergesi yürütülene kadar donanım özel durumu oluşturulmaz. **_Em_yetersizliği** veya **_Em_overflow**sonrasında hemen bir donanım özel durumu oluşturmak için FWAIT ması yönergesini çağırın.
