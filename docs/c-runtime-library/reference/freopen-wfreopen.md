...
**Freopen** işlevi, *Stream* ile ilişkili olan dosyayı kapatır ve *yol*tarafından belirtilen dosyaya yeniden atama *akışı* ile yeniden atar. **_wfreopen** , **_freopen**öğesinin geniş karakterli bir sürümüdür; **_wfreopen** için *yol* ve *mod* bağımsız değişkenleri geniş karakterli dizelerdir. **_wserbest açık** ve **_freaç** , diğer durumlarda aynı şekilde davranır.

### <a name="generic-text-routine-mappings"></a>Genel Metin Yordam Eşleşmeleri

|TCHAR.H yordamı|_UNıCODE & _MBCS tanımlı değil|_MBCS tanımlanmış|_UNICODE tanımlanmış|
|---------------------|------------------------------------|--------------------|-----------------------|
|**_tfyeniden aç**|**serbest açık**|**serbest açık**|**_wfreopen**|
...
|*modundaysa*|Access|
|-|-|
| **"r"** | Okuma için açılır. Dosya yoksa veya bulunamazsa, **serbest açma** çağrısı başarısız olur. |
