...
#### <a name="parameters"></a>Parametreler  
 ...
 `pfnNewHook`  
 Kanca yüklemek veya bu işlevi dar karakterlik sürümünü kaldırmak için rapor.  
  
 `pfnNewHook`  
 Kanca yüklemek veya bu işlevi joker karakter sürümünü kaldırmak için rapor.  
