...
description: _Getch_nolock için API başvurusu ve _getwch_nolock; Bu, yankısız ve iş parçacığını kilitlemeden konsoldan bir karakter alır.
ms.date: 4/2/2020
api_name:
- _getwch_nolock
- _getch_nolock
