...
Aşırı yükleme C++ izin verdiğinden, aşırı çağırabilirsiniz **csin** alın ve dönüş **_Fcomplex** ve **_Lcomplex** değerleri. Bir C programı **csin** her zaman alan ve döndüren bir **_Dcomplex** değeri.
