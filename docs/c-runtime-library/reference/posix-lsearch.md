...
ms.locfileid: "32397970"
---
# <a name="lsearch"></a>lsearch

Bu POSIX işlevi kullanım dışıdır. ISO C++ uyumluluğunu kullanmak [_lsearch](lsearch.md) veya Gelişmiş Güvenlik [_lsearch_s](lsearch-s.md) yerine.