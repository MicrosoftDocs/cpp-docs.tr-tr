...
*MaxSize*<br/>
*StrDest* arabelleğinin karakter cinsinden ölçülen boyutu (**char** veya **wchar_t**).
...
Bu işlev, parametrelerini doğrular. *StrDest*, *Format*veya *timeptr* bir null işaretçisiyse veya *timeptr* tarafından belirtilen **TM** veri yapısı geçersizse (örneğin, saat veya tarih için Aralık değerleri içeriyorsa) veya *Biçim* dizesi geçersiz bir biçimlendirme kodu içeriyor, [parametre doğrulama](../../c-runtime-library/parameter-validation.md)bölümünde açıklandığı gibi geçersiz parametre işleyicisi çağrılır. Yürütmenin devam etmesine izin veriliyorsa, işlev 0 döndürür ve **errno** öğesini **EINVAL**olarak ayarlar.
...
|**% #c**|Yerel ayar için uygun olan uzun tarih ve saat gösterimi. Örneğin: "Salı, Mart 14, 1995, 12:41:29".|
|**% #x**|Yerel ayara uygun uzun tarih gösterimi. Örneğin: "15 Mart 1995" Salı.|
