...
## <a name="return-value"></a>Dönüş Değeri  
 `_malloca` Rutin döndürür bir `void` nesnesinin herhangi bir türde bir depolama için uygun hizalanacak garanti ayrılan alanı işaretçi. Varsa `size` 0 ' dır `_malloca` sıfır uzunluklu öğesi ayırır ve geçerli bir işaretçi için bu öğeyi döndürür.  
...
> [!IMPORTANT]
>  Windows XP'de, `_malloca` çağrılır try/catch bloğunun içine çağırmalısınız [_resetstkoflw](../../c-runtime-library/reference/resetstkoflw.md) catch bloğu içinde.  
