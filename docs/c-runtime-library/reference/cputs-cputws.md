...
## <a name="remarks"></a>Açıklamalar  
 `_cputs` İşlevi Yazar işaret ediyor null ile sonlandırılmış dize `str` doğrudan konsola. Bir satır başı satır besleme (CR-LF) birleşimi dizeye otomatik olarak eklenmez.  
