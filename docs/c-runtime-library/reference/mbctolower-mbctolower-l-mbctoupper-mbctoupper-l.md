...
|`_mbctoupper,_mbctoupper_l`|Karakter büyük küçük harf karakter.|  
 ...
 Çıkış değerini ayarı tarafından etkilenen `LC_CTYPE` yerel kategori ayarı; bkz: [setlocale](../../c-runtime-library/reference/setlocale-wsetlocale.md) daha fazla bilgi için. Bu işlev olmadan sürümü `_l` soneki kullanır geçerli yerel ayar için bu yerel ayara bağımlı davranışı; sürümüyle `_l` soneki, bunun yerine geçirilen yerel ayar parametresi kullanır ancak bu aynıdır. Daha fazla bilgi için bkz: [yerel ayar](../../c-runtime-library/locale.md).  
