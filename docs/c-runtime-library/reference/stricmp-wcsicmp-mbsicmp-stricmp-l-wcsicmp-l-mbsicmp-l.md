---
description: 'Hakkında daha fazla bilgi edinin: _stricmp, _wcsicmp, _mbsicmp, _stricmp_l, _wcsicmp_l, _mbsicmp_l'
...
Bir hata durumunda **_mbsicmp** , ve içinde tanımlanan **_NLSCMPERROR** döndürür \<string.h> \<mbstring.h> .
