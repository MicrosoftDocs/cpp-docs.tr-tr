---
description: 'Hakkında daha fazla bilgi edinin: _open _wopen'
title: _open, _wopen
ms.date: 11/04/2016
api_name:
- _open
...
**_Open** işlevi, *filename* tarafından belirtilen dosyayı açar ve bunları okuma veya yazma için *hazırlar.* **_wopen** , **_open** geniş karakterli bir sürümüdür; _wopen *dosya adı* bağımsız  değişkeni, geniş karakterli bir dizedir. **_wopen** ve **_open** aynı şekilde davranır.
