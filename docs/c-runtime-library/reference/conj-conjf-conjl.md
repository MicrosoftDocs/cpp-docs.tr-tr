...
Çünkü C++ aşırı yüklemesi, sağlayan yüklerini çağırabilirsiniz **conj** alan ve getiren **_Fcomplex** ve **_Lcomplex** değerleri. C programında **conj** her zaman alan ve döndüren bir **_Dcomplex** değeri.
