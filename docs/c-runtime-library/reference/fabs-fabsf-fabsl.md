...
C++ aşırı yüklemeye izin verdiğinden, \<cmath> üst bilgisini dahil ediyorsanız **fabs** aşırı yüklerini çağırabilirsiniz. C programında **fabs** her zaman bir **Double**alır ve döndürür.
