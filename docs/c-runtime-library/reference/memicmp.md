---
description: 'Daha fazla bilgi için: memicmp'
title: memicmp
ms.date: 12/16/2019
api_name:
- memicmp
...
ms.locfileid: "97171432"
---
# <a name="memicmp"></a>memicmp

Microsoft 'a özgü işlev adı, `memicmp` [_memicmp](memicmp-memicmp-l.md) işlevi için kullanım dışı bir diğer addır. Varsayılan olarak, [Derleyici Uyarısı (düzey 3) C4996](../../error-messages/compiler-warnings/compiler-warning-level-3-c4996.md)oluşturur. Ad, uygulamaya özgü adlarla ilgili standart C kurallarını izlemediğinden kullanım dışı bırakılmıştır. Ancak, işlev hala desteklenmektedir.
