...
ms.locfileid: "75300670"
---
# <a name="spawnve"></a>spawnve

`spawnve` Microsoft 'a özgü işlev adı, [_spawnve](spawnve-wspawnve.md) işlevi için kullanım dışı bırakılmış bir diğer addır. Varsayılan olarak, [Derleyici Uyarısı (düzey 3) C4996](../../error-messages/compiler-warnings/compiler-warning-level-3-c4996.md)oluşturur. Ad, uygulamaya özgü adlarla ilgili standart C kurallarını izlemediğinden kullanım dışı bırakılmıştır. Ancak, işlev hala desteklenmektedir.
