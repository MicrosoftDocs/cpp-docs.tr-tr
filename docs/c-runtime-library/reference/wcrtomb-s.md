---
description: 'Hakkında daha fazla bilgi edinin: wcrtomb_s'
title: wcrtomb_s
ms.date: 4/2/2020
api_name:
- wcrtomb_s
...
Geçerli iş parçacığında hiçbir işlev bu işlev yürütülürken ve *mbstate* null olduğunda, **wcrtomb_s** işlevi  iş parçacığı güvenlidir.
