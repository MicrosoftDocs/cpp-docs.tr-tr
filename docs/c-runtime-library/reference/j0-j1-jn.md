...
Bu POSIX işlevler kullanım dışı bırakılmıştır. ISO C++ uyumluluğunu kullanmak [_j0, _j1, _jn](../../c-runtime-library/reference/bessel-functions-j0-j1-jn-y0-y1-yn.md) yerine.