...
Bir dizeyi, geçerli yerel ya da geçirilen belirtilen bir yerel ayar kullanarak büyük harfe dönüştürür. Bu sürümleri [_strupr, _strupr_l, _mbsupr, _mbsupr_l, _wcsupr_l, _wcsupr](../../c-runtime-library/reference/strupr-strupr-l-mbsupr-mbsupr-l-wcsupr-l-wcsupr.md) açıklandığı gibi güvenlik geliştirmeleri sahip [CRT'deki güvenlik özellikleri](../../c-runtime-library/security-features-in-the-crt.md).  
  
> [!IMPORTANT]
>  `_mbsupr_s`ve `_mbsupr_s_l` Windows çalışma zamanı'nda yürütme uygulamaları kullanılamaz. Daha fazla bilgi için bkz: [/ZW ile desteklenmeyen CRT işlevleri](http://msdn.microsoft.com/library/windows/apps/jj606124.aspx).  
...
## <a name="remarks"></a>Açıklamalar  
 `_strupr_s` İşlev yerinde, her küçük harfe dönüştürür `str` büyük harfe. `_wcsupr_s`joker karakter sürümü `_strupr_s`. `_mbsupr_s`çok baytlı karakter sürümü `_strupr_s`.  
  
 Dönüştürme tarafından belirlenen `LC_CTYPE` yerel kategori ayarı. Diğer karakterler etkilenmez. Daha fazla bilgi için `LC_CTYPE`, bkz: [setlocale](../../c-runtime-library/reference/setlocale-wsetlocale.md). Bu işlevlerin sürümleri `_l` sonekini kullan geçerli yerel; ile vizyonlarını `_l` soneki, bunun yerine geçirilen yerel ayar kullanmasını dışında aynıdır. Daha fazla bilgi için bkz: [yerel ayar](../../c-runtime-library/locale.md).  
...
## <a name="example"></a>Örnek  
 Örneğin bkz [_strlwr_s, _strlwr_s_l, _mbslwr_s, _mbslwr_s_l, _wcslwr_s, _wcslwr_s_l](../../c-runtime-library/reference/strlwr-s-strlwr-s-l-mbslwr-s-mbslwr-s-l-wcslwr-s-wcslwr-s-l.md) .  
