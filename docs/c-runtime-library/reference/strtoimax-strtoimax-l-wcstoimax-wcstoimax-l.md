...
**strtoimax** , *strSource*dizesinde temsil edilen değeri döndürür; bu durumda, bir taşmaya neden olacağı durumlar dışında, **INTMAX_MAX** veya **INTMAX_MIN**döndürür ve **errno** , **ERANGE olarak ayarlanır** . Dönüştürme gerçekleştirilemiyorsa işlev 0 döndürür. **wcstoimax** , **strtoimax**'e anormal olarak değer döndürür.
