...
Geçerli bir *yerel ayar* ve *kategori* verilirse, **_locale_t** nesne olarak belirtilen yerel ayar ayarlarını döndürür. Programın geçerli yerel ayarları değiştirilmez.
