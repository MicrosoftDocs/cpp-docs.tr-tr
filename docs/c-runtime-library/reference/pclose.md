...
**_Pclose** işlevi, ilişkili tarafından başlatılan Komut işlemcisi (Cmd.exe) işlem kimliği arayan **_popen** çağrısı, yürüten bir [_cwait](cwait.md) yeni komutunu çağırın İşlemci ve ilişkili kanal akışta kapatır.
