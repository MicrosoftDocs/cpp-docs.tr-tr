---
description: ': Strtoul, _strtoul_l, wcstoul, _wcstoul_l hakkında daha fazla bilgi edinin'
...
Bu işlevlerin her biri, *strSource* giriş dizesini bir öğesine dönüştürür **`unsigned long`** .
