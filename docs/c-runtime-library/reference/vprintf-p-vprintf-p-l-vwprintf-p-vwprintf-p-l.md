...
**_vwprintf_p** geniş karakter sürümü **_vprintf_p**; akış ANSI modunda açılırsa iki işlevleri aynı şekilde davranır. **_vprintf_p** çıktı bir UNICODE akışa şu anda desteklemiyor.
