...
`LC_NUMERIC` Geçerli yerel kategori ayarı belirler tanıma taban noktası karakterinin *nptr*. Daha fazla bilgi için bkz: [setlocale](../../c-runtime-library/reference/setlocale-wsetlocale.md). Olmadan çalışır `_l` sonekini kullan geçerli yerel; `_strtod_l` aynıdır `_strtod_l` kullandıkları dışında *yerel* yerine geçilen. Daha fazla bilgi için bkz: [yerel ayar](../../c-runtime-library/locale.md).
...
[*boşluk*] [*oturum*] {**INF** &#124; **SONSUZ**}  
[*boşluk*] [*oturum*] **NAN** [*dizisi*]
