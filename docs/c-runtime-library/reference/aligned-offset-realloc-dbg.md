...
*Dosya adı*<br/>
İstenen kaynak dosyasının adını işaretçi **aligned_offset_realloc** işlemi veya **NULL**.

*LineNumber*<br/>
Satır numarası kaynak dosyasında nerede **aligned_offset_realloc** işlemi istendi veya **NULL**.
