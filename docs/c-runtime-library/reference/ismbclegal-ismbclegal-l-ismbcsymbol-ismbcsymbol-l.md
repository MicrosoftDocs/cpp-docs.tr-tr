---
description: 'Hakkında daha fazla bilgi edinin: _ismbclegal, _ismbclegal_l, _ismbcsymbol, _ismbcsymbol_l'
...
|---------------------|--------------------------------------|--------------------|-----------------------|
|**_istlegal**|Her zaman yanlış döndürür|**_ismbclegal**|Her zaman false döndürür.|
