# [CRT Alfabetik İşlev Başvurusu](crt-alphabetical-function-reference.md)
## [abort](abort.md)
...
## [assert Makrosu, _assert, _wassert](assert-macro-assert-wassert.md)
## [_ASSERT, _ASSERTE, _ASSERT_EXPR Makroları](assert-asserte-assert-expr-macros.md)
...
## [Bessel İşlevleri: _j0, _j1, _jn, _y0, _y1, _yn](bessel-functions-j0-j1-jn-y0-y1-yn.md)
## [bitand](bitand.md)
## [bitor](bitor.md)
## [bsearch](bsearch.md)
...
## [_countof Makrosu](countof-macro.md)
...
## [Kayan nokta temel elemanları](floating-point-primitives.md)
...
## [not](not.md)
## [not_eq](not-eq.md)
## [offsetof Makrosu](offsetof-macro.md)
...
## [_RPT, _RPTF, _RPTW, _RPTFW Makroları](rpt-rptf-rptw-rptfw-macros.md)
...
## [_STATIC_ASSERT Makrosu](static-assert-macro.md)
...
## [strtoull, _strtoull_l, wcstoull, _wcstoull_l](strtoumax-strtoumax-l-wcstoumax-wcstoumax-l.md)
