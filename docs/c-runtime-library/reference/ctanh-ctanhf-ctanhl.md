...
Çünkü C++ aşırı yüklemesi, sağlayan yüklerini çağırabilirsiniz **ctanh** alan ve getiren **_Fcomplex** ve **_Lcomplex** değerleri. C programında **ctanh** her zaman alan ve döndüren bir **_Dcomplex** değeri.
