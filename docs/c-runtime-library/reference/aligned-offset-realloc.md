...
**_aligned_offset_realloc** işaretlenir `__declspec(noalias)` ve `__declspec(restrict)`işlevin genel değişkenleri değiştirmeyeceği ve döndürülen işaretçinin diğer adı olmadığı anlamına gelir. Daha fazla bilgi için bkz. [noalias](../../cpp/noalias.md) ve [Restrict](../../cpp/restrict.md).

## <a name="remarks"></a>Açıklamalar

[_Aligned_offset_malloc](aligned-offset-malloc.md)gibi **_aligned_offset_realloc** , yapının yapı içindeki bir uzaklığa göre hizalanmasına izin verir.
