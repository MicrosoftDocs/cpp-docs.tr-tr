...
description: Microsoft C çalışma zamanı (CRT) kitaplığı işlevlerini setlocale ve _wsetlocaleöğesini açıklar.
ms.date: 4/2/2020
api_name:
- _wsetlocale
- setlocale
...
**_wsetlocale** , **setlocale**'in geniş karakterli bir sürümüdür; _wsetlocale *yerel ayar* bağımsız değişkeni ve dönüş **_wsetlocale** değeri geniş karakterli dizelerdir. **_wsetlocale** ve **setlocale** aynı şekilde davranır.
...
Daha fazla bilgi için [C/C++ Önişlemci Başvurusu](../../preprocessor/c-cpp-preprocessor-reference.md)içindeki [setlocale](../../preprocessor/setlocale.md) pragma yönergesine bakın.
