---
description: 'Hakkında daha fazla bilgi edinin: _mbsnbcmp _mbsnbcmp_l'
...
Bir parametre doğrulama hatası üzerinde **_mbsnbcmp** ve **_mbsnbcmp_l** , ve ' de tanımlanan **_NLSCMPERROR** döndürün \<string.h> \<mbstring.h> .
