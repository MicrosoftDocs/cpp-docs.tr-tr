---
description: 'Daha fazla bilgi edinin: Kasin, casinf, casinl'
...
C++ aşırı yüklemeye izin verdiğinden, **_Fcomplex** ve **_Lcomplex** değerleri alıp döndüren **Casin** aşırı yüklerini çağırabilirsiniz. C programında, **Casin** her zaman bir **_Dcomplex** değeri alır ve döndürür.
