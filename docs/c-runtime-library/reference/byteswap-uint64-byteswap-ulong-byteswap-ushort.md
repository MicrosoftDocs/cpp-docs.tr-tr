---
description: 'Hakkında daha fazla bilgi edinin: _byteswap_uint64, _byteswap_ulong, _byteswap_ushort'
...
*Acil*<br/>
Bayt sırasının ters çevrilmesi için tamsayı.
