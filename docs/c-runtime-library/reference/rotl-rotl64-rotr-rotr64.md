...
## <a name="remarks"></a>Açıklamalar  
 `_rotl` Ve `_rotr` işlevleri döndürme imzasız *değeri* tarafından `shift` BITS. `_rotl`Sol değeri döndürür. `_rotr`değer sağa döndürür. Her iki işlevleri devre dışı bir ucunu Döndürülmüş BITS kaydırma *değeri* diğer bitiş.  
