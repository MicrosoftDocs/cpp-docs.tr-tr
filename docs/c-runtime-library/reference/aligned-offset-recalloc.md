---
description: 'Hakkında daha fazla bilgi edinin: _aligned_offset_recalloc'
...
**_aligned_offset_recalloc** `__declspec(noalias)` `__declspec(restrict)` , ve işlevin genel değişkenleri değiştirmeyeceği ve döndürülen işaretçinin diğer ad olmadığından garanti edilen anlamına gelir. Daha fazla bilgi için bkz. [noalias](../../cpp/noalias.md) ve [Restrict](../../cpp/restrict.md).
