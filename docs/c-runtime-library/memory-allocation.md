...
|[siteyi g_enişlet](../c-runtime-library/reference/expand.md)|Bellek bloğu taşımadan genişlemesine veya|  
...
|[boş](../c-runtime-library/reference/free.md)|Boş ayrılan bloğu|  
...
|[Yeni](../c-runtime-library/operator-new-crt.md)|Bellek bloğu yığınından ayırın|  
