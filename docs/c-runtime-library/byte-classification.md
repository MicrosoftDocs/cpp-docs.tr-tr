...
>  Tanımı gereği, 0 ile 127 arasında ASCII karakterleri tüm çok baytlı karakter kümeleri bir alt kümesidir. Örneğin, ASCII olmayan karakterler yanı sıra ASCII Japonca katakana karakter kümesi içerir.  
 ...
 Aşağıdaki tabloda önceden tanımlanmış sabitleri CTYPE içinde tanımlanmıştır. H.  
...
|[_ismbbkpunct, _ismbbkpunct_l](../c-runtime-library/reference/ismbbkpunct-ismbbkpunct-l.md)|ASCII olmayan noktalama işareti. Örneğin, yalnızca kod sayfası 932 içinde `_ismbbkpunct` katakana noktalama için testleri.|  
