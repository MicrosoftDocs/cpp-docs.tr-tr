---
description: 'Daha fazla bilgi edinin: dosya Işleme'
title: Dosya İşleme
ms.date: 11/04/2016
f1_keywords:
- c.files
...
## <a name="file-handling-routines-file-descriptor"></a>File-Handling yordamlar (dosya tanımlayıcısı)
...
## <a name="file-handling-routines-path-or-filename"></a>File-Handling yordamlar (yol veya dosya adı)
...
|[kaldır, _wremove](../c-runtime-library/reference/remove-wremove.md)|Dosyayı sil|
|[yeniden adlandır, _wrename](../c-runtime-library/reference/rename-wrename.md)|Dosyayı yeniden adlandır|
...
## <a name="file-handling-routines-open-file"></a>File-Handling yordamlar (dosya aç)
