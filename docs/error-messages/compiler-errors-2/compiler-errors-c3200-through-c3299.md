...
|[Derleyici Hatası C3202](compiler-error-c3202.md)|'*tanımlayıcı*': Geçersiz varsayılan bağımsız değişken; sınıf şablonu bekleniyor|
|[Derleyici Hatası C3203](compiler-error-c3203.md)|'*tanımlayıcı*': uzmanlaşmamış sınıf şablonu/genel şablon/genel parametresi için bir şablon/genel bağımsız değişkeni olarak kullanılamaz '*parametre*', gerçek tür bekleniyor|
|[Derleyici Hatası C3204](compiler-error-c3204.md)|'*işlevi*' den bir catch bloğunun içinden çağrılamaz|
|[Derleyici Hatası C3205](compiler-error-c3205.md)|Şablon parametresi şablonun bağımsız değişken listesi '*tanımlayıcı*' eksik|
|[Derleyici Hatası C3206](compiler-error-c3206.md)|'*işlevi*': Geçersiz şablon/genel bağımsız değişkeni için '*şablon*', sınıf şablonu/genel şablon/genel bağımsız değişken listesi eksik '*türü*'|
|[Derleyici Hatası C3207](compiler-error-c3207.md)|'*işlevi*': Geçersiz şablon bağımsız değişkeni için '*parametre*', sınıf şablonu bekleniyor|
|[Derleyici Hatası C3208](compiler-error-c3208.md)|'*işlevi*': sınıf şablonunun şablon parametre listesi '*şablon*'şablonu şablon parametresinin şablon parametre listesiyle eşleşmiyor'*parametre*'|
|[Derleyici Hatası C3209](compiler-error-c3209.md)|'*türü*': Genel sınıf bir yönetilen/WinRT sınıfı olmalıdır|
|[Derleyici Hatası C3210](compiler-error-c3210.md)|'*tanımlayıcı*': erişim bildirimi yalnızca bir temel sınıf üyesine uygulanabilir|
|[Derleyici Hatası C3211](compiler-error-c3211.md)|'*işlevi*': açık özelleştirme kısmı özelleştirme sözdizimi kullanıyor, bunun yerine şablon <> kullanın|
|[Derleyici Hatası C3212](compiler-error-c3212.md)|'*işlevi*': bir şablon üyesinin açık alt uzmanlaşması özelleştirmesi bir açık özelleştirmenin üyesi olmalıdır|
|[Derleyici Hatası C3213](compiler-error-c3213.md)|temel sınıfı*sınıfı*'den daha az erişilebilir olan'*derived_class*'|
|[Derleyici Hatası C3214](compiler-error-c3214.md)|'*bağımsız değişken*': genel parametresi için geçersiz tür bağımsız değişkeni '*parametre*'ın, genel'*türü*', kısıtlamasını karşılamıyor '*kısıtlaması*'|
|[Derleyici Hatası C3215](compiler-error-c3215.md)|'*constraint1*': genel tür parametresi zaten tarafından kısıtlanmış '*constraint2*'|
|[Derleyici Hatası C3216](compiler-error-c3216.md)|kısıtlaması olmamalı genel parametre '*türü*'|
|[Derleyici Hatası C3217](compiler-error-c3217.md)|'*parametre*': Bu bildirimde genel parametre kısıtlanamaz|
|[Derleyici Hatası C3218](compiler-error-c3218.md)|'*türü*': tür kısıtlama kullanılamaz|
|[Derleyici Hatası C3219](compiler-error-c3219.md)|'*parametre*': genel parametre birden fazla arabirim olmayan öğe tarafından kısıtlanamaz: '*türü*'|
|Derleyici Hatası C3220|'*arabirimi*': arabirimin program kimliği olamaz|
|Derleyici Hatası C3221|'*üye*': birden fazla 'default' ve 'case' özniteliğine üzerindeki bir üyeye izin verilmiyor|
|[Derleyici Hatası C3222](compiler-error-c3222.md)|'*işlevi*': üye için varsayılan bağımsız değişkenler, İşlevler yönetilen WinRT türü veya genel işlevlerin bildiremezsiniz.|
|[Derleyici Hatası C3223](compiler-error-c3223.md)|'*özelliği*': bir özelliğe 'typeid' uygulayamazsınız|
|[Derleyici Hatası C3224](compiler-error-c3224.md)|'*türü*': hiçbir aşırı yüklenmiş genel sınıf alır*sayı*' genel tür bağımsız değişkenleri|
|[Derleyici Hatası C3225](compiler-error-c3225.md)|genel tür bağımsız değişkeni için '*bağımsız değişken*'olamaz'*türü*', değer türü veya bir başvuru türü için bir tanıtıcı olmalıdır|
|[Derleyici Hatası C3226](compiler-error-c3226.md)|Genel bildirim içinde şablon bildirimine izin verilmez|
|[Derleyici Hatası C3227](compiler-error-c3227.md)|'*türü*': kullanamazsınız '*işleci*' genel tür ayırmak için|
|[Derleyici Hatası C3228](compiler-error-c3228.md)|'*işlevi*': genel tür bağımsız değişkeni için '*bağımsız değişken*'olamaz'*türü*', değer türü olması gerekir veya tanıtıcı türü|
|[Derleyici Hatası C3229](compiler-error-c3229.md)|'*türü*': genel tür parametresi yöneltmelere izin verilmez|
|[Derleyici Hatası C3230](compiler-error-c3230.md)|'*işlevi*': şablon türü bağımsız değişkeni için '*bağımsız değişken*' genel tür parametresi içeremez: '*türü*'|
|[Derleyici Hatası C3231](compiler-error-c3231.md)|'*türü*': şablon türü bağımsız değişkeni, genel tür parametresi kullanamaz|
|[Derleyici Hatası C3232](compiler-error-c3232.md)|'*parametre*': genel tür parametresi bir nitelenmiş adda kullanılamaz|
|[Derleyici Hatası C3233](compiler-error-c3233.md)|'*türü*': genel tür parametresi zaten kısıtlanmış|
|[Derleyici Hatası C3234](compiler-error-c3234.md)|Genel sınıf bir genel tür parametresinden türetilemez|
...
|[Derleyici Hatası C3271](compiler-error-c3271.md)|'*alan*': geçersiz değer '*sayı*' FieldOffset özniteliği için|
