---
title: Derleyici Hatası C3509 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33257421"
---
# <a name="compiler-error-c3509"></a>Derleyici Hatası C3509
'type': Geçersiz Otomasyon dönüş türü; bir parametre olarak işaretlenmiş 'retval', dönüş türü olduğunda 'void', 'HRESULT' veya 'SCODE' olmalıdır  
  
 COM arabirimi yönteminde, void veya HRESULT döndürmesi gerekir.  
