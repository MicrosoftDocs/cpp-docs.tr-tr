...
ms.locfileid: "33255810"
---
# <a name="compiler-error-c3057"></a>Derleyici Hatası C3057
'simgesi': 'threadprivate' simgelerin dinamik başlatma şu anda desteklenmiyor  
  
 Kullanılan bir simge başlatılmış değeri bir [threadprivate](../../parallel/openmp/reference/threadprivate.md) derleme zamanında yan tümcesi bilinen.  
