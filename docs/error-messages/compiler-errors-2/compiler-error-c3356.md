---
description: 'Hakkında daha fazla bilgi: derleyici hatası C3356'
title: Derleyici hatası C3356
ms.date: 11/04/2016
f1_keywords:
- C3356
helpviewer_keywords:
...
ms.locfileid: "97150923"
---
# <a name="compiler-error-c3356"></a>Derleyici hatası C3356

' Attribute ': bir çok noktaya yayın özniteliği bir tam adla çağrılamaz

Birden fazla işlem tarafından işlenen bir öznitelik (örneğin, derleyici ve ATL sağlayıcısı) yanlış belirtildi.
