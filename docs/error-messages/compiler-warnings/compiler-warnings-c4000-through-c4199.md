...
|[Derleyici Uyarısı (düzey 1) C4002](compiler-warning-level-1-c4002.md)|Makro 'identifier' için çok fazla sayıda gerçek parametre|
...
|[Derleyici Uyarısı (düzey 1) C4025](compiler-warning-level-1-c4025.md)|'function': değişken bağımsız değişkenleri olan işleve based işaretçi geçirildi: parametre 'parameter_number'|
|[Derleyici Uyarısı (düzey 1) C4026](compiler-warning-level-1-c4026.md)|işlev biçimsel parametre listesiyle bildirildi|
|[Derleyici Uyarısı (düzey 1) C4027](compiler-warning-level-1-c4027.md)|işlev biçimsel parametre listesi olmadan bildirildi|
...
|[Derleyici Uyarısı (düzey 1) C4030](compiler-warning-level-1-c4030.md)|ilk biçimsel parametre listesi ikinci listeden uzun|
...
|[Derleyici Uyarısı (düzey 1) C4036](compiler-warning-level-1-c4036.md)|'type' gerçek parametre olarak adsız|
|[Derleyici Uyarısı (düzey 1) C4038](compiler-warning-level-1-c4038.md)|'değiştiricisi': geçersiz sınıf değiştiricisi|
|[Derleyici Uyarısı (düzey 1) C4041](compiler-warning-level-1-c4041.md)|Derleyici sınırı: yarayıcı çıktısı sonlandırılıyor|
...
|[Derleyici Uyarısı (Düzey 3) C4066](compiler-warning-level-3-c4066.md)|geniş karakter sabiti göz ardı ilk sabitten sonraki karakterler|
...
|[Derleyici Uyarısı (düzey 1) C4081](compiler-warning-level-1-c4081.md)|Beklenen 'token1'; 'token2' bulundu|
...
|[Derleyici Uyarısı (düzey 1) C4085](compiler-warning-level-1-c4085.md)|Beklenen pragma parametresinin 'on' veya 'off' olması|
|[Derleyici Uyarısı (düzey 1) C4086](compiler-warning-level-1-c4086.md)|Beklenen pragma parametresinin '1', '2', '4', ' 8' veya ' 16' olması|
|[Derleyici Uyarısı (düzey 1) C4087](compiler-warning-level-1-c4087.md)|'function': 'void' parametre listesiyle bildirildi|
...
|[Derleyici Uyarısı (düzey 1 ve düzey 4) C4115](compiler-warning-levels-1-and-4-c4115.md)|'type': parantez içinde tür tanımı adı|
...
|[Derleyici Uyarısı (düzey 1) C4117](compiler-warning-level-1-c4117.md)|Makro adı 'name' ayrılmıştır, 'command' yoksayıldı|
|[Derleyici Uyarısı (düzey 1) C4119](compiler-warning-level-1-c4119.md)|farklı Tabanları 'base1' ve 'belirtilen base2'|
|[Derleyici Uyarısı (düzey 1) C4120](compiler-warning-level-1-c4120.md)|based/unbased uyuşmazlığı|
...
|[Derleyici Uyarısı (düzey 4) C4125](compiler-warning-level-4-c4125.md)|ondalık basamak sekizlik kaçış sırasını sonlandırıyor|
...
|[Derleyici Uyarısı (düzey 1) C4163](compiler-warning-level-1-c4163.md)|'identifier': iç işlev olarak kullanılamaz|
|[Derleyici Uyarısı (düzey 1) C4164](compiler-warning-level-1-c4164.md)|'function': iç işlevin bildirimi yapılmadı|
|[Derleyici Uyarısı (düzey 1) C4165](compiler-warning-level-1-c4165.md)|'HRESULT' 'bool'; dönüştürülüyor budur başlatmak için istediğinize emin misiniz?|
|[Derleyici Uyarısı (düzey 1) C4166](compiler-warning-level-1-c4166.md)|Oluşturucu/yıkıcı için geçersiz çağrı kuralı|
|[Derleyici Uyarısı (düzey 1) C4167](compiler-warning-level-1-c4167.md)|'function': iç işlev olarak kullanılabilir|
|[Derleyici Uyarısı (düzey 1) C4168](compiler-warning-level-1-c4168.md)|Derleyici sınırı: hata ayıklayıcı türü kalmadı, 'database' program veritabanını silin ve yeniden oluşturun|
...
|[Derleyici Uyarısı (düzey 1) C4175](compiler-warning-level-1-c4175.md)|#pragma component(browser, on): tarayıcı bilgileri başlangıçta girilmesi gerekir komut satırında|
|[Derleyici Uyarısı (düzey 1) C4176](compiler-warning-level-1-c4176.md)|'alt': #pragma bileşen tarayıcısı için Bilinmeyen alt bileşen|
...
|[Derleyici Uyarısı (düzey 1) C4178](compiler-warning-level-1-c4178.md)|Case sabiti 'sabiti' türü için çok büyük switch ifadesi|
|[Derleyici Uyarısı (düzey 4) C4179](compiler-warning-level-1-c4179.md)|'//*': olarak ayrıştırılır '/' ve ' /\*': Karışıklığı önlemek için standart ' / /' yorum|
|[Derleyici Uyarısı (düzey 1) C4180](compiler-warning-level-1-c4180.md)|işlev türüne uygulanan niteleyicinin bir anlamı yoktur; yoksayıldı|
|Derleyici Uyarısı C4181|başvuru türüne uygulanan niteleyicinin; yoksayıldı|
|[Derleyici Uyarısı (düzey 1) C4182](compiler-warning-level-1-c4182.md)|#include iç içe geçme düzeyi olan 'nest_count' derin; sonsuz özyineleme olasılığı|
...
|[Derleyici Uyarısı (düzey 1) C4185](compiler-warning-level-1-c4185.md)|'attribute' Bilinmeyen #import özniteliği yoksayılıyor|
|[Derleyici Uyarısı (düzey 1) C4186](compiler-warning-level-1-c4186.md)|#import özniteliği 'attribute', 'argument_count' bağımsız değişken gerektiriyor; yoksayıldı|
|[Derleyici Uyarısı (düzey 1) C4187](compiler-warning-level-1-c4187.md)|#import öznitelikleri 'öznitelik1' ve 'öznitelik2' uyumsuz; her ikisi de yoksayıldı|
