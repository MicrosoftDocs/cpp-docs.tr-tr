...
Bazı yayınları güvenlidir (örneğin, bir `static_cast` , kullanıcı tanımlı dönüşümler tetikler ve `const_cast`). A [safe_cast](../../windows/safe-cast-cpp-component-extensions.md) doğrulanabilen kod üretmek için sağlanır.
