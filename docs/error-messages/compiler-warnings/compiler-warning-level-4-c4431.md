...
Bu hata, görsel için yapıldığı derleyici uyumluluğu iş sonucu olarak oluşturulabilir C++ 2005: Görsel C++ artık yazılmamış tanımlayıcıları int varsayılan olarak oluşturur. Bir tanımlayıcı türünü açıkça belirtilmesi gerekir.
