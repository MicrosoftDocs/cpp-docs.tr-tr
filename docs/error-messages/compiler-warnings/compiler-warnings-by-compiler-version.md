...
description: Derleyici sürümüne göre Microsoft C/C++ derleyicisi uyarıları tablosu.
ms.date: 10/18/2020
helpviewer_keywords:
...
Derleyici, derleyici seçeneğini kullanarak belirttiğiniz sürümden sonra tanıtılan uyarıları engelleyebilir [`/Wv`](../../build/reference/compiler-option-warning-level.md) . Bu seçenek, yeni bir araç takımı sürümü oluştururken derleme işleminizi yönetmek ve yeni uyarıları geçici olarak gizlemek istediğinizde yararlıdır. Bu seçenek yalnızca uyarıları göstermez, yeni hata iletileri göstermez. Tüm yeni uyarıları kalıcı olarak göstermez! Her zaman en yüksek düzenli uyarı düzeyinde derleme yapmanız ve derlemenizde **`/W4`** **`/Wv`** seçeneği pratik olarak kaldırmanız önerilir.
...
| Visual Studio 2015 Güncelleştirme 1 | 19.00.23506.0 |
...
| Visual Studio 2017 sürüm 15.7 Sürüm Notları | 19.14.26428.0 |
...
|  Visual Studio 2019 sürüm 16.1 | 19.21.27702.0 |
|  Visual Studio 2019 sürüm 16.2  | 19.22.27905.0 |
| Visual Studio 2019 sürüm 16,3 | 19.23.28105.0 |
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.26`** .
...
## <a name="warnings-introduced-in-visual-studio-2019-version-166-compiler-version-1926288050"></a>Visual Studio 2019 sürüm 16,6 ' de tanıtılan uyarılar (derleyici sürümü 19.26.28805.0)

Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.25`** .
...
## <a name="warnings-introduced-in-visual-studio-2019-version-165-compiler-version-1925286100"></a>Visual Studio 2019 sürüm 16,5 ' de tanıtılan uyarılar (derleyici sürümü 19.25.28610.0)

Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.24`** .
...
## <a name="warnings-introduced-in-visual-studio-2019-version-164-compiler-version-1924283140"></a>Visual Studio 2019 sürüm 16,4 ' de tanıtılan uyarılar (derleyici sürümü 19.24.28314.0)

Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.23`** .

| Uyarı | İleti |
|--|--|
| C5200 | `feature 'feature-name' requires compiler flag 'option-name'` | Dil özellikleri için C2429 ile eşdeğer bir uyarı
...
## <a name="warnings-introduced-in-visual-studio-2019-version-163-compiler-version-1923281050"></a>Visual Studio 2019 sürüm 16,3 ' de tanıtılan uyarılar (derleyici sürümü 19.23.28105.0)

Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.22`** .
...
## <a name="warnings-introduced-in-visual-studio-2019-version-162-compiler-version-1922279050"></a>Visual Studio 2019 sürüm 16,2 ' de tanıtılan uyarılar (derleyici sürümü 19.22.27905.0)

Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.21`** .
...
## <a name="warnings-introduced-in-visual-studio-2019-version-161-compiler-version-1921277020"></a>Visual Studio 2019 sürüm 16,1 ' de tanıtılan uyarılar (derleyici sürümü 19.21.27702.0)

Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.20`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.15`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.14`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.13`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.12`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.11`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.10`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.00`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.00.23918`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.00.23506`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:19.00.23026`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:18`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:17`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:16`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:15`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:14`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:13`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:13.00.9466`** .
...
Bu uyarılar ve sonraki sürümlerde bulunan tüm uyarılar, derleyici seçeneği kullanılarak bastırılır **`/Wv:12`** .
