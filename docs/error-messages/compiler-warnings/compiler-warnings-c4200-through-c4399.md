...
|[Derleyici Uyarısı (düzey 4) C4207](../../error-messages/compiler-warnings/compiler-warning-level-4-c4207.md)|Standart olmayan uzantı kullanıldı: uzatılmış Başlatıcı biçimi|
