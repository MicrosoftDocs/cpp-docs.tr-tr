...
|[Derleyici Uyarısı (düzey 4) C4221](../../error-messages/compiler-warnings/compiler-warning-level-4-c4221.md)|kullanılan standart olmayan uzantısı: 'tanımlayıcısı': 'değişkeni' otomatik değişkenin adresini kullanarak başlatılamaz|
...
|[Derleyici Uyarısı (düzey 1) C4224](../../error-messages/compiler-warnings/compiler-warning-level-1-c4224.md)|kullanılan standart olmayan uzantısı: biçimsel parametresi 'tanımlayıcısı' daha önce bir tür olarak tanımlanmıştı|
|[Derleyici Uyarısı (düzey 1, hata) C4226](../../error-messages/compiler-warnings/compiler-warning-level-1-c4226.md)|kullanılan standart olmayan uzantısı: 'anahtar sözcüğü' olan bir geçersiz anahtar sözcüğü|
...
|[Derleyici Uyarısı (düzey 4) C4232](../../error-messages/compiler-warnings/compiler-warning-level-4-c4232.md)|kullanılan standart olmayan uzantısı: 'tanımlayıcısı': adresi dllimport 'dllimport' değil statik kimlik garanti edilmez|
|[Derleyici Uyarısı (düzey 4, hata) C4233](../../error-messages/compiler-warnings/compiler-warning-level-4-c4233.md)|kullanılan standart olmayan uzantısı: C++, C değil yalnızca desteklenen 'anahtar sözcüğü' anahtar sözcüğü|
|[Derleyici Uyarısı (düzey 4, hata) C4234](../../error-messages/compiler-warnings/compiler-warning-level-4-c4234.md)|kullanılan standart olmayan uzantısı: gelecekte kullanılmak üzere ayrılmış 'anahtar sözcüğü' anahtar sözcüğü|
|[Derleyici Uyarısı (düzey 4, hata) C4235](../../error-messages/compiler-warnings/compiler-warning-level-4-c4235.md)|kullanılan standart olmayan uzantısı: Bu mimarisine desteklenmeyen 'anahtar sözcüğü' anahtar sözcüğü|
...
|[Derleyici Uyarısı (düzey 4) C4256](../../error-messages/compiler-warnings/compiler-warning-level-4-c4256.md)|'function': sanal tabanları ile sınıf için bir oluşturucuya sahip '...'; çağrıları Visual C++ eski sürümleriyle uyumlu olmayabilir|
...
|[Derleyici Uyarısı (düzey 1) C4297](../../error-messages/compiler-warnings/compiler-warning-level-1-c4297.md)|'function': işlevi kabul ancak bir özel durum yok|
...
|Derleyici Uyarısı (düzey 4) C4315|'classname': 'this' üyesi 'member' işaretçisi hizalanmış 'hizalama' oluşturucusu tarafından beklendiği gibi olmayabilir|
|Derleyici Uyarısı (Düzey 3) C4316|'tanımlayıcısı': yığında ayrılmış nesne hizalanmış 'hizalama' olamaz|
...
|[Derleyici Uyarısı (düzey 1) C4319](../../error-messages/compiler-warnings/compiler-warning-level-1-c4319.md)|'işleci': sıfır genişletme 'type1' büyük boyutta 'type2'|
|Derleyici Uyarısı (düzey 1) C4321|'%$S' arabirimin IID'yi otomatik olarak oluşturma|
|Derleyici Uyarısı (düzey 1) C4322|sınıfı '%$S' CLSID otomatik olarak oluşturma|
|Derleyici Uyarısı (düzey 1) C4323|CLSID '%$S' sınıfı için kayıtlı yeniden kullanma|
...
|[Derleyici Uyarısı (düzey 1) C4325](../../error-messages/compiler-warnings/compiler-warning-level-1-c4325.md)|Standart 'göz ardı bölüm' bölümü için öznitelikler|
|[Derleyici Uyarısı (düzey 1) C4326](../../error-messages/compiler-warnings/compiler-warning-level-1-c4326.md)|'işlevinin' dönüş türü 'type2' yerine ' type1' olmalıdır|
|C4327 uyarı derleyici|'Ataması': LHS ('alignment1') yöneltme hizalamasını RHS ('alignment2') büyük|
|C4328 uyarı derleyici|'function': biçimsel parametresi parameter_number (parameter_alignment) yöneltme hizalamasını gerçek bağımsız değişkeni hizalama (argument_alignment) büyük|
...
|Derleyici Uyarısı (düzey 4) C4338|#pragma %s standart Bölümü '%s' kullanılır|
|[Derleyici Uyarısı (düzey 4) C4339](../../error-messages/compiler-warnings/compiler-warning-level-4-c4339.md)|'type': algılandı tanımsız tür kullanımı ' WinRT &#124; CLR' meta veri - bu tür kullanımına neden olabilir bir çalışma zamanı özel durumu|
|[Derleyici Uyarısı (düzey 1) C4340](../../error-messages/compiler-warnings/compiler-warning-level-1-c4340.md)|'value': pozitif negatif değer olarak kaydırılan değeri|
|[Derleyici Uyarısı (düzey 1) C4342](../../error-messages/compiler-warnings/compiler-warning-level-1-c4342.md)|behavior change: 'function' çağrıldı, ancak önceki sürümlerde bir üye işleç çağrılıyordu|
|Derleyici Uyarısı (düzey 4) C4343|#pragma optimize("g",off) /Og seçeneğini geçersiz kılar|
|[Derleyici Uyarısı (düzey 1) C4344](../../error-messages/compiler-warnings/compiler-warning-level-1-c4344.md)|davranış değişikliği: açık şablon bağımsız değişken sonuçları 'Function 'işlevine yapılan çağrıda kullanımı|
|[Derleyici Uyarısı (düzey 1) C4346](../../error-messages/compiler-warnings/compiler-warning-level-1-c4346.md)|'name': bağımlı adı bir tür değil|
|[Derleyici Uyarısı (düzey 1) C4348](../../error-messages/compiler-warnings/compiler-warning-level-1-c4348.md)|'type': yeniden tanımlama varsayılan parametre: parametre 'parameter_number'|
|[Derleyici Uyarısı (düzey 1) C4350](../../error-messages/compiler-warnings/compiler-warning-level-1-c4350.md)|behavior change: 'member2' yerine 'member1' çağrıldı|
...
|[Derleyici Uyarısı (düzey 4) C4366](../../error-messages/compiler-warnings/compiler-warning-level-4-c4366.md)|Birli 'işleci' işlecinin sonucu hizalanmamış olabilir|
|Derleyici Uyarısı (Düzey 3) C4367|'%$T' '%$T' dönüştürme datatype uyuşmazlığın özel durumuna neden olabilir|
|[Derleyici Uyarısı (hata) C4368](../../error-messages/compiler-warnings/compiler-warning-c4368.md)|Yönetilen 'type' üyesi olarak 'üyesi' tanımlanamıyor: karışık türleri desteklenmiyor|
|[Derleyici Uyarısı (düzey 1) C4369](../../error-messages/compiler-warnings/compiler-warning-level-1-c4369.md)|'Numaralandırıcı': Numaralayıcı değeri 'value' 'type' temsil edilemez, değer 'yeni_değer'.|
|C4370 uyarı derleyici|'classname': sınıf yerleşimini daha iyi paketleme nedeniyle Derleyici önceki bir sürümünden değişti|
|Derleyici Uyarısı (Düzey 3) C4371|'classname': sınıf yerleşimini 'member' üyesinin daha iyi paketleme nedeniyle Derleyici önceki bir sürümünden değişmiş olabilir|
|Derleyici Uyarısı (Düzey 3) C4373|'derived_class::function': sanal işlevi geçersiz kılmaları 'base_class::function', önceki sürümlerini derleyici parametreleri yalnızca const/volatile niteleyicileri tarafından farklıydı olduğunda geçersiz|
|[Derleyici Uyarısı (düzey 1) C4374](../../error-messages/compiler-warnings/compiler-warning-level-1-c4374.md)|'function1': arabirim yöntemi uygulanmadı sanal olmayan bir yöntemle 'function2'|
|[Derleyici Uyarısı (düzey 1) C4375](../../error-messages/compiler-warnings/compiler-warning-level-1-c4375.md)|genel yöntem 'method2' 'method2' kılmaz|
...
|[Derleyici Uyarısı (düzey 1) C4379](../../error-messages/compiler-warnings/compiler-warning-level-1-c4379.md)|Ortak dil çalışma zamanı ' version_number' sürümü bu derleyici tarafından desteklenmiyor. Bu sürümünü kullanarak beklenmeyen sonuçlara neden olabilir|
|Derleyici Uyarısı (düzey 1, hata) C4380|'%$S': varsayılan bir oluşturucu kullanım|
...
|[Derleyici Uyarısı (düzey 1) C4382](../../error-messages/compiler-warnings/compiler-warning-level-1-c4382.md)|'type' atma: / CLR __clrcall yıkıcı veya kopya Oluşturucu türüyle yalnızca yakalanabilir: Saf Modülü|
|[Derleyici Uyarısı (düzey 1) C4383](../../error-messages/compiler-warnings/compiler-warning-level-1-c4383.md)|'instance_dereference_operator': bir kullanıcı tanımlı 'instance_dereference_operator' işleci mevcut; bir tanıtıcı başvurusunun kaldırılmasının anlamı, değiştirebilirler işlenen hakkında açık olması için statik bir işlevi olarak işleci yazma|
...
|[Derleyici Uyarısı C4394](../../error-messages/compiler-warnings/compiler-warning-c4394.md)|'function': appdomain başına simgesi işaretlenmemiş __declspec('dllexport') ile|
