---
description: 'Hakkında daha fazla bilgi edinin: Derleyici Uyarısı (düzey 1) C4122'
title: Derleyici Uyarısı (düzey 1) C4122
ms.date: 11/04/2016
f1_keywords:
- C4122
helpviewer_keywords:
...
**Alloc_text** pragma yalnızca **extern c** ile belirtilen işlevler için geçerlidir. Dış C++ işlevleriyle kullanılamaz.
