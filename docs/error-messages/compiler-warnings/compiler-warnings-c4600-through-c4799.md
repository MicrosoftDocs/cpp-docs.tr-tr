...
|[Derleyici Uyarısı (düzey 1) C4603](compiler-warning-level-1-c4603.md)|'*tanımlayıcı*': Makro tanımlı değil veya tanımı, önceden derlenmiş üstbilgi kullanımından farklıdır|
...
|[Derleyici Uyarısı (düzey 1) C4612](compiler-warning-level-1-c4612.md)|hataya dahil etmek, dosya adı|
|[Derleyici Uyarısı (düzey 1) C4613](compiler-warning-level-1-c4613.md)|'*sembol*': kesimin sınıfı değiştirilemez|
...
|[Derleyici Uyarısı (düzey 4) C4629](compiler-warning-level-4-c4629.md)|Digraph kullanıldığında, belirteç char (Bu değilse, iki karakter arasına bir boşluk ekleyin)' olarak yorumlanıp'digraph ' karakter dizisi|
