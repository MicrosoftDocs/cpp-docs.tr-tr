---
title: Profil Temelli İyileştirme hataları ve uyarıları
ms.date: 04/17/2019
f1_keywords:
- PG0001
- PG0002
...
ms.locfileid: "62359754"
---
# <a name="profile-guided-optimization-errors-and-warnings-pgxxxx"></a>Profil temelli iyileştirme hataları ve Uyarıları (PGxxxx)

Bu bölümde permutasyonları iyileştirme (PGO) araçları tarafından oluşturulan hatalara bir başvurudur. PGO hataları ve Uyarıları olan form PG*xxxx*burada *xxxx* bir dört basamaklı sayıdır.

[!INCLUDE[error-boilerplate](../../error-messages/includes/error-boilerplate.md)]

## <a name="pgo-errors"></a>PGO hataları

[Profil Temelli İyileştirme Hatası PG0165](../../error-messages/tool-errors/profile-guided-optimization-error-pg0165.md)

## <a name="pgo-warnings"></a>PGO uyarıları
