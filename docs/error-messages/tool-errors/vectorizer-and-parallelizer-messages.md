...
|1006|Bu işlevi içeren **openmp**. Herhangi bir kaldırarak bu sorunu çözmek **openmp** Bu işlevde.|  
|1007|Döngü endüksiyon değişkeni veya döngü sınırları imzalı 32-bit sayı değil (`int` veya `long`). Endüksiyon değişkeninin türünü değiştirerek sorunu çözebilirsiniz.|  
...
|1009|Derleyici, "do-while" döngüsünü paralel hale getirme denemesi algıladı. Otomatik paralel hale getirici yalnızca hedefler `for` döngüler.|  
|1010|Döngü "eşittir değil" kullandığını derleyici algılandı (! =), koşul için.|  
...
|1401|**/ Kernel** x86 veya ARM hedeflerken anahtarı belirtilir.|  
|1402|**/arch:SSE2** ya da daha yüksek anahtar x86 hedeflerken belirtilmedi.|  
|1403|**/arch:Atom** anahtarı belirtilir ve döngü çiftleri işlemlerini içerir.|  
|1404|**/ O1** veya **/Os** anahtarı belirtilir.|  
