...
Parametre `number1` listesine geçirilen parametre `number2` bir **`void`** parametredir. Parametrelerin türü olamaz **`void`** . **`void*`** Bunun yerine kullanın.
