...
ms.locfileid: "62152611"
---
# <a name="compiler-error-c2268"></a>Derleyici Hatası C2268

'function' bir önceden tanımlanmış bir derleyici kitaplık yardımcı dosyasıdır. Kitaplık Yardımcıları /GL ile desteklenmez; Nesne dosyasını /GL olmadan ' file' derleyin

Kaynak kodunuzu tanımlanan bir işlev, derleyici iç işlev olarak aynı ada sahip. Olmadan işlevi içeren modül derlemek [/GL](../../build/reference/gl-whole-program-optimization.md).
