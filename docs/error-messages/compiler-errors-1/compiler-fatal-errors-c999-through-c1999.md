...
|Hata|İleti|
|-----------|-------------|
|[Önemli Hata C999](../../error-messages/compiler-errors-1/fatal-error-c999.md)|Lütfen Bilinmeyen ileti Visual C++ Yardım menüsünden teknik destek komut seçin veya daha fazla bilgi için teknik destek Yardım dosyasını açın|
|[Önemli Hata C1001](../../error-messages/compiler-errors-1/fatal-error-c1001.md)|Derleyicide bir iç hata oluştu.<br /><br /> (derleyici dosya '*dosya*', satır *numarası*)<br /><br /> Bu sorunu geçici olarak çözmek için yukarıda basitleştirme veya programın konumları yakın değiştirme deneyin listelenen. Visual C++ Yardım menüsünden teknik destek komut seçin ya da daha fazla bilgi için teknik destek Yardım dosyasını açın|
|[Önemli Hata C1002](../../error-messages/compiler-errors-1/fatal-error-c1002.md)|yığın alanı 2 geçişindeki derleyici dışındadır|
|[Önemli Hata C1003](../../error-messages/compiler-errors-1/fatal-error-c1003.md)|hata sayısı aşıyor *numarası*; derleme durdurma|
|[Önemli Hata C1004](../../error-messages/compiler-errors-1/fatal-error-c1004.md)|Beklenmeyen son bulunan dosya|
|[Önemli Hata C1005](../../error-messages/compiler-errors-1/fatal-error-c1005.md)|dize için arabellek boyutu çok büyük|
...
|[Önemli Hata C1009](../../error-messages/compiler-errors-1/fatal-error-c1009.md)|Derleyici sınırı: Makro çok fazla iç içe|
...
|Önemli hata C1013|Derleyici sınırı: çok fazla açık parantez|
|Önemli hata C1014|çok fazla dosyaları dahil etme: derinliği = *numarası*|
|Önemli hata C1016|#ifdef / #ifndef tanımlayıcıyı bekleniyor|
|[Önemli Hata C1017](../../error-messages/compiler-errors-1/fatal-error-c1017.md)|Geçersiz tamsayı sabit ifade|
|Önemli hata C1018|Beklenmeyen #elif|
|Önemli hata C1019|Beklenmeyen #else|
|Önemli hata C1020|Beklenmeyen #endif|
|Önemli hata C1021|Geçersiz önişlemci komut '*dize*'|
|Önemli hata C1022|Beklenen #endif|
|Önemli hata C1023|'*dosya*': pch, beklenmeyen bir hatayla deneyin pch yeniden oluşturma|
|[Önemli Hata C1026](../../error-messages/compiler-errors-1/fatal-error-c1026.md)|Ayrıştırıcı yığın taşması, program çok karmaşık|
|[Önemli Hata C1033](../../error-messages/compiler-errors-1/fatal-error-c1033.md)|Program veritabanı açılamıyor. '*dosya*'|
|Önemli hata C1034|*Dosya*: hiçbir yolu grubu içerir|
|Önemli hata C1035|ifade çok karmaşık; İfadeyi sadeleştirmek|
...
|[Önemli Hata C1085](../../error-messages/compiler-errors-1/fatal-error-c1085.md)|yazılamıyor *türü* dosya: '*dosya*': *iletisi*|
...
|[Önemli Hata C1197](../../error-messages/compiler-errors-1/fatal-error-c1197.md)|başvuramaz. '*dosya*'program zaten başvurmuş gibi'*dosya*'|
...
|[Önemli Hata C1603](../../error-messages/compiler-errors-1/fatal-error-c1603.md)|Satır içi derleme şube hedef tarafından aralık dışında *numarası* bayt|
