---
title: Derleyici Önemli Hataları C999 - C1999
ms.date: 11/17/2017
f1_keywords:
- C1012
- C1013
...
|[Önemli Hata C1001](../../error-messages/compiler-errors-1/fatal-error-c1001.md)|Derleyicide bir iç hata oluştu.<br /><br /> (derleyici dosyası '*dosya*', satır *numarası*)<br /><br /> Basitleştirmeyi veya yukarıda listelenen konumların yakınındaki programı değiştirmeyi deneyin. Bu sorunu geçici olarak çözmek için. Lütfen Visual C++ Yardım menüsünde teknik destek komutunu seçin veya daha fazla bilgi için teknik destek Yardım dosyasını açın|
...
|Önemli hata C1012|eşleşmeyen parantez: eksik '*karakter*"|
|Önemli hata C1013|Derleyici sınırı: çok fazla açık parantez var|
|Önemli hata C1014|çok fazla sayıda ekleme dosyası: derinlik = *numarası*|
|Önemli hata C1016|#ifdef / #ifndef bir tanımlayıcı bekleniyor|
|[Önemli Hata C1017](../../error-messages/compiler-errors-1/fatal-error-c1017.md)|Geçersiz tamsayı sabit ifadesi|
|Önemli hata C1018|Beklenmeyen #elif|
|Önemli hata C1019|Beklenmeyen #else|
|Önemli hata C1020|Beklenmeyen #endif|
|Önemli hata C1021|Geçersiz önişlemci komutu '*dize*'|
|Önemli hata C1022|#endif bekleniyor|
|Önemli hata C1023|'*dosya*': beklenmeyen pch hatası, pch'yi yeniden oluşturmayı deneyin deneyin|
...
|Önemli hata C1035|ifade çok karmaşık; ifadesini Basitleştir|
...
|Önemli hata C1045|Derleyici sınırı: bağlantı belirtimleri çok derin iç içe|
|[Önemli Hata C1046](../../error-messages/compiler-errors-1/fatal-error-c1046.md)|Derleyici sınırı: *yapısı* çok derin iç içe geçmiş|
|Önemli hata C1047|Nesne veya kitaplık dosyası '*dosya*' diğer nesnelere; yeniden eski nesneleri ve kitaplıkları daha eski bir derleyici ile oluşturulmuş|
...
|Önemli hata C1053|'*işlevi*': işlev çok büyük|
...
|Önemli hata C1074|'IDB', PDB dosyası için geçersiz bir uzantı: *dosyası*|
...
|Önemli hata C1082|kapatamazsınız *türü* dosya: '*dosya*': *iletisi*|
...
|Önemli hata C1086|nelze vyhledat danou pozici *türü* dosya: '*dosya*': *iletisi*|
|Önemli hata C1087|nejde *türü* dosya: '*dosya*': *iletisi*|
|Önemli hata C1088|temizleyemiyor *türü* dosya: '*dosya*': *iletisi*|
...
|Önemli hata C1091|Derleyici sınırı: dize aşıyor *numarası* bayt cinsinden uzunluğu|
...
|Önemli hata C1098|Düzenle ve devam et altyapısında sürüm uyuşmazlığı|
|Önemli hata C1099|Düzenle ve devam et altyapısı derlemeyi sonlandırıyor|
|Önemli hata C1100|OLE başlatılamıyor: *hata*|
|Önemli hata C1101|özniteliği için işleyici oluşturulamıyor '*tanımlayıcı*'|
|Önemli hata C1102|başlatılamıyor: *hata*|
|Önemli hata C1103|önemli hata program kimliği içeri aktarılırken: '*ileti*'|
|Önemli hata C1104|Kitaplık kimliği içeri aktarılırken önemli hata: '*ileti*'|
...
|Önemli hata C1109|bulunamadı '*sembol*'DLL' ın*dosya*'|
...
|Önemli hata C1196|'*tanımlayıcı*': tür kitaplığındaki tanımlayıcı bulunamadı '*typelib*' geçerli bir C++ tanımlayıcısı değil|
...
|Önemli hata C1201|sınıf şablonu tanımındaki sözdizimi hatasından sonra devam edilemiyor|
|Önemli hata C1202|özyinelemeli tür veya işlev bağımlılığı bağlamı çok karmaşık|
|Önemli hata C1205|Genel türler yüklü olan çalışma zamanı sürümü tarafından desteklenmiyor|
|Önemli hata C1206|Appdomain başına veriler yüklü olan çalışma zamanı sürümü tarafından desteklenmiyor|
|Önemli hata C1207|Yönetilen şablonlar yüklü olan çalışma zamanı sürümü tarafından desteklenmiyor|
|Önemli hata C1208|Yığında başvuru sınıfları ayırma yüklü olan çalışma zamanı sürümü tarafından desteklenmiyor|
|Önemli hata C1209|Arkadaş derlemeler yüklü olan çalışma zamanı sürümü tarafından desteklenmiyor|
|Önemli hata C1210|/ CLR: pure ve/CLR: safe yüklü olan çalışma zamanı sürümü tarafından desteklenmiyor|
|Önemli hata C1211|TypeForwardedTo özel özniteliği yüklü olan çalışma zamanı sürümü tarafından desteklenmiyor|
...
|Önemli hata C1310|Profil temelli en iyileştirmeler OpenMP ile kullanılamaz|
...
|Önemli hata C1312|İşlevi çok fazla sayıda koşullu dallanma.  Basitleştirin veya kaynak kodu yeniden düzenleyin.|
...
|Önemli hata C1352|Geçersiz veya bozuk MSIL işlevi '*işlevi*'modülünden'*Modülü*'|
|Önemli hata C1353|meta veri işlemi başarısız oldu: çalışma zamanı yüklü değil veya sürümü uyuşmuyor|
...
|Önemli hata C1383|derleyici seçeneği /GL, ortak dil çalışma zamanının yüklü sürümüyle uyumlu değil|
...
|Önemli hata C1852|'*dosya*' geçerli bir ön derlenmiş üstbilgi dosyası değil|
...
|Önemli hata C1903|Önceki hatalardan kurtarmak alınamıyor; derleme durduruluyor|
|Önemli hata C1904|Hatalı sağlayıcı etkileşimi: '*dosya*'|
