...
|[Önemli hata C1016](fatal-error-c1016.md)|#ifdef/#ifndef bir tanımlayıcı bekliyordu|
|[Önemli Hata C1017](../../error-messages/compiler-errors-1/fatal-error-c1017.md)|geçersiz tamsayı sabiti ifadesi|
...
|[Önemli hata c1021](fatal-error-c1021.md)|geçersiz önişlemci komutu '*String*'|
|[Önemli hata C1022](fatal-error-c1022.md)|beklenen #endif|
|[Önemli hata C1023](fatal-error-c1023.md)|'*Dosya*': beklenmeyen PCH hatası, PCH 'yi yeniden oluşturmayı deneyin|
|[Önemli hata C1026](../../error-messages/compiler-errors-1/fatal-error-c1026.md)|Ayrıştırıcı yığını taştı, program çok karmaşık|
|[Önemli hata C1033](../../error-messages/compiler-errors-1/fatal-error-c1033.md)|'*Dosya*' program veritabanı açılamıyor|
|Önemli hata C1034|*Dosya*: hiçbir ekleme yolu ayarlanmadı|
|[Önemli hata C1035](fatal-error-c1035.md)|ifade çok karmaşık; ifadeyi Basitleştir|
...
|Önemli hata C1048|'*Option*' içinde bilinmeyen '*String*' seçeneği|
|[Önemli hata C1049](fatal-error-c1049.md)|geçersiz sayısal bağımsız değişken '*Value*'|
|[Önemli Hata C1051](../../error-messages/compiler-errors-1/fatal-error-c1051.md)|'*Dosya*' program veritabanı dosyası eski bir biçime sahip, onu silip yeniden derleyin|
|[Önemli hata C1052](fatal-error-c1052.md)|'*filename*' program veritabanı dosyası bağlayıcı tarafından/Debug: fastlink ile oluşturuldu; derleyici bu tür PDB dosyalarını güncelleştiremez; Lütfen bu dosyayı silin veya/fd kullanarak farklı bir PDB dosya adı belirtin|
|[Önemli hata C1053](fatal-error-c1053.md)|'*Function*': işlev çok büyük|
...
|[Önemli hata C1057](../../error-messages/compiler-errors-1/fatal-error-c1057.md)|makro genişletilirken beklenmeyen dosya sonu|
|[Önemli hata C1060](../../error-messages/compiler-errors-1/fatal-error-c1060.md)|Derleyicinin yığın alanı kalmadı|
|[Önemli Hata C1061](../../error-messages/compiler-errors-1/fatal-error-c1061.md)|Derleyici sınırı: iç içe geçmiş bloklar çok derin|
|Önemli hata C1063|Derleyici sınırı: derleyici Yığını Taşması|
...
|[Önemli hata C1067](../../error-messages/compiler-errors-1/fatal-error-c1067.md)|Derleyici sınırı: bir tür kaydının boyutuyla ilgili 64K sınırı aşıldı|
|[Önemli hata C1068](fatal-error-c1068.md)|'*Dosya*' dosyası açılamıyor|
|Önemli hata C1069|derleyici komut satırı okunamıyor|
|[Önemli hata C1070](fatal-error-c1070.md)|'*Dosya*' dosyasında eşleşmeyen #if/#endif çifti|
|[Önemli hata C1071](../../error-messages/compiler-errors-1/fatal-error-c1071.md)|açıklamada beklenmeyen dosya sonu bulundu|
|[Önemli Hata C1073](../../error-messages/compiler-errors-1/fatal-error-c1073.md)|Artımlı derleme (derleyici dosyası '*Dosya*', satır *numarası*) ile ilgili iç hata|
|[Önemli hata C1074](fatal-error-c1074.md)|' IDB ', PDB dosyası için geçersiz bir uzantı: *Dosya*|
|[Önemli hata C1075](../../error-messages/compiler-errors-1/fatal-error-c1075.md)|sol *belirteç* dosyanın sonunda uyuşduk|
|[Önemli hata C1076](../../error-messages/compiler-errors-1/fatal-error-c1076.md)|Derleyici sınırı: iç yığın sınırına ulaşıldı; daha yüksek bir sınır belirtmek için/ZD kullanın|
|[Önemli hata C1077](fatal-error-c1077.md)|Derleyici sınırı *: sayıdan fazla komut satırı* seçeneği bulunamaz|
|[Önemli hata C1079](../../error-messages/compiler-errors-1/fatal-error-c1079.md)|Derleyici sınırı: PCH dosyası boyut sınırı aşıldı|
|[Önemli hata C1080](../../error-messages/compiler-errors-1/fatal-error-c1080.md)|Derleyici sınırı: komut satırı seçeneği, *sayı* karakter sınırını aştı|
|[Önemli hata C1081](../../error-messages/compiler-errors-1/fatal-error-c1081.md)|'*Dosya*': dosya adı çok uzun|
|[Önemli hata C1082](fatal-error-c1082.md)|*tür* dosyası kapatılamıyor: '*Dosya*': *ileti*|
|[Önemli hata C1083](../../error-messages/compiler-errors-1/fatal-error-c1083.md)|*tür* dosyası açılamıyor: '*Dosya*': *ileti*|
|[Önemli hata C1084](../../error-messages/compiler-errors-1/fatal-error-c1084.md)|*tür* dosyası okunamıyor: '*Dosya*': *ileti*|
|[Önemli hata C1085](../../error-messages/compiler-errors-1/fatal-error-c1085.md)|*tür* dosyası yazılamıyor: '*Dosya*': *ileti*|
|[Önemli hata C1086](fatal-error-c1086.md)|*tür* dosyası aranamıyor: '*Dosya*': *ileti*|
|[Önemli hata C1087](fatal-error-c1087.md)|*tür* dosyasına söylenemez: '*Dosya*': *ileti*|
|[Önemli hata C1088](fatal-error-c1088.md)|*tür* dosyası boşaltılamadı: '*Dosya*': *ileti*|
|[Önemli hata C1089](fatal-error-c1089.md)|*tür* dosyası kesilemiyor: '*Dosya*': *ileti*|
...
|Önemli hata C1101|'*Identifier*' özniteliği için işleyici oluşturulamıyor|
|Önemli hata C1102|başlatılamıyor: *hata*|
|[Önemli hata C1103](fatal-error-c1103.md)|ProgID içeri aktarılırken önemli hata: '*Message*'|
|[Önemli hata C1104](fatal-error-c1104.md)|libıd içeri aktarılırken önemli hata: '*Message*'|
|Önemli hata C1105|*ileti*: *hata*|
|[Önemli hata C1107](../../error-messages/compiler-errors-1/fatal-error-c1107.md)|'*Assembly*' bütünleştirilmiş kodu bulunamadı: lütfen/AI kullanarak veya LIBPATH ortam değişkenini ayarlayarak derleme arama yolunu belirtin|
...
|[Önemli hata C1121](../../error-messages/compiler-errors-1/fatal-error-c1121.md)|CryptoAPI 'ye çağrı başarısız oldu|
|[Önemli hata C1126](../../error-messages/compiler-errors-1/fatal-error-c1126.md)|Otomatik ayırma *boyutu* aşıyor|
|[Önemli hata C1128](../../error-messages/compiler-errors-1/fatal-error-c1128.md)|Bölüm sayısı nesne dosyası biçimi sınırını aştı:/bigobj ile derle|
|[Önemli hata C1189](../../error-messages/compiler-errors-1/fatal-error-c1189.md)|#error: *ileti*|
|[Önemli hata C1190](fatal-error-c1190.md)|yönetilen hedeflenen kod bir '/CLR ' seçeneği gerektiriyor|
|[Önemli hata C1191](../../error-messages/compiler-errors-1/fatal-error-c1191.md)|'*File*' yalnızca genel kapsamda içeri aktarılabilir|
...
|[Önemli hata C1206](fatal-error-c1206.md)|Uygulama etki alanı başına veriler yüklü olan çalışma zamanı sürümü tarafından desteklenmiyor|
...
|[Önemli hata C1209](fatal-error-c1209.md)|Friend derlemeleri yüklü çalışma zamanının sürümü tarafından desteklenmiyor|
...
|[Önemli hata C1313](../../error-messages/compiler-errors-1/fatal-error-c1313.md)|Derleyici sınırı: *tür* blokları, *sayı* düzeylerinden daha derin iç içe olamaz|
|[Önemli hata C1350](../../error-messages/compiler-errors-1/fatal-error-c1350.md)|dll '*File*' yüklenirken hata oluştu: dll bulunamadı|
|[Önemli hata C1351](../../error-messages/compiler-errors-1/fatal-error-c1351.md)|dll '*File*' yüklenirken hata oluştu: uyumsuz sürüm|
|[Önemli hata C1352](fatal-error-c1352.md)|'*Module*' modülünden '*Function*' IŞLEVINDE geçersiz veya bozuk MSIL|
|[Önemli hata C1353](fatal-error-c1353.md)|meta veri işlemi başarısız oldu: çalışma zamanı yüklü değil veya sürüm uyumsuzluğu|
...
|[Önemli hata C1903](fatal-error-c1903.md)|önceki hatalardan kurtarma yapılamıyor; derleme durduruluyor|
