...
Bu hata için Visual Studio 2005 yapıldığı derleyici uyumluluğu iş sonucu olarak da oluşturulabilir: görsel için parametre C++ öznitelikleri.
