...
|Hata|`Message`|
|-----------|-------------|
|Derleyici Hatası C2000|Bilinmeyen hata Lütfen Visual C++ Yardım menüsünde teknik destek komutunu seçin veya daha fazla bilgi için teknik destek Yardım dosyasını açın|
|[Derleyici Hatası C2001](compiler-error-c2001.md)|Sabitte|
|[Derleyici Hatası C2002](compiler-error-c2002.md)|Geçersiz geniş karakter sabiti|
|[Derleyici Hatası C2003](compiler-error-c2003.md)|Beklenen 'defined id'|
|[Derleyici Hatası C2004](compiler-error-c2004.md)|'defined(id)' bekleniyor|
|[Derleyici Hatası C2005](compiler-error-c2005.md)|#line bir satır numarası bulundu, beklenen '*belirteci*'|
|[Derleyici Hatası C2006](compiler-error-c2006.md)|'*yönergesi*': bulunan bir dosya adı bekleniyordu, '*belirteci*'|
|[Derleyici Hatası C2007](compiler-error-c2007.md)|#define söz dizimi|
|[Derleyici Hatası C2008](compiler-error-c2008.md)|'*karakter*': Makro tanımında beklenmiyor|
|[Derleyici Hatası C2009](compiler-error-c2009.md)|Makro biçimsel kullanılmasını '*tanımlayıcı*'|
|[Derleyici Hatası C2010](compiler-error-c2010.md)|'*karakter*': makro biçimsel parametre listesinde beklenmeyen|
|[Derleyici Hatası C2011](compiler-error-c2011.md)|'*tanımlayıcı*': '*türü*' yeniden tanımlama yazın|
|[Derleyici Hatası C2012](compiler-error-c2012.md)|işaretinden sonra ad eksik ' <'|
|[Derleyici Hatası C2013](compiler-error-c2013.md)|eksik ' >'|
|[Derleyici Hatası C2014](compiler-error-c2014.md)|Önişlemci komutu ilk boşluk olmayan karakterde başlamalıdır|
|[Derleyici Hatası C2015](compiler-error-c2015.md)|çok fazla karakter sabiti|
|Derleyici Hatası C2016|C, bir yapıda veya birleşimde en az bir üye olmasını gerektirir|
|[Derleyici Hatası C2017](compiler-error-c2017.md)|Geçersiz kaçış sırası|
|[Derleyici Hatası C2018](compiler-error-c2018.md)|Bilinmeyen karakter ' 0 x*değer*'|
...
|[Derleyici Hatası C2028](compiler-error-c2028.md)|Yapı/birleşim üyesi bir yapı/birleşim içinde olmalıdır|
|Derleyici Hatası C2029|Sol '*belirteci*'tanımsız sınıfını/yapısını/arabirimini belirtiyor'*tanımlayıcı*'|
|[Derleyici Hatası C2030](compiler-error-c2030.md)|erişebilirliği 'protected private' olan bir yok edici 'sealed' olarak bildirilmiş bir sınıfın üyesi olamaz|
|Derleyici Hatası C2031|sanal bir yıkıcı ile '*erişilebilirlik*' erişilebilirlik bu tür için izin verilmiyor|
|[Derleyici Hatası C2032](compiler-error-c2032.md)|'*tanımlayıcı*': işlev, yapı/birleşim üyesi olamaz '*türü*'|
...
|[Derleyici Hatası C2069](compiler-error-c2069.md)|'void' olmayan 'void' terim'ın dönüştürme|
