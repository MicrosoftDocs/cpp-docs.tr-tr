...
ms.locfileid: "99554436"
---
# <a name="x64-amd64-intrinsics-list"></a>x64 (amd64) iç bilgi listesi

Bu belgede, x64 (amd64 olarak da anılır) hedeflendiğinde Microsoft C++ derleyicisinin desteklediği iç bilgiler listelenir.
...
| [`_addcarryx_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u32) | ADX \[ 2] | ımintrin. h | `unsigned char _addcarryx_u32(unsigned char, unsigned int, unsigned int, unsigned int *);` |
| [`_addcarryx_u64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u64) | ADX \[ 2] | ımintrin. h | `unsigned char _addcarryx_u64(unsigned char, unsigned __int64, unsigned __int64, unsigned __int64 *);` |
...
| `_andn_u32` | BMı \[ 1] | ammintrin. h | `unsigned int _andn_u32(unsigned int, unsigned int);` |
| `_andn_u64` | BMı \[ 1] | ammintrin. h | `unsigned __int64 _andn_u64(unsigned __int64, unsigned __int64);` |
...
| `_bextri_u32` | ABA \[ 1] | ammintrin. h | `unsigned int _bextri_u32(unsigned int, unsigned int);` |
| `_bextri_u64` | ABA \[ 1] | ammintrin. h | `unsigned __int64 _bextri_u64(unsigned __int64, unsigned int);` |
...
| `_blcfill_u32` | ABA \[ 1] | ammintrin. h | `unsigned int _blcfill_u32(unsigned int);` |
| `_blcfill_u64` | ABA \[ 1] | ammintrin. h | `unsigned __int64 _blcfill_u64(unsigned __int64);` |
| `_blci_u32` | ABA \[ 1] | ammintrin. h | `unsigned int _blci_u32(unsigned int);` |
| `_blci_u64` | ABA \[ 1] | ammintrin. h | `unsigned __int64 _blci_u64(unsigned __int64);` |
| `_blcic_u32` | ABA \[ 1] | ammintrin. h | `unsigned int _blcic_u32(unsigned int);` |
| `_blcic_u64` | ABA \[ 1] | ammintrin. h | `unsigned __int64 _blcic_u64(unsigned __int64);` |
| `_blcmsk_u32` | ABA \[ 1] | ammintrin. h | `unsigned int _blcmsk_u32(unsigned int);` |
| `_blcmsk_u64` | ABA \[ 1] | ammintrin. h | `unsigned __int64 _blcmsk_u64(unsigned __int64);` |
| `_blcs_u32` | ABA \[ 1] | ammintrin. h | `unsigned int _blcs_u32(unsigned int);` |
| `_blcs_u64` | ABA \[ 1] | ammintrin. h | `unsigned __int64 _blcs_u64(unsigned __int64);` |
| `_blsfill_u32` | ABA \[ 1] | ammintrin. h | `unsigned int _blsfill_u32(unsigned int);` |
| `_blsfill_u64` | ABA \[ 1] | ammintrin. h | `unsigned __int64 _blsfill_u64(unsigned __int64);` |
...
| `_blsic_u32` | ABA \[ 1] | ammintrin. h | `unsigned int _blsic_u32(unsigned int);` |
| `_blsic_u64` | ABA \[ 1] | ammintrin. h | `unsigned __int64 _blsic_u64(unsigned __int64);` |
...
| [`_bzhi_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bzhi_u32) | BMı \[ 2] | ımintrin. h | `unsigned int _bzhi_u32(unsigned int, unsigned int);` |
| [`_bzhi_u64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bzhi_u64) | BMı \[ 2] | ımintrin. h | `unsigned __int64 _bzhi_u64(unsigned __int64, unsigned int);` |
...
| [`_fxrstor64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_fxrstor64) | FXSR \[ 2] | ımintrin. h | `void _fxrstor64(void const*);` |
...
| [`_InterlockedAnd_HLEAcquire`](interlockedand-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `long _InterlockedAnd_HLEAcquire(long volatile *, long);` |
| [`_InterlockedAnd_HLERelease`](interlockedand-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `long _InterlockedAnd_HLERelease(long volatile *, long);` |
...
| [`_InterlockedAnd64_HLEAcquire`](interlockedand-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `__int64 _InterlockedAnd64_HLEAcquire(__int64 volatile *, __int64);` |
| [`_InterlockedAnd64_HLERelease`](interlockedand-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `__int64 _InterlockedAnd64_HLERelease(__int64 volatile *, __int64);` |
...
| [`_interlockedbittestandreset_HLEAcquire`](interlockedbittestandreset-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `unsigned char _interlockedbittestandreset_HLEAcquire(long *, long);` |
| [`_interlockedbittestandreset_HLERelease`](interlockedbittestandreset-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `unsigned char _interlockedbittestandreset_HLERelease(long *, long);` |
...
| [`_interlockedbittestandreset64_HLEAcquire`](interlockedbittestandreset-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `unsigned char _interlockedbittestandreset64_HLEAcquire(__int64 *, __int64);` |
| [`_interlockedbittestandreset64_HLERelease`](interlockedbittestandreset-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `unsigned char _interlockedbittestandreset64_HLERelease(__int64 *, __int64);` |
...
| [`_interlockedbittestandset_HLEAcquire`](interlockedbittestandset-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `unsigned char _interlockedbittestandset_HLEAcquire(long *, long);` |
| [`_interlockedbittestandset_HLERelease`](interlockedbittestandset-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `unsigned char _interlockedbittestandset_HLERelease(long *, long);` |
...
| [`_interlockedbittestandset64_HLEAcquire`](interlockedbittestandset-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `unsigned char _interlockedbittestandset64_HLEAcquire(__int64 *, __int64);` |
| [`_interlockedbittestandset64_HLERelease`](interlockedbittestandset-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `unsigned char _interlockedbittestandset64_HLERelease(__int64 *, __int64);` |
...
| [`_InterlockedCompareExchange_HLEAcquire`](interlockedcompareexchange-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `long _InterlockedCompareExchange_HLEAcquire(long volatile *, long, long);` |
| [`_InterlockedCompareExchange_HLERelease`](interlockedcompareexchange-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `long _InterlockedCompareExchange_HLERelease(long volatile *, long, long);` |
...
| [`_InterlockedCompareExchange64_HLEAcquire`](interlockedcompareexchange-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `__int64 _InterlockedCompareExchange64_HLEAcquire(__int64 volatile *, __int64, __int64);` |
| [`_InterlockedCompareExchange64_HLERelease`](interlockedcompareexchange-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `__int64 _InterlockedCompareExchange64_HLERelease(__int64 volatile *, __int64, __int64);` |
...
| [`_InterlockedExchange_HLEAcquire`](interlockedexchange-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `long _InterlockedExchange_HLEAcquire(long volatile *, long);` |
| [`_InterlockedExchange_HLERelease`](interlockedexchange-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `long _InterlockedExchange_HLERelease(long volatile *, long);` |
...
| [`_InterlockedExchange64_HLEAcquire`](interlockedexchange-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `__int64 _InterlockedExchange64_HLEAcquire(__int64 volatile *, __int64);` |
| [`_InterlockedExchange64_HLERelease`](interlockedexchange-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `__int64 _InterlockedExchange64_HLERelease(__int64 volatile *, __int64);` |
...
| [`_InterlockedExchangeAdd_HLEAcquire`](interlockedexchangeadd-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `long _InterlockedExchangeAdd_HLEAcquire(long volatile *, long);` |
| [`_InterlockedExchangeAdd_HLERelease`](interlockedexchangeadd-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `long _InterlockedExchangeAdd_HLERelease(long volatile *, long);` |
...
| [`_InterlockedExchangeAdd64_HLEAcquire`](interlockedexchangeadd-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `__int64 _InterlockedExchangeAdd64_HLEAcquire(__int64 volatile *, __int64);` |
| [`_InterlockedExchangeAdd64_HLERelease`](interlockedexchangeadd-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `__int64 _InterlockedExchangeAdd64_HLERelease(__int64 volatile *, __int64);` |
...
| [`_InterlockedOr_HLEAcquire`](interlockedor-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `long _InterlockedOr_HLEAcquire(long volatile *, long);` |
| [`_InterlockedOr_HLERelease`](interlockedor-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `long _InterlockedOr_HLERelease(long volatile *, long);` |
...
| [`_InterlockedOr64_HLEAcquire`](interlockedor-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `__int64 _InterlockedOr64_HLEAcquire(__int64 volatile *, __int64);` |
| [`_InterlockedOr64_HLERelease`](interlockedor-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `__int64 _InterlockedOr64_HLERelease(__int64 volatile *, __int64);` |
...
| [`_InterlockedXor_HLEAcquire`](interlockedxor-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `long _InterlockedXor_HLEAcquire(long volatile *, long);` |
| [`_InterlockedXor_HLERelease`](interlockedxor-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `long _InterlockedXor_HLERelease(long volatile *, long);` |
...
| [`_InterlockedXor64_HLEAcquire`](interlockedxor-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `__int64 _InterlockedXor64_HLEAcquire(__int64 volatile *, __int64);` |
| [`_InterlockedXor64_HLERelease`](interlockedxor-intrinsic-functions.md) | HLE \[ 2] | ımintrin. h | `__int64 _InterlockedXor64_HLERelease(__int64 volatile *, __int64);` |
...
| [`_invpcid`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_invpcid) | INVPCıD \[ 2] | ımintrin. h | `void _invpcid(unsigned int, void *);` |
...
| [`_loadbe_i16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i16&expand=3071) | MOVBE | ımintrin. h | `short _loadbe_i16(void const*);`\[3] |
| [`_loadbe_i32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i32&expand=3072) | MOVBE | ımintrin. h | `int _loadbe_i32(void const*);`\[3] |
| [`_loadbe_i64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i64&expand=3073) | MOVBE | ımintrin. h | `__int64 _loadbe_i64(void const*);`\[3] |
| `_load_be_u16` | MOVBE | ımintrin. h | `unsigned short _load_be_u16(void const*);`\[3] |
| `_load_be_u32` | MOVBE | ımintrin. h | `unsigned int _load_be_u32(void const*);`\[3] |
| `_load_be_u64` | MOVBE | ımintrin. h | `unsigned __int64 _load_be_u64(void const*);`\[3] |
...
| [`__lzcnt`](lzcnt16-lzcnt-lzcnt64.md) | LZSAYISI | Intrin. h | `unsigned int __lzcnt(unsigned int);` |
...
| [`__lzcnt16`](lzcnt16-lzcnt-lzcnt64.md) | LZSAYISI | Intrin. h | `unsigned short __lzcnt16(unsigned short);` |
| [`__lzcnt64`](lzcnt16-lzcnt-lzcnt64.md) | LZSAYISI | Intrin. h | `unsigned __int64 __lzcnt64(unsigned __int64);` |
...
| [`_mm_i32gather_pd`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_pd) | AVX2 \[ 2] | ımintrin. h | `__m128d _mm_i32gather_pd(double const *, __m128i, const int);` |
...
| [`_mm_i64gather_pd`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_pd) | AVX2 \[ 2] | ımintrin. h | `__m128d _mm_i64gather_pd(double const *, __m128i, const int);` |
...
| [`_mm_maskload_pd`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskload_pd) | AVX \[ 2] | ımintrin. h | `__m128d _mm_maskload_pd(double const *, __m128i);` |
...
| [`_mm_maskstore_pd`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskstore_pd) | AVX \[ 2] | ımintrin. h | `void _mm_maskstore_pd(double *, __m128i, __m128d);` |
...
| [`_mm_popcnt_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_popcnt_u32) | POPSAYISI | Intrin. h | `int _mm_popcnt_u32(unsigned int);` |
| [`_mm_popcnt_u64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_popcnt_u64) | POPSAYISI | Intrin. h | `__int64 _mm_popcnt_u64(unsigned __int64);` |
...
| [`_mm256_broadcast_sd`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_broadcast_sd) | AVX \[ 2] | ımintrin. h | `__m256d _mm256_broadcast_sd(double const *);` |
...
| [`_mm256_i32gather_pd`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_pd) | AVX2 \[ 2] | ımintrin. h | `__m256d _mm256_i32gather_pd(double const *, __m128i, const int);` |
...
| [`_mm256_i64gather_pd`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_pd) | AVX2 \[ 2] | ımintrin. h | `__m256d _mm256_i64gather_pd(double const *, __m256i, const int);` |
...
| [`_mm256_load_pd`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_load_pd) | AVX \[ 2] | ımintrin. h | `__m256d _mm256_load_pd(double const *);` |
...
| [`_mm256_loadu_pd`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_loadu_pd) | AVX \[ 2] | ımintrin. h | `__m256d _mm256_loadu_pd(double const *);` |
...
| [`_mm256_maskload_pd`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskload_pd) | AVX \[ 2] | ımintrin. h | `__m256d _mm256_maskload_pd(double const *, __m256i);` |
...
| [`_mm256_maskstore_pd`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskstore_pd) | AVX \[ 2] | ımintrin. h | `void _mm256_maskstore_pd(double *, __m256i, __m256d);` |
...
| [`_mm256_set_epi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_set_epi16) | AVX \[ 2] | ımintrin. h | `(__m256i _mm256_set_epi16(short ` |
...
| [`_mm256_set_epi64x`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_set_epi64x) | AVX \[ 2] | ımintrin. h | `__m256i _mm256_set_epi64x(long long, long long, long long, long long);` |
| [`_mm256_set_epi8`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_set_epi8) | AVX \[ 2] | ımintrin. h | `__m256i _mm256_set_epi8(char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char);` |
...
| [`_mm256_set1_epi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_set1_epi16) | AVX \[ 2] | ımintrin. h | `__m256i _mm256_set1_epi16(short);` |
...
| [`_mm256_set1_epi64x`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_set1_epi64x) | AVX \[ 2] | ımintrin. h | `__m256i _mm256_set1_epi64x(long long);` |
...
| [`_mm256_set1_pd`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_set1_pd) | AVX \[ 2] | ımintrin. h | `__m256d _mm256_set1_pd(double);` |
...
| [`_mm256_setr_epi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_setr_epi16) | AVX \[ 2] | ımintrin. h | `(__m256i _mm256_setr_epi16(short ` |
...
| [`_mm256_setr_epi64x`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_setr_epi64x) | AVX \[ 2] | ımintrin. h | `__m256i _mm256_setr_epi64x(long long, long long, long long, long long);` |
...
| [`_mm256_store_pd`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_store_pd) | AVX \[ 2] | ımintrin. h | `void _mm256_store_pd(double *, __m256d);` |
...
| [`_mm256_storeu_pd`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_storeu_pd) | AVX \[ 2] | ımintrin. h | `void _mm256_storeu_pd(double *, __m256d);` |
...
| [`_mm256_stream_pd`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_stream_pd) | AVX \[ 2] | ımintrin. h | `void __mm256_stream_pd(double *, __m256d);` |
...
| `_mulx_u32` | BMı \[ 2] | ımintrin. h | `unsigned int _mulx_u32(unsigned int, unsigned int, unsigned int*);` |
| `_mulx_u64` | BMı \[ 2] | ımintrin. h | `unsigned __int64 _mulx_u64(unsigned __int64, unsigned __int64, unsigned __int64*);` |
...
| [`_pdep_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pdep_u32) | BMı \[ 2] | ımintrin. h | `unsigned int _pdep_u32(unsigned int, unsigned int);` |
| [`_pdep_u64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pdep_u64) | BMı \[ 2] | ımintrin. h | `unsigned __int64 _pdep_u64(unsigned __int64, unsigned __int64);` |
| [`_pext_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pext_u32) | BMı \[ 2] | ımintrin. h | `unsigned int _pext_u32(unsigned int, unsigned int);` |
| [`_pext_u64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pext_u64) | BMı \[ 2] | ımintrin. h | `unsigned __int64 _pext_u64(unsigned __int64, unsigned __int64);` |
| [`__popcnt`](popcnt16-popcnt-popcnt64.md) | POPSAYISI | Intrin. h | `unsigned int __popcnt(unsigned int);` |
| [`__popcnt16`](popcnt16-popcnt-popcnt64.md) | POPSAYISI | Intrin. h | `unsigned short __popcnt16(unsigned short);` |
| [`__popcnt64`](popcnt16-popcnt-popcnt64.md) | POPSAYISI | Intrin. h | `unsigned __int64 __popcnt64(unsigned __int64);` |
| [`_rdrand16_step`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdrand16_step) | RDRVE \[ 2] | ımintrin. h | `int _rdrand16_step(unsigned short *);` |
| [`_rdrand32_step`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdrand32_step) | RDRVE \[ 2] | ımintrin. h | `int _rdrand32_step(unsigned int *);` |
| [`_rdrand64_step`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdrand64_step) | RDRVE \[ 2] | ımintrin. h | `int _rdrand64_step(unsigned __int64 *);` |
| [`_rdseed16_step`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdseed16_step) | RDSEED \[ 2] | ımintrin. h | `int _rdseed16_step(unsigned short *);` |
| [`_rdseed32_step`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdseed32_step) | RDSEED \[ 2] | ımintrin. h | `int _rdseed32_step(unsigned int *);` |
| [`_rdseed64_step`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdseed64_step) | RDSEED \[ 2] | ımintrin. h | `int _rdseed64_step(unsigned __int64 *);` |
...
| [`_readfsbase_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_readfsbase_u32) | FSGSBASE \[ 2] | ımintrin. h | `unsigned int _readfsbase_u32(void);` |
| [`_readfsbase_u64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_readfsbase_u64) | FSGSBASE \[ 2] | ımintrin. h | `unsigned __int64 _readfsbase_u64(void);` |
| [`_readgsbase_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_readgsbase_u32) | FSGSBASE \[ 2] | ımintrin. h | `unsigned int _readgsbase_u32(void);` |
| [`_readgsbase_u64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_readgsbase_u64) | FSGSBASE \[ 2] | ımintrin. h | `unsigned __int64 _readgsbase_u64(void);` |
...
| `_rorx_u32` | BMı \[ 2] | ımintrin. h | `unsigned int _rorx_u32(unsigned int, const unsigned int);` |
| `_rorx_u64` | BMı \[ 2] | ımintrin. h | `unsigned __int64 _rorx_u64(unsigned __int64, const unsigned int);` |
...
| `_sarx_i32` | BMı \[ 2] | ımintrin. h | `int _sarx_i32(int, unsigned int);` |
| `_sarx_i64` | BMı \[ 2] | ımintrin. h | `__int64 _sarx_i64(__int64, unsigned int);` |
...
| `_shlx_u32` | BMı \[ 2] | ımintrin. h | `unsigned int _shlx_u32(unsigned int, unsigned int);` |
| `_shlx_u64` | BMı \[ 2] | ımintrin. h | `unsigned __int64 _shlx_u64(unsigned __int64, unsigned int);` |
| `_shrx_u32` | BMı \[ 2] | ımintrin. h | `unsigned int _shrx_u32(unsigned int, unsigned int);` |
| `_shrx_u64` | BMı \[ 2] | ımintrin. h | `unsigned __int64 _shrx_u64(unsigned __int64, unsigned int);` |
| [`__sidt`](sidt.md) |  | Intrin. h | `void __sidt(void*);` |
| `__slwpcb` | LWP \[ 1] | ammintrin. h | `void *__slwpcb(void);` |
| `_stac` | SMAP | Intrin. h | `void _stac(void);` |
| [`_storebe_i16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i16&expand=5141) | MOVBE | ımintrin. h | `void _storebe_i16(void *, short);`\[3] |
| [`_storebe_i32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i32&expand=5142) | MOVBE | ımintrin. h | `void _storebe_i32(void *, int);`\[3] |
| [`_storebe_i64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i64&expand=5143) | MOVBE | ımintrin. h | `void _storebe_i64(void *, __int64);`\[3] |
| `_store_be_u16` | MOVBE | ımintrin. h | `void _store_be_u16(void *, unsigned short);`\[3] |
| `_store_be_u32` | MOVBE | ımintrin. h | `void _store_be_u32(void *, unsigned int);`\[3] |
| `_store_be_u64` | MOVBE | ımintrin. h | `void _store_be_u64(void *, unsigned __int64);`\[3] |
| `_Store_HLERelease` | HLE \[ 2] | ımintrin. h | `void _Store_HLERelease(long volatile *, long);` |
| `_Store64_HLERelease` | HLE \[ 2] | ımintrin. h | `void _Store64_HLERelease(__int64 volatile *, __int64);` |
...
| `_t1mskc_u32` | ABA \[ 1] | ammintrin. h | `unsigned int _t1mskc_u32(unsigned int);` |
| `_t1mskc_u64` | ABA \[ 1] | ammintrin. h | `unsigned __int64 _t1mskc_u64(unsigned __int64);` |
...
| `_tzmsk_u32` | ABA \[ 1] | ammintrin. h | `unsigned int _tzmsk_u32(unsigned int);` |
| `_tzmsk_u64` | ABA \[ 1] | ammintrin. h | `unsigned __int64 _tzmsk_u64(unsigned __int64);` |
...
| [`_writefsbase_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writefsbase_u32) | FSGSBASE \[ 2] | ımintrin. h | `void _writefsbase_u32(unsigned int);` |
| [`_writefsbase_u64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writefsbase_u64) | FSGSBASE \[ 2] | ımintrin. h | `void _writefsbase_u64(unsigned __int64);` |
| [`_writegsbase_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writegsbase_u32) | FSGSBASE \[ 2] | ımintrin. h | `void _writegsbase_u32(unsigned int);` |
| [`_writegsbase_u64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writegsbase_u64) | FSGSBASE \[ 2] | ımintrin. h | `void _writegsbase_u64(unsigned __int64);` |
...
| [`_xabort`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xabort) | RTM \[ 2] | ımintrin. h | `void _xabort(unsigned int);` |
| [`_xbegin`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xbegin) | RTM \[ 2] | ımintrin. h | `unsigned _xbegin(void);` |
| [`_xend`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xend) | RTM \[ 2] | ımintrin. h | `void _xend(void);` |
| [`_xgetbv`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xgetbv) | XSAVE \[ 2] | ımintrin. h | `unsigned __int64 _xgetbv(unsigned int);` |
| [`_xrstor`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xrstor) | XSAVE \[ 2] | ımintrin. h | `void _xrstor(void const*, unsigned __int64);` |
| [`_xrstor64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xrstor64) | XSAVE \[ 2] | ımintrin. h | `void _xrstor64(void const*, unsigned __int64);` |
| [`_xsave`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsave) | XSAVE \[ 2] | ımintrin. h | `void _xsave(void*, unsigned __int64);` |
| [`_xsave64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsave64) | XSAVE \[ 2] | ımintrin. h | `void _xsave64(void*, unsigned __int64);` |
| [`_xsaveopt`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsaveopt) | XSAVEOPT \[ 2] | ımintrin. h | `void _xsaveopt(void*, unsigned __int64);` |
| [`_xsaveopt64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsaveopt64) | XSAVEOPT \[ 2] | ımintrin. h | `void _xsaveopt64(void*, unsigned __int64);` |
| [`_xsetbv`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsetbv) | XSAVE \[ 2] | ımintrin. h | `void _xsetbv(unsigned int, unsigned __int64);` |
| [`_xtest`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xtest) | XTEST \[ 2] | ımintrin. h | `unsigned char _xtest(void);` |
