...
-   Üstbilgi dosyası. Birçok iç bilgileri üstbilgi dosyası açıklamaları belgelenmiştir.  
  
-   [Intel iç bilgileri Kılavuzu](http://go.microsoft.com/fwlink/p/?LinkId=512130). Belirli iç bilgileri bulmak için arama kutusunu kullanın.  
  
-   [Intel 64 ve IA-32 mimarileri yazılım geliştirici kılavuzları](http://go.microsoft.com/fwlink/p/?LinkId=251198)  
  
-   [Intel AVX](http://go.microsoft.com/fwlink/p/?LinkId=251202)  
  
-   [AMD Geliştirici Kılavuzlar ve kılavuzları](http://go.microsoft.com/fwlink/p/?LinkId=251203)  
...
|--------------------|----------------|------------|------------------------|  
|_addcarry_u16||intrin.h|İmzasız char _addcarry_u16 (imzasız char c_in, imzasız kısa src1, kısa imzasız imzasız kısa src2 * toplam)|  
|[_addcarry_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)||intrin.h|İmzasız char _addcarry_u32 (imzasız char c_in, imzasız int src1, imzasız int src2, imzasız int * toplam)|  
|[_addcarry_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)||intrin.h|İmzasız char _addcarry_u64 (imzasız imzasız char c_in \_imzasız _int64 src1 \_imzasız _int64 src2 \__int64 * toplam)|  
...
|[_addcarryx_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|ADX [2]|immintrin.h|İmzasız char _addcarryx_u32 (imzasız char c_in, imzasız int src1, imzasız int src2, imzasız int * toplam)|  
|[_addcarryx_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|ADX [2]|immintrin.h|İmzasız char _addcarryx_u64 (imzasız imzasız char c_in \_imzasız _int64 src1 \_imzasız _int64 src2 \__int64 * toplam)|  
|[__addgsbyte](../intrinsics/addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsbyte (imzasız uzun, imzasız char)|  
|[__addgsdword](../intrinsics/addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsdword (imzasız uzun, imzasız int)|  
|[__addgsqword](../intrinsics/addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsqword (uzun İmzasız, imzasız \__int64)|  
|[__addgsword](../intrinsics/addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsword (imzasız uzun, imzasız short)|  
|[_AddressOfReturnAddress](../intrinsics/addressofreturnaddress.md)||intrin.h|void * _AddressOfReturnAddress(void)|  
|_andn_u32|BMI [1]|ammintrin.h|İmzasız int _andn_u32 (imzasız int, imzasız int)|  
|_andn_u64|BMI [1]|ammintrin.h|İmzasız __int64 _andn_u64 (imzasız \_imzasız _int64 \__int64)|  
|[_bextr_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI|ammintrin.h, immintrin.h|İmzasız int _bextr_u32 (int, imzasız int, imzasız int imzasız)|  
|[_bextr_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI|ammintrin.h, immintrin.h|İmzasız __int64 _bextr_u64 (imzasız \__int64, imzasız int, int imzasız)|  
|_bextri_u32|ABM [1]|ammintrin.h|İmzasız int _bextri_u32 (imzasız int, imzasız int)|  
|_bextri_u64|ABM [1]|ammintrin.h|İmzasız __int64 _bextri_u64 (imzasız \__int64, imzasız int)|  
|[_BitScanForward](../intrinsics/bitscanforward-bitscanforward64.md)||intrin.h|BOOLEAN _BitScanForward (OUT ULONG * dizin, IN ULONG maskesi)|  
|[_BitScanForward64](../intrinsics/bitscanforward-bitscanforward64.md)||intrin.h|BOOLEAN _BitScanForward64 (OUT ULONG * dizin, IN ULONG64 maskesi)|  
|[_BitScanReverse](../intrinsics/bitscanreverse-bitscanreverse64.md)||intrin.h|BOOLEAN _BitScanReverse (OUT ULONG * dizin, IN ULONG maskesi)|  
|[_BitScanReverse64](../intrinsics/bitscanreverse-bitscanreverse64.md)||intrin.h|BOOLEAN _BitScanReverse64 (OUT ULONG * dizin, IN ULONG64 maskesi)|  
...
|_blcfill_u32|ABM [1]|ammintrin.h|İmzasız int _blcfill_u32(unsigned int)|  
|_blcfill_u64|ABM [1]|ammintrin.h|İmzasız __int64 _blcfill_u64 (imzasız \__int64)|  
|_blci_u32|ABM [1]|ammintrin.h|İmzasız int _blci_u32(unsigned int)|  
|_blci_u64|ABM [1]|ammintrin.h|İmzasız __int64 _blci_u64 (imzasız \__int64)|  
|_blcic_u32|ABM [1]|ammintrin.h|İmzasız int _blcic_u32(unsigned int)|  
|_blcic_u64|ABM [1]|ammintrin.h|İmzasız __int64 _blcic_u64 (imzasız \__int64)|  
|_blcmsk_u32|ABM [1]|ammintrin.h|İmzasız int _blcmsk_u32(unsigned int)|  
|_blcmsk_u64|ABM [1]|ammintrin.h|İmzasız __int64 _blcmsk_u64 (imzasız \__int64)|  
|_blcs_u32|ABM [1]|ammintrin.h|İmzasız int _blcs_u32(unsigned int)|  
|_blcs_u64|ABM [1]|ammintrin.h|İmzasız __int64 _blcs_u64 (imzasız \__int64)|  
|_blsfill_u32|ABM [1]|ammintrin.h|İmzasız int _blsfill_u32(unsigned int)|  
|_blsfill_u64|ABM [1]|ammintrin.h|İmzasız __int64 _blsfill_u64 (imzasız \__int64)|  
|[_blsi_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI|ammintrin.h, immintrin.h|İmzasız int _blsi_u32(unsigned int)|  
|[_blsi_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI|ammintrin.h, immintrin.h|İmzasız __int64 _blsi_u64 (imzasız \__int64)|  
|_blsic_u32|ABM [1]|ammintrin.h|İmzasız int _blsic_u32(unsigned int)|  
|_blsic_u64|ABM [1]|ammintrin.h|İmzasız __int64 _blsic_u64 (imzasız \__int64)|  
|[_blsmsk_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI|ammintrin.h, immintrin.h|İmzasız int _blsmsk_u32(unsigned int)|  
|[_blsmsk_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI|ammintrin.h, immintrin.h|İmzasız __int64 _blsmsk_u64 (imzasız \__int64)|  
|[_blsr_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI|ammintrin.h, immintrin.h|İmzasız int _blsr_u32(unsigned int)|  
|[_blsr_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI|ammintrin.h, immintrin.h|İmzasız __int64 _blsr_u64 (imzasız \__int64)|  
|[_bzhi_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI [2]|immintrin.h|İmzasız int _bzhi_u32 (imzasız int, imzasız int)|  
|[_bzhi_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI [2]|immintrin.h|İmzasız __int64 _bzhi_u64 (imzasız \__int64, imzasız int)|  
...
|[__emulu](../intrinsics/emul-emulu.md)||intrin.h|İmzasız __int64 [pascal/cdecl]\__emulu (imzasız int, imzasız int)|  
|[_tcp](../intrinsics/enable.md)||intrin.h|void _enable(void)|  
...
|[__getcallerseflags](../intrinsics/getcallerseflags.md)||intrin.h|(imzasız int __getcallerseflags())|  
|[__halt](../intrinsics/halt.md)||intrin.h|void __halt(void)|  
|[__inbyte](../intrinsics/inbyte.md)||intrin.h|İmzasız char __inbyte (imzasız kısa bağlantı noktası)|  
|[__inbytestring](../intrinsics/inbytestring.md)||intrin.h|void __inbytestring (imzasız kısa bağlantı noktası, imzasız char * arabellek, uzun sayısı imzasız)|  
...
|[__indword](../intrinsics/indword.md)||intrin.h|İmzasız uzun __indword (imzasız kısa bağlantı noktası)|  
|[__indwordstring](../intrinsics/indwordstring.md)||intrin.h|void __indwordstring (işaretsiz kısa bağlantı noktası, uzun imzasız * arabellek, uzun sayısı imzasız)|  
|[__int2c](../intrinsics/int2c.md)||intrin.h|void __int2c(void)|  
|[_InterlockedAnd](../intrinsics/interlockedand-intrinsic-functions.md)||intrin.h|uzun _InterlockedAnd (uzun volatile *, uzun)|  
|[_InterlockedAnd_HLEAcquire](../intrinsics/interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedAnd_HLEAcquire (uzun volatile *, uzun)|  
|[_InterlockedAnd_HLERelease](../intrinsics/interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedAnd_HLERelease (uzun volatile *, uzun)|  
...
|[_InterlockedCompareExchange](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|uzun _InterlockedCompareExchange (uzun volatile * uzun, uzun)|  
|[_InterlockedCompareExchange_HLEAcquire](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedCompareExchange_HLEAcquire (uzun volatile * uzun, uzun)|  
|[_InterlockedCompareExchange_HLERelease](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedCompareExchange_HLERelease (uzun volatile * uzun, uzun)|  
...
|[_InterlockedCompareExchange128](../intrinsics/interlockedcompareexchange128.md)||intrin.h|İmzasız char _InterlockedCompareExchange128 (\__int64 volatile *,\__int64,\__int64,\__int64\*)|  
|[_InterlockedCompareExchange128_np](../intrinsics/interlockedcompareexchange128.md)||intrin.h|İmzasız char _InterlockedCompareExchange128 (\__int64 volatile *,\__int64,\__int64,\__int64\*)|  
...
|[_InterlockedCompareExchange8](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|_InterlockedCompareExchange8 char (char geçici * hedef, char Exchange, char karşılaştırılan)|  
...
|[_InterlockedDecrement](../intrinsics/interlockeddecrement-intrinsic-functions.md)||intrin.h|uzun _InterlockedDecrement(long volatile *)|  
...
|[_InterlockedExchange](../intrinsics/interlockedexchange-intrinsic-functions.md)||intrin.h|uzun _InterlockedExchange (uzun volatile *, uzun)|  
|[_InterlockedExchange_HLEAcquire](../intrinsics/interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedExchange_HLEAcquire (uzun volatile *, uzun)|  
|[_InterlockedExchange_HLERelease](../intrinsics/interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedExchange_HLERelease (uzun volatile *, uzun)|  
...
|[_Interlockedexchangeadd](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)||intrin.h|uzun _ınterlockedexchangeadd (uzun volatile *, uzun)|  
|[_Interlockedexchangeadd_hleacquire](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _ınterlockedexchangeadd_hleacquire (uzun volatile *, uzun)|  
|[_Interlockedexchangeadd_hlerelease](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _ınterlockedexchangeadd_hlerelease (uzun volatile *, uzun)|  
...
|[_Interlockedexchangeadd64](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)||intrin.h|__int64 _ınterlockedexchangeadd64 (\__int64 volatile *,\__int64)|  
|[_Interlockedexchangeadd64_hleacquire](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _ınterlockedexchangeadd64_hleacquire (\__int64 volatile *,\__int64)|  
|[_Interlockedexchangeadd64_hlerelease](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _ınterlockedexchangeadd64_hlerelease (\__int64 volatile *,\__int64)|  
...
|[_InterlockedExchangePointer](../intrinsics/interlockedexchangepointer-intrinsic-functions.md)||intrin.h|void * _InterlockedExchangePointer (void \*geçici \*, void \*)|  
...
|[_InterlockedIncrement](../intrinsics/interlockedincrement-intrinsic-functions.md)||intrin.h|uzun _InterlockedIncrement(long volatile *)|  
...
|[_InterlockedOr](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|uzun _InterlockedOr (uzun volatile *, uzun)|  
|[_InterlockedOr_HLEAcquire](../intrinsics/interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedOr_HLEAcquire (uzun volatile *, uzun)|  
|[_InterlockedOr_HLERelease](../intrinsics/interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedOr_HLERelease (uzun volatile *, uzun)|  
...
|[_InterlockedXor](../intrinsics/interlockedxor-intrinsic-functions.md)||intrin.h|uzun _InterlockedXor (uzun volatile *, uzun)|  
|[_InterlockedXor_HLEAcquire](../intrinsics/interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedXor_HLEAcquire (uzun volatile *, uzun)|  
|[_InterlockedXor_HLERelease](../intrinsics/interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedXor_HLERelease (uzun volatile *, uzun)|  
...
|[_invpcid](http://go.microsoft.com/fwlink/p/?LinkId=512130)|INVPCID [2]|immintrin.h|void _invpcid (imzalanmamış int, void *)|  
|[__inword](../intrinsics/inword.md)||intrin.h|İmzasız short __inword (imzasız kısa bağlantı noktası)|  
|[__inwordstring](../intrinsics/inwordstring.md)||intrin.h|void __inwordstring (işaretsiz kısa imzasız kısa bağlantı noktası * arabellek, uzun sayısı imzasız)|  
|_lgdt||intrin.h|void _lgdt(void*)|  
|[__lidt](../intrinsics/lidt.md)||intrin.h|void __lidt(void*)|  
|[__ll_lshift](../intrinsics/ll-lshift.md)||intrin.h|İmzasız __int64 [pascal/cdecl] \__ll_lshift (imzasız \__int64, int)|  
...
|_load_be_u16<br /><br /> [_loadbe_i16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i16&expand=3071)|MOVBE|immintrin.h|İmzasız short _load_be_u16 (void const *);<br /><br /> kısa _loadbe_i16 (void const\*); [3]|  
|_load_be_u32<br /><br /> [_loadbe_i32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i32&expand=3072)|MOVBE|immintrin.h|İmzasız int _load_be_u32 (void const *);<br /><br /> int _loadbe_i32 (void const\*); [3]|  
|_load_be_u64<br /><br /> [_loadbe_i64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i64&expand=3073)|MOVBE|immintrin.h|İmzasız __int64 _load_be_u64 (void const *);<br /><br /> \__int64 _loadbe_i64 (void const\*); [3]|  
|__lwpins32|LWP [1]|ammintrin.h|İmzasız char __lwpins32 (int, imzasız int, imzasız int imzasız)|  
|__lwpins64|LWP [1]|ammintrin.h|İmzasız char __lwpins64 (imzasız \__int64, imzasız int, int imzasız)|  
|__lwpval32|LWP [1]|ammintrin.h|void __lwpval32 (int, imzasız int, imzasız int imzasız)|  
|__lwpval64|LWP [1]|ammintrin.h|void __lwpval64 (imzasız \__int64, imzasız int, int imzasız)|  
|[__lzcnt](../intrinsics/lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|İmzasız int __lzcnt(unsigned int)|  
|[_lzcnt_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI|ammintrin.h, immintrin.h|İmzasız int _lzcnt_u32(unsigned int)|  
|[_lzcnt_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI|ammintrin.h, immintrin.h|İmzasız __int64 _lzcnt_u64 (imzasız \__int64)|  
|[__lzcnt16](../intrinsics/lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|İmzasız short __lzcnt16(unsigned short)|  
|[__lzcnt64](../intrinsics/lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|İmzasız __int64 \__lzcnt64 (imzasız \__int64)|  
...
|[_mm_crc32_u16](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE42|intrin.h|İmzasız int _mm_crc32_u16 (imzasız int kısa imzasız)|  
|[_mm_crc32_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE42|intrin.h|İmzasız int _mm_crc32_u32 (imzasız int, imzasız int)|  
|[_mm_crc32_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE42|intrin.h|İmzasız __int64 _mm_crc32_u64 (imzasız \_imzasız _int64 \__int64)|  
|[_mm_crc32_u8](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE42|intrin.h|İmzasız int _mm_crc32_u8 (imzasız int, imzasız char)|  
...
|[_mm_cvtsd_f64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSSE3|intrin.h|çift _mm_cvtsd_f64 (\__m128d)|  
...
|[_mm_cvtsd_si64x](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE2|intrin.h|__int64 _mm_cvtsd_si64x (\__m128d bir)|  
...
|[_mm_cvtsi128_si64x](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE2|intrin.h|__int64 _mm_cvtsi128_si64x (\__m128i bir)|  
...
|[_mm_cvtsi64x_si128](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE2|intrin.h|__m128i _mm_cvtsi64x_si128 (\__int64 bir)|  
|[_mm_cvtsi64x_ss](../intrinsics/mm-cvtsi64x-ss.md)|SSE2|intrin.h|__m128 _mm_cvtsi64x_ss (\__m128\__int64 b).|  
|[_mm_cvtss_f32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSSE3|intrin.h|_mm_cvtss_f32 float (\__m128)|  
...
|[_mm_cvtss_si64x](../intrinsics/mm-cvtss-si64x.md)|SSE2|intrin.h|__int64 _mm_cvtss_si64x (\__m128 bir)|  
...
|[_mm_cvttsd_si64x](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE2|intrin.h|__int64 _mm_cvttsd_si64x (\__m128d bir)|  
|[_mm_cvttss_si64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE2|intrin.h|__int64 _mm_cvttss_si64 (\__m128)|  
|[_mm_cvttss_si64x](../intrinsics/mm-cvttss-si64x.md)|SSE2|intrin.h|__int64 _mm_cvttss_si64x (\__m128 bir)|  
...
|[_mm_getcsr](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE|intrin.h|İmzasız int _mm_getcsr(void)|  
...
|[_mm_i32gather_epi32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128i _mm_i32gather_epi32 (const Int * tabanının\__m128i dizini, const Int Ölçek)|  
|[_mm_i32gather_epi64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128i _mm_i32gather_epi64 (\__int64 const * temel,\__m128i dizini, const Int Ölçek)|  
|[_mm_i32gather_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128d _mm_i32gather_pd (çift const * tabanının\__m128i dizini, const Int Ölçek)|  
|[_mm_i32gather_ps](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128 _mm_i32gather_ps (const float * tabanının\__m128i dizini, const Int Ölçek)|  
|[_mm_i64gather_epi32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128i _mm_i64gather_epi32 (const Int * tabanının\__m128i dizini, const Int Ölçek)|  
|[_mm_i64gather_epi64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128i _mm_i64gather_epi64 (\__int64 const * temel,\__m128i dizini, const Int Ölçek)|  
|[_mm_i64gather_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128d _mm_i64gather_pd (çift const * tabanının\__m128i dizini, const Int Ölçek)|  
|[_mm_i64gather_ps](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128 _mm_i64gather_ps (const float * tabanının\__m128i dizini, const Int Ölçek)|  
...
|[_mm_loaddup_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE3|intrin.h|__m128d _mm_loaddup_pd (çift const *)|  
|[_mm_loadh_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE2|intrin.h|__m128d _mm_loadh_pd (\__m128d, çift *)|  
...
|[_mm_loadl_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE2|intrin.h|__m128d _mm_loadl_pd (\__m128d, çift *)|  
...
|[_mm_mask_i32gather_epi32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i32gather_epi32 (\__m128i src, const Int * temel,\__m128i dizin\__m128i maske, const Int Ölçek)|  
|[_mm_mask_i32gather_epi64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i32gather_epi64 (\__m128i src\__int64 const * temel,\__m128i dizin\__m128i maske, const Int Ölçek)|  
|[_mm_mask_i32gather_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128d _mm_mask_i32gather_pd (\__m128d src, çift const * temel,\__m128i dizin\__m128d maske, const Int Ölçek)|  
|[_mm_mask_i32gather_ps](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128 _mm_mask_i32gather_ps (\__m128 src, float const * temel,\__m128i dizin\__m128 maske, const Int Ölçek)|  
|[_mm_mask_i64gather_epi32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i64gather_epi32 (\__m128i src, const Int * temel,\__m128i dizin\__m128i maske, const Int Ölçek)|  
|[_mm_mask_i64gather_epi64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i64gather_epi64 (\__m128i src\__int64 const * temel,\__m128i dizin\__m128i maske, const Int Ölçek)|  
|[_mm_mask_i64gather_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128d _mm_mask_i64gather_pd (\__m128d src, çift const * temel,\__m128i dizin\__m128d maske, const Int Ölçek)|  
|[_mm_mask_i64gather_ps](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128 _mm_mask_i64gather_ps (\__m128 src, float const * temel,\__m128i dizin\__m128 maske, const Int Ölçek)|  
|[_mm_maskload_epi32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128i _mm_maskload_epi32 (const Int *,\__m128i)|  
...
|[_mm_maskload_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX [2]|immintrin.h|__m128d _mm_maskload_pd (çift const *,\__m128i)|  
|[_mm_maskload_ps](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX [2]|immintrin.h|__m128 _mm_maskload_ps (const float *,\__m128i)|  
...
|[_mm_maskstore_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX [2]|immintrin.h|void _mm_maskstore_pd (çift *,\__m128i,\__m128d)|  
...
|[_mm_monitor](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE3|intrin.h|void _mm_monitor (void const *, imzasız int, imzasız int)|  
...
|[_mm_mwait](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE3|intrin.h|void _mm_mwait (imzasız int, imzasız int)|  
...
|[_mm_popcnt_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|POPCNT|intrin.h|__int64 _mm_popcnt_u64 (imzasız \__int64)|  
...
|[_mm_set1_epi64x](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE2|intrin.h|__m128i _mm_set1_epi64x (\__int64 t)|  
...
|[_mm_shuffle_ps](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE|intrin.h|__m128 _mm_shuffle_ps (\__m128,\__m128, imzasız int)|  
...
|[_mm_store_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE2|intrin.h|void _mm_store_pd (çift *\__m128d)|  
...
|[_mm_store_sd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE2|intrin.h|void _mm_store_sd (çift *\__m128d)|  
...
|[_mm_store1_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE2|intrin.h|void _mm_store1_pd (çift *\__m128d)|  
|[_mm_storeh_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE2|intrin.h|void _mm_storeh_pd (çift *\__m128d)|  
...
|[_mm_storel_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE2|intrin.h|void _mm_storel_pd (çift *\__m128d)|  
|[_mm_storel_pi](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE|intrin.h|void _mm_storel_pi (\__m64 *\__m128)|  
|[_mm_storer_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE2|intrin.h|void _mm_storer_pd (çift *\__m128d)|  
|[_mm_storer_ps](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE|intrin.h|void _mm_storer_ps (float *\__m128)|  
|[_mm_storeu_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE2|intrin.h|void _mm_storeu_pd (çift *\__m128d)|  
...
|[_mm_stream_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE2|intrin.h|void _mm_stream_pd (çift *\__m128d)|  
...
|[_mm256_extracti128_si256](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128i _mm256_extracti128_si256 (\__m256i int uzaklığı)|  
...
|[_mm256_i32gather_epi32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m256i _mm256_i32gather_epi32 (const Int * tabanının\__m256i dizini, const Int Ölçek)|  
|[_mm256_i32gather_epi64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m256i _mm256_i32gather_epi64 (\__int64 const * temel,\__m128i dizini, const Int Ölçek)|  
|[_mm256_i32gather_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m256d _mm256_i32gather_pd (çift const * tabanının\__m128i dizini, const Int Ölçek)|  
|[_mm256_i32gather_ps](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m256 _mm256_i32gather_ps (const float * tabanının\__m256i dizini, const Int Ölçek)|  
|[_mm256_i64gather_epi32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m256i _mm256_i64gather_epi32 (const Int * tabanının\__m256i dizini, const Int Ölçek)|  
|[_mm256_i64gather_epi64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m256i _mm256_i64gather_epi64 (\__int64 const * temel,\__m256i dizini, const Int Ölçek)|  
|[_mm256_i64gather_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m256d _mm256_i64gather_pd (çift const * tabanının\__m256i dizini, const Int Ölçek)|  
|[_mm256_i64gather_ps](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128 _mm256_i64gather_ps (const float * tabanının\__m256i dizini, const Int Ölçek)|  
...
|[_mm256_mask_i32gather_epi32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m256i _mm256_mask_i32gather_epi32 (\__m256i src, const Int * temel,\__m256i dizin\__m256i maske, const Int Ölçek)|  
|[_mm256_mask_i32gather_epi64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m256i _mm256_mask_i32gather_epi64 (\__m256i src\__int64 const * temel,\__m128i dizin\__m256i maske, const Int Ölçek)|  
|[_mm256_mask_i32gather_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m256d _mm256_mask_i32gather_pd (\__m256d src, çift const * temel,\__m128i dizin\__m256d maske, const Int Ölçek)|  
|[_mm256_mask_i32gather_ps](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m256 _mm256_mask_i32gather_ps (\__m256 src, float const * temel,\__m256i dizin\__m256 maske, const Int Ölçek)|  
|[_mm256_mask_i64gather_epi32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128i _mm256_mask_i64gather_epi32 (\__m128i src, const Int * temel,\__m256i dizin\__m128i maske, const Int Ölçek)|  
|[_mm256_mask_i64gather_epi64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m256i _mm256_mask_i64gather_epi64 (\__m256i src\__int64 const * temel,\__m256i dizin\__m256i maske, const Int Ölçek)|  
|[_mm256_mask_i64gather_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m256d _mm256_mask_i64gather_pd (\__m256d src, çift const * temel,\__m256i dizin\__m256d maske, const Int Ölçek)|  
|[_mm256_mask_i64gather_ps](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m128 _mm256_mask_i64gather_ps (\__m128 src, float const * temel,\__m256i dizin\__m128 maske, const Int Ölçek)|  
|[_mm256_maskload_epi32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX2 [2]|immintrin.h|__m256i _mm256_maskload_epi32 (const Int *,\__m256i)|  
...
|[_mm256_maskload_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX [2]|immintrin.h|__m256d _mm256_maskload_pd (çift const *,\__m256i)|  
|[_mm256_maskload_ps](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX [2]|immintrin.h|__m256 _mm256_maskload_ps (const float *,\__m256i)|  
...
|[_mm256_maskstore_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX [2]|immintrin.h|void _mm256_maskstore_pd (çift *,\__m256i,\__m256d)|  
...
|[_mm256_set_epi16](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX [2]|immintrin.h|(__m256i _mm256_set_epi16 (kısa|  
...
|[_mm256_set_epi64x](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX [2]|immintrin.h|__m256i _mm256_set_epi64x (uzun uzun, uzun uzun, uzun uzun, uzun uzun)|  
...
|[_mm256_set1_epi64x](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX [2]|immintrin.h|__m256i _mm256_set1_epi64x (uzun uzun)|  
...
|[_mm256_setr_epi16](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX [2]|immintrin.h|(__m256i _mm256_setr_epi16 (kısa|  
...
|[_mm256_setr_epi64x](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX [2]|immintrin.h|__m256i _mm256_setr_epi64x (uzun uzun, uzun uzun, uzun uzun, uzun uzun)|  
...
|[_mm256_store_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX [2]|immintrin.h|void _mm256_store_pd (çift *,\__m256d)|  
...
|[_mm256_storeu_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX [2]|immintrin.h|void _mm256_storeu_pd (çift *,\__m256d)|  
...
|[_mm256_stream_pd](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX [2]|immintrin.h|void __mm256_stream_pd (çift *,\__m256d)|  
|[_mm256_stream_ps](http://go.microsoft.com/fwlink/p/?LinkId=512130)|AVX [2]|immintrin.h|void _mm256_stream_ps (float * p\__m256 bir)|  
...
|[__movsb](../intrinsics/movsb.md)||intrin.h|VOID __movsb (İNÇ PBYTE, IN bayt const *, IN SIZE_T)|  
|[__movsd](../intrinsics/movsd.md)||intrin.h|VOID __movsd (İNÇ PDWORD, IN DWORD const *, IN SIZE_T)|  
|[__movsq](../intrinsics/movsq.md)||intrin.h|VOID __movsq (İNÇ PDWORD64, IN DWORD64 const *, IN SIZE_T)|  
|[__movsw](../intrinsics/movsw.md)||intrin.h|VOID __movsw (İNÇ PWORD, IN WORD const *, IN SIZE_T)|  
|[_mul128](../intrinsics/mul128.md)||intrin.h|__int64 _mul128 (\__int64 çarpanı\__int64 multiplicand\__int64 * highproduct)|  
|[__mulh](../intrinsics/mulh.md)||intrin.h|__int64 \__mulh (\__int64,\__int64)|  
|_mulx_u32|BMI [2]|immintrin.h|İmzasız int _mulx_u32 (int, imzasız int, imzasız int * imzasız)|  
|_mulx_u64|BMI [2]|immintrin.h|İmzasız __int64 _mulx_u64 (imzasız \_imzasız _int64 \_imzasız _int64 \__int64 *)|  
...
|[__outbyte](../intrinsics/outbyte.md)||intrin.h|void __outbyte (imzasız kısa bağlantı noktası, imzasız char veri)|  
|[__outbytestring](../intrinsics/outbytestring.md)||intrin.h|void __outbytestring (imzasız kısa bağlantı noktası, imzasız char * arabellek, uzun sayısı imzasız)|  
|[__outdword](../intrinsics/outdword.md)||intrin.h|void __outdword (imzasız kısa bağlantı noktası, imzasız long veri)|  
|[__outdwordstring](../intrinsics/outdwordstring.md)||intrin.h|void __outdwordstring (işaretsiz kısa bağlantı noktası, uzun imzasız * arabellek, uzun sayısı imzasız)|  
|[__outword](../intrinsics/outword.md)||intrin.h|void __outword (imzasız kısa bağlantı noktası, imzasız short veri)|  
|[__outwordstring](../intrinsics/outwordstring.md)||intrin.h|void __outwordstring (işaretsiz kısa imzasız kısa bağlantı noktası * arabellek, uzun sayısı imzasız)|  
|[_pdep_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI [2]|immintrin.h|İmzasız int _pdep_u32 (imzasız int, imzasız int)|  
|[_pdep_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI [2]|immintrin.h|İmzasız __int64 _pdep_u64 (imzasız \_imzasız _int64 \__int64)|  
|[_pext_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI [2]|immintrin.h|İmzasız int _pext_u32 (imzasız int, imzasız int)|  
|[_pext_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI [2]|immintrin.h|İmzasız __int64 _pext_u64 (imzasız \_imzasız _int64 \__int64)|  
|[__popcnt](../intrinsics/popcnt16-popcnt-popcnt64.md)|POPCNT|intrin.h|İmzasız int __popcnt(unsigned int)|  
|[__popcnt16](../intrinsics/popcnt16-popcnt-popcnt64.md)|POPCNT|intrin.h|İmzasız short __popcnt16(unsigned short)|  
|[__popcnt64](../intrinsics/popcnt16-popcnt-popcnt64.md)|POPCNT|intrin.h|İmzasız __int64 \__popcnt64 (imzasız \__int64)|  
...
|[_rdrand64_step](http://go.microsoft.com/fwlink/p/?LinkId=512130)|RDRAND [2]|immintrin.h|int _rdrand64_step (imzasız \__int64 *)|  
...
|[_rdseed64_step](http://go.microsoft.com/fwlink/p/?LinkId=512130)|RDSEED [2]|immintrin.h|int _rdseed64_step (imzasız \__int64 *)|  
|[__rdtsc](../intrinsics/rdtsc.md)||intrin.h|İmzasız __int64 \__rdtsc(void)|  
|[__rdtscp](../intrinsics/rdtscp.md)|RDTSCP|intrin.h|İmzasız __int64 \__rdtscp (imzasız int *)|  
|[_ReadBarrier](../intrinsics/readbarrier.md)||intrin.h|void _ReadBarrier(void)|  
|[__readcr0](../intrinsics/readcr0.md)||intrin.h|İmzasız __int64 \__readcr0(void)|  
|[__readcr2](../intrinsics/readcr2.md)||intrin.h|İmzasız __int64 \__readcr2(void)|  
|[__readcr3](../intrinsics/readcr3.md)||intrin.h|İmzasız __int64 \__readcr3(void)|  
|[__readcr4](../intrinsics/readcr4.md)||intrin.h|İmzasız __int64 \__readcr4(void)|  
|[__readcr8](../intrinsics/readcr8.md)||intrin.h|İmzasız __int64 \__readcr8(void)|  
|[__readdr](../intrinsics/readdr.md)||intrin.h|İmzasız __int64 \__readdr(unsigned)|  
|[__readeflags](../intrinsics/readeflags.md)||intrin.h|İmzasız __int64 \__readeflags(void)|  
|[_readfsbase_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|FSGSBASE [2]|immintrin.h|İmzasız int _readfsbase_u32(void)|  
|[_readfsbase_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|FSGSBASE [2]|immintrin.h|İmzasız __int64 _readfsbase_u64(void)|  
|[_readgsbase_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|FSGSBASE [2]|immintrin.h|İmzasız int _readgsbase_u32(void)|  
|[_readgsbase_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|FSGSBASE [2]|immintrin.h|İmzasız __int64 _readgsbase_u64(void)|  
|[__readgsbyte](../intrinsics/readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|İmzasız char __readgsbyte (imzasız mesafesi)|  
|[__readgsdword](../intrinsics/readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|uzun __readgsdword (imzasız mesafesi) imzalanmamış|  
|[__readgsqword](../intrinsics/readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|İmzasız __int64 \__readgsqword (imzasız mesafesi)|  
|[__readgsword](../intrinsics/readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|İmzasız short __readgsword (imzasız mesafesi)|  
|[__readmsr](../intrinsics/readmsr.md)||intrin.h|İmzasız __int64 \__readmsr (uzun imzasız)|  
|[__readpmc](../intrinsics/readpmc.md)||intrin.h|İmzasız __int64 \__readpmc(unsigned long a)|  
...
|_rorx_u32|BMI [2]|immintrin.h|İmzasız int _rorx_u32 (imzasız int, const imzasız int)|  
|_rorx_u64|BMI [2]|immintrin.h|İmzasız __int64 _rorx_u64 (imzasız \__int64, const imzasız int)|  
|[_rotl16](../intrinsics/rotl8-rotl16.md)||intrin.h|İmzasız short _rotl16 (işaretsiz kısa değer, imzasız char shift)|  
|[_rotl8](../intrinsics/rotl8-rotl16.md)||intrin.h|İmzasız char _rotl8 (imzasız char değeri, imzasız char shift)|  
|[_rotr16](../intrinsics/rotr8-rotr16.md)||intrin.h|İmzasız short _rotr16 (işaretsiz kısa değer, imzasız char shift)|  
|[_rotr8](../intrinsics/rotr8-rotr16.md)||intrin.h|İmzasız char _rotr8 (imzasız char değeri, imzasız char shift)|  
|_rsm||intrin.h|void _rsm(void)|  
|_sarx_i32|BMI [2]|immintrin.h|int _sarx_i32 (int, imzasız int)|  
|_sarx_i64|BMI [2]|immintrin.h|__int64 _sarx_i64 (\__int64, imzasız int)|  
|[__segmentlimit](../intrinsics/segmentlimit.md)||intrin.h|uzun imzasız __segmentlimit(unsigned long a)|  
|_sgdt||intrin.h|void _sgdt(void*)|  
|[__shiftleft128](../intrinsics/shiftleft128.md)||intrin.h|İmzasız __int64 \__shiftleft128 (imzasız \__int64 alt kısım, imzasız \__int64 HighPart imzasız char Shift)|  
|[__shiftright128](../intrinsics/shiftright128.md)||intrin.h|İmzasız __int64 \__shiftright128 (imzasız \__int64 alt kısım, imzasız \__int64 HighPart imzasız char Shift)|  
|_shlx_u32|BMI [2]|immintrin.h|İmzasız int _shlx_u32 (imzasız int, imzasız int)|  
|_shlx_u64|BMI [2]|immintrin.h|İmzasız __int64 _shlx_u64 (imzasız \__int64, imzasız int)|  
|_shrx_u32|BMI [2]|immintrin.h|İmzasız int _shrx_u32 (imzasız int, imzasız int)|  
|_shrx_u64|BMI [2]|immintrin.h|İmzasız __int64 _shrx_u64 (imzasız \__int64, imzasız int)|  
...
|_store_be_u16<br /><br /> [_storebe_i16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i16&expand=5141)|MOVBE|immintrin.h|void _store_be_u16 (void *, kısa imzasız);<br /><br /> void _storebe_i16 (void \*, kısa); [3]|  
|_store_be_u32<br /><br /> [_storebe_i32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i32&expand=5142)|MOVBE|immintrin.h|void _store_be_u32 (void *, imzalanmamış int);<br /><br /> void _storebe_i32 (void \*, int); [3]|  
|_store_be_u64<br /><br /> [_storebe_i64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i64&expand=5143)|MOVBE|immintrin.h|void _store_be_u64 (void *, imzasız \__int64);<br /><br /> void _storebe_i64 (void \*, \__int64); [3]|  
|_Store_HLERelease|HLE [2]|immintrin.h|void _Store_HLERelease (uzun volatile *, uzun)|  
...
|[__stosb](../intrinsics/stosb.md)||intrin.h|void __stosb (İNÇ PBYTE, IN bayt IN SIZE_T)|  
|[__stosd](../intrinsics/stosd.md)||intrin.h|void __stosd (İNÇ PDWORD, IN DWORD IN SIZE_T)|  
|[__stosq](../intrinsics/stosq.md)||intrin.h|void __stosq (İNÇ PDWORD64, IN DWORD64 IN SIZE_T)|  
|[__stosw](../intrinsics/stosw.md)||intrin.h|void __stosw (İNÇ PWORD, IN WORD IN SIZE_T)|  
|_subborrow_u16||intrin.h|İmzasız char _subborrow_u16 (imzasız char b_in, imzasız kısa src1, kısa imzasız imzasız kısa src2 * fark)|  
|[_subborrow_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)||intrin.h|İmzasız char _subborrow_u32 (imzasız char b_in, imzasız int src1, imzasız int src2, imzasız int * fark)|  
|[_subborrow_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)||intrin.h|İmzasız char _subborrow_u64 (imzasız imzasız char b_in \_imzasız _int64 src1 \_imzasız _int64 src2 \__int64 * fark)|  
...
|_t1mskc_u32|ABM [1]|ammintrin.h|İmzasız int _t1mskc_u32(unsigned int)|  
|_t1mskc_u64|ABM [1]|ammintrin.h|İmzasız __int64 _t1mskc_u64 (imzasız \__int64)|  
|[_tzcnt_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI|ammintrin.h, immintrin.h|İmzasız int _tzcnt_u32(unsigned int)|  
|[_tzcnt_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|BMI|ammintrin.h, immintrin.h|İmzasız __int64 _tzcnt_u64 (imzasız \__int64)|  
|_tzmsk_u32|ABM [1]|ammintrin.h|İmzasız int _tzmsk_u32(unsigned int)|  
|_tzmsk_u64|ABM [1]|ammintrin.h|İmzasız __int64 _tzmsk_u64 (imzasız \__int64)|  
|[__ud2](../intrinsics/ud2.md)||intrin.h|void __ud2(void)|  
|[__ull_rshift](../intrinsics/ull-rshift.md)||intrin.h|İmzasız __int64 [pascal/cdecl] \__ull_rshift (imzasız \__int64, int)|  
|[_umul128](../intrinsics/umul128.md)||intrin.h|İmzasız __int64 _umul128 (imzasız \_imzasız _int64 çarpanı \_imzasız _int64 multiplicand \__int64 * highproduct)|  
|[__umulh](../intrinsics/umulh.md)||intrin.h|İmzasız __int64 \__umulh (imzasız \_imzasız _int64 \__int64)|  
|[__vmx_off](../intrinsics/vmx-off.md)||intrin.h|void __vmx_off(void)|  
|[__vmx_on](../intrinsics/vmx-on.md)||intrin.h|İmzasız char __vmx_on (imzasız \__int64 *)|  
|[__vmx_vmclear](../intrinsics/vmx-vmclear.md)||intrin.h|İmzasız char __vmx_vmclear (imzasız \__int64 *)|  
|[__vmx_vmlaunch](../intrinsics/vmx-vmlaunch.md)||intrin.h|İmzasız char __vmx_vmlaunch(void)|  
|[__vmx_vmptrld](../intrinsics/vmx-vmptrld.md)||intrin.h|İmzasız char __vmx_vmptrld (imzasız \__int64 *)|  
|[__vmx_vmptrst](../intrinsics/vmx-vmptrst.md)||intrin.h|void __vmx_vmptrst (imzasız \__int64 *)|  
...
|[__writecr0](../intrinsics/writecr0.md)||intrin.h|void __writecr0 (imzasız \__int64)|  
|[__writecr3](../intrinsics/writecr3.md)||intrin.h|void __writecr3 (imzasız \__int64)|  
|[__writecr4](../intrinsics/writecr4.md)||intrin.h|void __writecr4 (imzasız \__int64)|  
|[__writecr8](../intrinsics/writecr8.md)||intrin.h|void __writecr8 (imzasız \__int64)|  
|[__writedr](../intrinsics/writedr.md)||intrin.h|void __writedr (işaretsiz, imzasız \__int64)|  
|[__writeeflags](../intrinsics/writeeflags.md)||intrin.h|void __writeeflags (imzasız \__int64)|  
|[_writefsbase_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|FSGSBASE [2]|immintrin.h|void _writefsbase_u32(unsigned int)|  
|[_writefsbase_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|FSGSBASE [2]|immintrin.h|void _writefsbase_u64 (imzasız \__int64)|  
|[_writegsbase_u32](http://go.microsoft.com/fwlink/p/?LinkId=512130)|FSGSBASE [2]|immintrin.h|void _writegsbase_u32(unsigned int)|  
|[_writegsbase_u64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|FSGSBASE [2]|immintrin.h|void _writegsbase_u64 (imzasız \__int64)|  
|[__writegsbyte](../intrinsics/writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsbyte (imzasız uzun uzaklık, imzasız char veri)|  
|[__writegsdword](../intrinsics/writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsdword (imzasız uzun uzaklık, imzasız long veri)|  
|[__writegsqword](../intrinsics/writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsqword (imzasız imzasız mesafesi \__int64 veri)|  
|[__writegsword](../intrinsics/writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsword (imzasız uzun uzaklık, imzasız short veri)|  
|[__writemsr](../intrinsics/writemsr.md)||intrin.h|void __writemsr (uzun İmzasız, imzasız \__int64)|  
|[_xabort](http://go.microsoft.com/fwlink/p/?LinkId=512130)|[2] RTM|immintrin.h|void _xabort(unsigned int)|  
|[_xbegin](http://go.microsoft.com/fwlink/p/?LinkId=512130)|[2] RTM|immintrin.h|İmzasız _xbegin(void)|  
|[_xend](http://go.microsoft.com/fwlink/p/?LinkId=512130)|[2] RTM|immintrin.h|void _xend(void)|  
|[_xgetbv](http://go.microsoft.com/fwlink/p/?LinkId=512130)|XSAVE [2]|immintrin.h|İmzasız __int64 _xgetbv(unsigned int)|  
|[_xrstor](http://go.microsoft.com/fwlink/p/?LinkId=512130)|XSAVE [2]|immintrin.h|void _xrstor (void const İmzasız *, \__int64)|  
|[_xrstor64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|XSAVE [2]|immintrin.h|void _xrstor64 (void const İmzasız *, \__int64)|  
|[_xsave](http://go.microsoft.com/fwlink/p/?LinkId=512130)|XSAVE [2]|immintrin.h|void _xsave (geçersiz kılma İmzasız *, \__int64)|  
|[_xsave64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|XSAVE [2]|immintrin.h|void _xsave64 (geçersiz kılma İmzasız *, \__int64)|  
|[_xsaveopt](http://go.microsoft.com/fwlink/p/?LinkId=512130)|XSAVEOPT [2]|immintrin.h|void _xsaveopt (geçersiz kılma İmzasız *, \__int64)|  
|[_xsaveopt64](http://go.microsoft.com/fwlink/p/?LinkId=512130)|XSAVEOPT [2]|immintrin.h|void _xsaveopt64 (geçersiz kılma İmzasız *, \__int64)|  
|[_xsetbv](http://go.microsoft.com/fwlink/p/?LinkId=512130)|XSAVE [2]|immintrin.h|void _xsetbv (imzasız imzasız int \__int64)|  
|[_xtest](http://go.microsoft.com/fwlink/p/?LinkId=512130)|XTEST [2]|immintrin.h|İmzasız char _xtest(void)|  
