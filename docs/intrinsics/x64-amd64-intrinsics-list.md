...
Aşağıdaki tabloda x64 üzerinde kullanılabilir yapı içlerini listeler işlemci. Teknoloji sütunu gerekli yönerge kümesi desteği listelenmektedir. Kullanım [__cpuid](cpuid-cpuidex.md) iç çalışma zamanında yönerge kümesi desteğini belirlemek için. İki giriş tek bir satırda varsa, bunlar farklı Giriş noktalarının aynı iç temsil eder. [1] iç yalnızca AMD işlemciler üzerinde kullanılabilir olduğunu gösterir. [2] iç yalnızca Intel işlemci üzerinde kullanılabilir olduğunu gösterir. [3], bir makro prototip olduğunu gösterir. İşlev prototipi için gereken üst bilgi Üstbilgi sütununda listelenir. İmmintrin.h hem ammintrin.h kolaylık olması için ıntrin.h üstbilgisi içerir.

|Yapı içi adı|Teknoloji|Üstbilgi|İşlev prototipi|
|--------------------|----------------|------------|------------------------|
|_addcarry_u16||intrin.h|İmzasız char _addcarry_u16 (işaretsiz karakter, işaretsiz, işaretsiz, işaretsiz \*)|
|[_addcarry_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u32)||intrin.h|İmzasız char _addcarry_u32 (imzasız char, işaretsiz int, işaretsiz int, işaretsiz int \*)|
|[_addcarry_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u64)||intrin.h|İmzasız char _addcarry_u64 (işaretsiz karakter, imzasız \__int64, işaretsiz \__int64, işaretsiz \__int64 \*)|
|_addcarry_u8||intrin.h|İmzasız char _addcarry_u8 (imzasız char unsigned char, imzasız char, imzasız char \*)|
|[_addcarryx_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u32)|ADX [2]|immintrin.h|İmzasız char _addcarryx_u32 (imzasız char, işaretsiz int, işaretsiz int, işaretsiz int \*)|
|[_addcarryx_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u64)|ADX [2]|immintrin.h|İmzasız char _addcarryx_u64 (işaretsiz karakter, imzasız \__int64, işaretsiz \__int64, işaretsiz \__int64 \*)|
|[__addgsbyte](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsbyte (işaretsiz uzun, işaretsiz karakter)|
|[__addgsdword](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsdword (işaretsiz uzun, işaretsiz int)|
|[__addgsqword](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsqword (işaretsiz uzun, işaretsiz \__int64)|
|[__addgsword](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsword (işaretsiz uzun, işaretsiz kısa)|
...
|[_BitScanForward](bitscanforward-bitscanforward64.md)||intrin.h|İmzasız char _BitScanForward (işaretsiz uzun\*, işaretsiz uzun)|
|[_BitScanForward64](bitscanforward-bitscanforward64.md)||intrin.h|İmzasız char _BitScanForward64 (işaretsiz uzun\*imzalanmamış \__int64)|
|[_BitScanReverse](bitscanreverse-bitscanreverse64.md)||intrin.h|İmzasız char _BitScanReverse (işaretsiz uzun\*, işaretsiz uzun)|
|[_BitScanReverse64](bitscanreverse-bitscanreverse64.md)||intrin.h|İmzasız char _BitScanReverse64 (işaretsiz uzun\*imzalanmamış \__int64)|
|[_bittest](bittest-bittest64.md)||intrin.h|İmzasız char _bittest (uzun const \*, uzun)|
|[_bittest64](bittest-bittest64.md)||intrin.h|İmzasız char _bittest64 (\__int64 const \*, \__int64)|
|[_bittestandcomplement](bittestandcomplement-bittestandcomplement64.md)||intrin.h|İmzasız char _bittestandcomplement (uzun \*, uzun)|
|[_bittestandcomplement64](bittestandcomplement-bittestandcomplement64.md)||intrin.h|İmzasız char _bittestandcomplement64 (\__int64 \*, \__int64)|
|[_bittestandreset](bittestandreset-bittestandreset64.md)||intrin.h|İmzasız char _bittestandreset (uzun \*, uzun)|
|[_bittestandreset64](bittestandreset-bittestandreset64.md)||intrin.h|İmzasız char _bittestandreset64 (\__int64 \*, \__int64)|
|[_bittestandset](bittestandset-bittestandset64.md)||intrin.h|İmzasız char _bittestandset (uzun \*, uzun)|
|[_bittestandset64](bittestandset-bittestandset64.md)||intrin.h|İmzasız char _bittestandset64 (\__int64 \*, \__int64)|
...
|[__emulu](emul-emulu.md)||intrin.h|imzalanmamış __int64 pascal/cdecl\__emulu (işaretsiz int, işaretsiz int)|
...
|[__inbyte](inbyte.md)||intrin.h|İmzasız char __inbyte(unsigned short)|
|[__inbytestring](inbytestring.md)||intrin.h|void __inbytestring (unsigned char kısa, işaretsiz \*, işaretsiz uzun)|
...
|[__indword](indword.md)||intrin.h|işaretsiz uzun __indword(unsigned short)|
|[__indwordstring](indwordstring.md)||intrin.h|void __indwordstring (işaretsiz uzun kısa, işaretsiz \*, işaretsiz uzun)|
|[__int2c](int2c.md)||intrin.h|void __int2c(void)|
|[_Interlockedand](interlockedand-intrinsic-functions.md)||intrin.h|uzun _ınterlockedand (uzun geçici \*, uzun)|
|[_InterlockedAnd_HLEAcquire](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedAnd_HLEAcquire (uzun geçici \*, uzun)|
|[_InterlockedAnd_HLERelease](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedAnd_HLERelease (uzun geçici \*, uzun)|
...
|[_InterlockedAnd64_HLEAcquire](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedAnd64_HLEAcquire (\__int64 geçici \*, \__int64)|
|[_InterlockedAnd64_HLERelease](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedAnd64_HLERelease (\__int64 geçici \*, \__int64)|
|[_InterlockedAnd64_np](interlockedand-intrinsic-functions.md)||intrin.h|__int64 _InterlockedAnd64_np (\__int64 \*, \__int64)|
|[_InterlockedAnd8](interlockedand-intrinsic-functions.md)||intrin.h|_InterlockedAnd8 char (char geçici \*, char)|
|[_InterlockedAnd8_np](interlockedand-intrinsic-functions.md)||intrin.h|_InterlockedAnd8_np char (char \*, char)|
|[_interlockedbittestandreset](interlockedbittestandreset-intrinsic-functions.md)||intrin.h|İmzasız char _interlockedbittestandreset (uzun \*, uzun)|
|[_interlockedbittestandreset_HLEAcquire](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|İmzasız char _interlockedbittestandreset_HLEAcquire (uzun \*, uzun)|
|[_interlockedbittestandreset_HLERelease](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|İmzasız char _interlockedbittestandreset_HLERelease (uzun \*, uzun)|
|[_interlockedbittestandreset64](interlockedbittestandreset-intrinsic-functions.md)||intrin.h|İmzasız char _interlockedbittestandreset64 (\__int64 \*, \__int64)|
|[_interlockedbittestandreset64_HLEAcquire](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|İmzasız char _interlockedbittestandreset64_HLEAcquire (\__int64 \*, \__int64)|
|[_interlockedbittestandreset64_HLERelease](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|İmzasız char _interlockedbittestandreset64_HLERelease (\__int64 \*, \__int64)|
|[_interlockedbittestandset](interlockedbittestandset-intrinsic-functions.md)||intrin.h|İmzasız char _interlockedbittestandset (uzun \*, uzun)|
|[_interlockedbittestandset_HLEAcquire](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|İmzasız char _interlockedbittestandset_HLEAcquire (uzun \*, uzun)|
|[_interlockedbittestandset_HLERelease](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|İmzasız char _interlockedbittestandset_HLERelease (uzun \*, uzun)|
|[_interlockedbittestandset64](interlockedbittestandset-intrinsic-functions.md)||intrin.h|İmzasız char _interlockedbittestandset64 (\__int64 \*, \__int64)|
|[_interlockedbittestandset64_HLEAcquire](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|İmzasız char _interlockedbittestandset64_HLEAcquire (\__int64 \*, \__int64)|
|[_interlockedbittestandset64_HLERelease](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|İmzasız char _interlockedbittestandset64_HLERelease (\__int64 \*, \__int64)|
|[_InterlockedCompareExchange](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|uzun _ınterlockedcompareexchange (uzun geçici \*uzun, uzun)|
|[_InterlockedCompareExchange_HLEAcquire](interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedCompareExchange_HLEAcquire (uzun geçici \*uzun, uzun)|
|[_InterlockedCompareExchange_HLERelease](interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedCompareExchange_HLERelease (uzun geçici \*uzun, uzun)|
...
|[_InterlockedCompareExchange128](interlockedcompareexchange128.md)||intrin.h|İmzasız char _InterlockedCompareExchange128 (\__int64 geçici \*, \__int64, \__int64, \__int64\*)|
|[_InterlockedCompareExchange128_np](interlockedcompareexchange128.md)||intrin.h|İmzasız char _InterlockedCompareExchange128 (\__int64 geçici \*, \__int64, \__int64, \__int64\*)|
...
|[_InterlockedCompareExchange64_HLEAcquire](interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedCompareExchange64_HLEAcquire (\__int64 geçici \*, \__int64, \__int64)|
|[_InterlockedCompareExchange64_HLERelease](interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedCompareExchange64_HLERelease (\__int64 geçici \*, \__int64, \__int64)|
...
|[_InterlockedCompareExchange8](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|_InterlockedCompareExchange8 char (char geçici \*, karakter, karakter)|
|[_InterlockedCompareExchangePointer](interlockedcompareexchangepointer-intrinsic-functions.md)||intrin.h|void \*_ınterlockedcompareexchangepointer (void \*geçici \*, void \*, void \*)|
|[_InterlockedCompareExchangePointer_HLEAcquire](interlockedcompareexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void * _InterlockedCompareExchangePointer_HLEAcquire (void \*geçici \*, void \*, void \*)|
|[_InterlockedCompareExchangePointer_HLERelease](interlockedcompareexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void * _InterlockedCompareExchangePointer_HLERelease (void \*geçici \*, void \*, void \*)|
...
|[_Interlockeddecrement](interlockeddecrement-intrinsic-functions.md)||intrin.h|uzun _ınterlockeddecrement (uzun geçici \*)|
...
|[_Interlockedexchange](interlockedexchange-intrinsic-functions.md)||intrin.h|uzun _ınterlockedexchange (uzun geçici \*, uzun)|
|[_InterlockedExchange_HLEAcquire](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedExchange_HLEAcquire (uzun geçici \*, uzun)|
|[_InterlockedExchange_HLERelease](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedExchange_HLERelease (uzun geçici \*, uzun)|
...
|[_InterlockedExchange64_HLEAcquire](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedExchange64_HLEAcquire (\__int64 geçici \*, \__int64)|
|[_InterlockedExchange64_HLERelease](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedExchange64_HLERelease (\__int64 geçici \*, \__int64)|
|[_InterlockedExchange8](interlockedexchange-intrinsic-functions.md)||intrin.h|_InterlockedExchange8 char (char geçici \*, char)|
|[_InterlockedExchangeAdd](interlockedexchangeadd-intrinsic-functions.md)||intrin.h|uzun _ınterlockedexchangeadd (uzun geçici \*, uzun)|
|[_InterlockedExchangeAdd_HLEAcquire](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _ınterlockedexchangeadd_hleacquire (uzun geçici \*, uzun)|
|[_Interlockedexchangeadd_hlerelease](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _ınterlockedexchangeadd_hlerelease (uzun geçici \*, uzun)|
|[_InterlockedExchangeAdd16](interlockedexchangeadd-intrinsic-functions.md)||intrin.h|kısa _ınterlockedexchangeadd16 (kısa geçici \*, kısa)|
|[_InterlockedExchangeAdd64](interlockedexchangeadd-intrinsic-functions.md)||intrin.h|__int64 _ınterlockedexchangeadd64 (\__int64 geçici \*, \__int64)|
|[_Interlockedexchangeadd64_hleacquire](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _ınterlockedexchangeadd64_hleacquire (\__int64 geçici \*, \__int64)|
|[_Interlockedexchangeadd64_hlerelease](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _ınterlockedexchangeadd64_hlerelease (\__int64 geçici \*, \__int64)|
|[_InterlockedExchangeAdd8](interlockedexchangeadd-intrinsic-functions.md)||intrin.h|_ınterlockedexchangeadd8 char (char geçici \*, char)|
|[_InterlockedExchangePointer](interlockedexchangepointer-intrinsic-functions.md)||intrin.h|void \* _ınterlockedexchangepointer (void \*geçici \*, void \*)|
|[_InterlockedExchangePointer_HLEAcquire](interlockedexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void \* _InterlockedExchangePointer_HLEAcquire (void \*geçici \*, void \*)|
|[_InterlockedExchangePointer_HLERelease](interlockedexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void * _InterlockedExchangePointer_HLERelease (void \*geçici \*, void \*)|
|[_Interlockedıncrement](interlockedincrement-intrinsic-functions.md)||intrin.h|uzun _ınterlockedıncrement (uzun geçici \*)|
...
|[_InterlockedOr](interlockedor-intrinsic-functions.md)||intrin.h|uzun _ınterlockedor (uzun geçici \*, uzun)|
|[_InterlockedOr_HLEAcquire](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedOr_HLEAcquire (uzun geçici \*, uzun)|
|[_InterlockedOr_HLERelease](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedOr_HLERelease (uzun geçici \*, uzun)|
...
|[_InterlockedOr64_HLEAcquire](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedOr64_HLEAcquire (\__int64 geçici \*, \__int64)|
|[_InterlockedOr64_HLERelease](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedOr64_HLERelease (\__int64 geçici \*, \__int64)|
|[_InterlockedOr64_np](interlockedor-intrinsic-functions.md)||intrin.h|__int64 _InterlockedOr64_np (\__int64 \*, \__int64)|
|[_InterlockedOr8](interlockedor-intrinsic-functions.md)||intrin.h|_InterlockedOr8 char (char geçici \*, char)|
|[_InterlockedOr8_np](interlockedor-intrinsic-functions.md)||intrin.h|_InterlockedOr8_np char (char \*, char)|
|[_Interlockedxor](interlockedxor-intrinsic-functions.md)||intrin.h|uzun _ınterlockedxor (uzun geçici \*, uzun)|
|[_InterlockedXor_HLEAcquire](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedXor_HLEAcquire (uzun geçici \*, uzun)|
|[_InterlockedXor_HLERelease](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|uzun _InterlockedXor_HLERelease (uzun geçici \*, uzun)|
...
|[_InterlockedXor64_HLEAcquire](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedXor64_HLEAcquire (\__int64 geçici \*, \__int64)|
|[_InterlockedXor64_HLERelease](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedXor64_HLERelease (\__int64 geçici \*, \__int64)|
|[_InterlockedXor64_np](interlockedxor-intrinsic-functions.md)||intrin.h|__int64 _InterlockedXor64_np (\__int64 \*, \__int64)|
|[_InterlockedXor8](interlockedxor-intrinsic-functions.md)||intrin.h|_InterlockedXor8 char (char geçici \*, char)|
...
|[__inword](inword.md)||intrin.h|işaretsiz kısa __inword(unsigned short)|
|[__inwordstring](inwordstring.md)||intrin.h|void __inwordstring (işaretsiz kısa, işaretsiz \*, işaretsiz uzun)|
|_lgdt||intrin.h|void _lgdt(void\*)|
|[__lidt](lidt.md)||intrin.h|void __lidt (void\*)|
|[__ll_lshift](ll-lshift.md)||intrin.h|imzalanmamış __int64 pascal/cdecl \__ll_lshift (işaretsiz \__int64, int)|
...
|[__lzcnt](lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|işaretsiz int __lzcnt(unsigned int)|
...
|[__lzcnt16](lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|işaretsiz kısa __lzcnt16(unsigned short)|
|[__lzcnt64](lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|imzalanmamış __int64 \__lzcnt64 (işaretsiz \__int64)|
...
|[_mm_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_i32gather_ps (const float \*, \__m128i, const int)|
...
|[_mm_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_i64gather_ps (const float \*, \__m128i, const int)|
...
|[_mm256_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_i32gather_pd (çift const \*, \__m128i, const int)|
|[_mm256_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_ps)|AVX2 [2]|immintrin.h|__m256 _mm256_i32gather_ps (const float \*, \__m256i, const int)|
...
|[_mm256_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_i64gather_pd (çift const \*, \__m256i, const int)|
|[_mm256_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm256_i64gather_ps (const float \*, \__m256i, const int)|
...
|[_mm256_set_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_set_pd)|AVX [2]|immintrin.h|__m256d _mm256_set_pd (double, double, double, çift)|
...
|[__movsb](movsb.md)||intrin.h|VOID __movsb (işaretsiz karakter \*imzalanmamış const char \*, size_t)|
|[__movsd](movsd.md)||intrin.h|VOID __movsd (işaretsiz uzun \*, işaretsiz uzun const \*, size_t)|
|[__movsq](movsq.md)||intrin.h|VOID __movsq (işaretsiz \__int64 \*imzalanmamış \__int64 const \*, size_t)|
|[__movsw](movsw.md)||intrin.h|VOID __movsw (işaretsiz \*, işaretsiz kısa const \*, size_t)|
...
|[__outbytestring](outbytestring.md)||intrin.h|void __outbytestring (unsigned char kısa, işaretsiz \*, işaretsiz uzun)|
|[__outdword](outdword.md)||intrin.h|void __outdword (işaretsiz kısa, işaretsiz uzun)|
|[__outdwordstring](outdwordstring.md)||intrin.h|void __outdwordstring (işaretsiz uzun kısa, işaretsiz \*, işaretsiz uzun)|
|[__outword](outword.md)||intrin.h|void __outword (işaretsiz kısa, işaretsiz kısa)|
|[__outwordstring](outwordstring.md)||intrin.h|void __outwordstring (işaretsiz kısa, işaretsiz \*, işaretsiz uzun)|
...
|[__popcnt](popcnt16-popcnt-popcnt64.md)|POPCNT|intrin.h|işaretsiz int __popcnt(unsigned int)|
|[__popcnt16](popcnt16-popcnt-popcnt64.md)|POPCNT|intrin.h|işaretsiz kısa __popcnt16(unsigned short)|
...
|[__rdtsc](rdtsc.md)||intrin.h|imzalanmamış __int64 \__rdtsc(void)|
|[__rdtscp](rdtscp.md)|RDTSCP|intrin.h|imzalanmamış __int64 \__rdtscp (işaretsiz int\*)|
|[_ReadBarrier](readbarrier.md)||intrin.h|void _ReadBarrier(void)|
|[__readcr0](readcr0.md)||intrin.h|imzalanmamış __int64 \__readcr0(void)|
|[__readcr2](readcr2.md)||intrin.h|imzalanmamış __int64 \__readcr2(void)|
|[__readcr3](readcr3.md)||intrin.h|imzalanmamış __int64 \__readcr3(void)|
|[__readcr4](readcr4.md)||intrin.h|imzalanmamış __int64 \__readcr4(void)|
|[__readcr8](readcr8.md)||intrin.h|imzalanmamış __int64 \__readcr8(void)|
|[__readdr](readdr.md)||intrin.h|imzalanmamış __int64 \__readdr(unsigned)|
|[__readeflags](readeflags.md)||intrin.h|imzalanmamış __int64 \__readeflags(void)|
...
|[__readgsbyte](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|İmzasız char __readgsbyte(unsigned long)|
|[__readgsdword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|işaretsiz uzun __readgsdword(unsigned long)|
|[__readgsqword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|imzalanmamış __int64 \__readgsqword (işaretsiz uzun)|
|[__readgsword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|işaretsiz kısa __readgsword(unsigned long)|
|[__readmsr](readmsr.md)||intrin.h|imzalanmamış __int64 \__readmsr (işaretsiz uzun)|
|[__readpmc](readpmc.md)||intrin.h|imzalanmamış __int64 \__readpmc (işaretsiz uzun)|
...
|[_rotl16](rotl8-rotl16.md)||intrin.h|işaretsiz kısa _rotl16 (unsigned char kısa, imzasız)|
|[_rotl8](rotl8-rotl16.md)||intrin.h|İmzasız char _rotl8 (unsigned char, işaretsiz karakter)|
|[_rotr16](rotr8-rotr16.md)||intrin.h|işaretsiz kısa _rotr16 (unsigned char kısa, imzasız)|
|[_rotr8](rotr8-rotr16.md)||intrin.h|İmzasız char _rotr8 (unsigned char, işaretsiz karakter)|
...
|[__segmentlimit](segmentlimit.md)||intrin.h|işaretsiz uzun __segmentlimit(unsigned long)|
|_sgdt||intrin.h|void _sgdt(void\*)|
|[__shiftleft128](shiftleft128.md)||intrin.h|imzalanmamış __int64 \__shiftleft128 (işaretsiz \__int64, işaretsiz \__int64, işaretsiz karakter)|
|[__shiftright128](shiftright128.md)||intrin.h|imzalanmamış __int64 \__shiftright128 (işaretsiz \__int64, işaretsiz \__int64, işaretsiz karakter)|
...
|[__stosb](stosb.md)||intrin.h|void __stosb (işaretsiz karakter \*, imzasız char, size_t)|
|[__stosd](stosd.md)||intrin.h|void __stosd (işaretsiz uzun \*, size_t işaretsiz uzun,)|
|[__stosq](stosq.md)||intrin.h|void __stosq (işaretsiz \__int64 \*imzalanmamış \__int64, size_t)|
|[__stosw](stosw.md)||intrin.h|void __stosw (işaretsiz \*, kısa, size_t imzasız)|
|_subborrow_u16||intrin.h|İmzasız char _subborrow_u16 (işaretsiz karakter, işaretsiz, işaretsiz, işaretsiz \*)|
|[_subborrow_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u32)||intrin.h|İmzasız char _subborrow_u32 (imzasız char, işaretsiz int, işaretsiz int, işaretsiz int \*)|
|[_subborrow_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u64)||intrin.h|İmzasız char _subborrow_u64 (işaretsiz karakter, imzasız \__int64, işaretsiz \__int64, işaretsiz \__int64 \*)|
|_subborrow_u8||intrin.h|İmzasız char _subborrow_u8 (imzasız char unsigned char, imzasız char, imzasız char \*)|
...
|[_udiv128](udiv128.md)||intrin.h|imzalanmamış __int64 _udiv128 (işaretsiz \__int64, işaretsiz \__int64, işaretsiz \__int64, işaretsiz \__int64 \*)|
|[_udiv64](udiv64.md)||intrin.h|işaretsiz int \_udiv64 (işaretsiz \__int64, işaretsiz int, işaretsiz int *)|
|[__ull_rshift](ull-rshift.md)||intrin.h|imzalanmamış __int64 pascal/cdecl \__ull_rshift (işaretsiz \__int64, int)|
|[_umul128](umul128.md)||intrin.h|imzalanmamış __int64 _umul128 (işaretsiz \__int64, işaretsiz \__int64, işaretsiz \__int64 \*)|
|[__umulh](umulh.md)||intrin.h|imzalanmamış __int64 \__umulh (işaretsiz \__int64, işaretsiz \__int64)|
|[__vmx_off](vmx-off.md)||intrin.h|void __vmx_off(void)|
|[__vmx_on](vmx-on.md)||intrin.h|İmzasız char __vmx_on (işaretsiz \__int64\*)|
|[__vmx_vmclear](vmx-vmclear.md)||intrin.h|İmzasız char __vmx_vmclear (işaretsiz \__int64\*)|
|[__vmx_vmlaunch](vmx-vmlaunch.md)||intrin.h|unsigned char __vmx_vmlaunch(void)|
|[__vmx_vmptrld](vmx-vmptrld.md)||intrin.h|İmzasız char __vmx_vmptrld (işaretsiz \__int64\*)|
|[__vmx_vmptrst](vmx-vmptrst.md)||intrin.h|void __vmx_vmptrst (işaretsiz \__int64 \*)|
|[__vmx_vmread](vmx-vmread.md)||intrin.h|İmzasız char __vmx_vmread (size_t, size_t\*)|
|[__vmx_vmresume](vmx-vmresume.md)||intrin.h|İmzasız char __vmx_vmresume(void)|
|[__vmx_vmwrite](vmx-vmwrite.md)||intrin.h|İmzasız char __vmx_vmwrite (size_t, size_t)|
|[__wbinvd](wbinvd.md)||intrin.h|void __wbinvd(void)|
|[_WriteBarrier](writebarrier.md)||intrin.h|void _WriteBarrier(void)|
|[__writecr0](writecr0.md)||intrin.h|void __writecr0 (işaretsiz \__int64)|
|[__writecr3](writecr3.md)||intrin.h|void __writecr3 (işaretsiz \__int64)|
|[__writecr4](writecr4.md)||intrin.h|void __writecr4 (işaretsiz \__int64)|
|[__writecr8](writecr8.md)||intrin.h|void __writecr8 (işaretsiz \__int64)|
|[__writedr](writedr.md)||intrin.h|void __writedr (işaretsiz, işaretsiz \__int64)|
|[__writeeflags](writeeflags.md)||intrin.h|void __writeeflags (işaretsiz \__int64)|
...
|[__writegsbyte](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsbyte (işaretsiz uzun, işaretsiz karakter)|
|[__writegsdword](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsdword (işaretsiz uzun, işaretsiz uzun)|
|[__writegsqword](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsqword (işaretsiz uzun, işaretsiz \__int64)|
|[__writegsword](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsword (işaretsiz uzun, işaretsiz kısa)|
|[__writemsr](writemsr.md)||intrin.h|void __writemsr (işaretsiz uzun, işaretsiz \__int64)|
...
[Derleyici iç bilgileri](compiler-intrinsics.md)<br/>
[ARM iç bilgileri](arm-intrinsics.md)<br/>
