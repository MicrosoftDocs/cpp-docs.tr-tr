...
ms.locfileid: "59982401"
---
# <a name="x86-intrinsics-list"></a>x86 iç bilgi listesi

Bu belge, yapı içlerini listeler, Microsoft C /C++ derleyici x86 hedeflendiğinde destekler.
...
|[__addfsbyte](addfsbyte-addfsword-addfsdword.md)||intrin.h|void __addfsbyte (işaretsiz uzun, işaretsiz karakter)|
|[__addfsdword](addfsbyte-addfsword-addfsdword.md)||intrin.h|void __addfsdword (işaretsiz uzun, işaretsiz uzun)|
|[__addfsword](addfsbyte-addfsword-addfsdword.md)||intrin.h|void __addfsword (işaretsiz uzun, işaretsiz kısa)|
...
|[__readcr2](readcr2.md)||intrin.h|işaretsiz uzun __readcr2(void)|
|[__readcr3](readcr3.md)||intrin.h|işaretsiz uzun __readcr3(void)|
|[__readcr4](readcr4.md)||intrin.h|işaretsiz uzun __readcr4(void)|
|[__readcr8](readcr8.md)||intrin.h|işaretsiz uzun __readcr8(void)|
|[__readdr](readdr.md)||intrin.h|İmzasız __readdr(unsigned)|
|[__readeflags](readeflags.md)||intrin.h|İmzasız __readeflags(void)|
|[__readfsbyte](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|İmzasız char __readfsbyte(unsigned long)|
|[__readfsdword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|işaretsiz uzun __readfsdword(unsigned long)|
|[__readfsword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|işaretsiz kısa __readfsword(unsigned long)|
...
|[__writedr](writedr.md)||intrin.h|void __writedr (işaretsiz, imzasız)|
|[__writeeflags](writeeflags.md)||intrin.h|void __writeeflags(unsigned)|
|[__writefsbyte](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void __writefsbyte (işaretsiz uzun, işaretsiz karakter)|
|[__writefsdword](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void __writefsdword (işaretsiz uzun, işaretsiz uzun)|
|[__writefsword](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void __writefsword (işaretsiz uzun, işaretsiz kısa)|
...
[x64 (amd64) yapısalları](x64-amd64-intrinsics-list.md)
