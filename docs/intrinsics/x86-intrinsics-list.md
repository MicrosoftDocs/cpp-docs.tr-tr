...
| [`_andn_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_andn_u32) | BMı \[ 1] | ammintrin. h | `unsigned int _andn_u32(unsigned int, unsigned int);` |
...
| `_m_to_float` | Şimdi 3D | Intrin. h | `float _m_to_float(__m64);` |
