...
|&nbsp;&nbsp;[P0962R2 aralığını yeniden edinme-for döngüsü özelleştirme noktası kuralları bulma](http://open-std.org/JTC1/SC22/WG21/docs/papers/2018/p0962r1.html)|Hayır|
...
|&nbsp;&nbsp;[P0409R2, Lambda yakalama \[=, bu\]](http://open-std.org/JTC1/SC22/WG21/docs/papers/2017/p0409r2.html)|VS 2019 16,1 <sup> [20](#note_20)</sup>|
...
|&nbsp;&nbsp;[P0306R4 ekleme \_\_VA_OPT\_, virgül atlama ve virgül silme için \_](https://wg21.link/P0306R4)|Hayır|
...
|&nbsp;&nbsp;[P0780R2, lambda init-Capture içinde paket genişletmesine Izin verir](https://wg21.link/P0780R2)|Hayır|
|&nbsp;&nbsp;[P0806R2 \[=aracılığıyla örtülü yakalamayı kullanımdan kaldırır \]](https://wg21.link/P0806R2)|Hayır|
...
|[yapılandırılmış bağlamaları P1091R3 değişken bildirimleri gibi bir şekilde genişletmek](https://wg21.link/P1091R3) &nbsp;&nbsp;|Hayır|
|&nbsp;&nbsp;[P1094R2 Iç Içe geçmiş satır adları](https://wg21.link/P1094R2)|Hayır|
|&nbsp;&nbsp;[P1103R3 modülleri](https://wg21.link/P1103R3)|Hayır|
|[< = > ve diğer karşılaştırma işleçleri için &nbsp;P1120R0 &nbsp;tutarlılık iyileştirmeleri](https://wg21.link/P1120R0)|Hayır|
...
|&nbsp;&nbsp;[P1327R1, sabit ifadelerde dynamic_cast, polimorfik TypeId](https://wg21.link/P1327R1)|Hayır|
...
|&nbsp;&nbsp;[P0600R1 \[\[noDiscard\]STL, Bölüm 1 için \]](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0600r1.pdf)|Hayır|
...
|&nbsp;&nbsp;[P0754R2 \<sürümü >](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2018/p0754r2.pdf)|Hayır|
|&nbsp;&nbsp;[P0758R1 is_nothrow_convertible](https://wg21.link/P0758R1)|Hayır|
|&nbsp;&nbsp;[P0767R1 is_pod](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0767r1.html)|Hayır|
...
|[std:: Işlevin taşıma Oluşturucusu için &nbsp;&nbsp;P0771R1 noexcept](https://wg21.link/P0771R1)|Hayır|
...
|[sıralanmamış kapsayıcılar için &nbsp;P0919R3 &nbsp;heterojen arama](https://wg21.link/P0919R3)|Hayır|
...
|&nbsp;&nbsp;[P1165R1, durum bilgisi olan ayırıcıları basic_string's işleci + () Içinde sürekli olarak yayma](https://wg21.link/P1165R1)|Hayır|
...
|[unique_ptr\<t [] &nbsp;N4089 &nbsp;güvenli dönüşümler >](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2014/n4089.pdf)|VS 2015 <sup> [14](#note_14)</sup>|
...
|&nbsp;&nbsp;[N4366 Unique_ptr atamasını kesin olarak kısıtlayan](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2015/n4366.html)|VS 2015 <sup> [14](#note_14)</sup>|
...
|[vektör/liste/forward_list Içinde eksik türleri desteklemek &nbsp;N4510](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2015/n4510.html) &nbsp;|VS 2013 <sup> [14](#note_14)</sup>|
...
|&nbsp;&nbsp;[P0254R2 tümleştirmesi String_view ve std:: String](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0254r2.pdf)|VS 2017 15,0|
...
|&nbsp;&nbsp;[P0414R2 shared_ptr\<t [] >, shared_ptr\<t [N] >](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0414r2.html)<br/>&nbsp;&nbsp;[P0497R0 düzeltme, diziler için shared_ptr](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0497r0.html)|VS 2017 15,5 <sup> [14](#note_14)</sup>|
...
|&nbsp;&nbsp;[P0516R0 işaretlemek noexcept olarak kopyalanmaya shared_future](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0516r0.html)|VS 2017 15,3 <sup> [14](#note_14)</sup>|
...
|&nbsp;&nbsp;[P0521R0 shared_ptr:: Unique () kullanımdan kaldırıldı.](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0521r0.html)|VS 2017 15,5 <sup> [17](#note_17)</sup>|
...
<a name="note_C"></a>__C__ derleyicinin C99 Önişlemci kuralları için destek, Visual Studio 2017 içinde eksik. Ön işlemci overhauling ve Visual Studio 2017 sürüm 15,8 ' de [/deneysel: Önişlemci](../build/reference/experimental-preprocessor.md) derleyici anahtarıyla bu değişiklikleri gönderim başladı.
...
<a name="note_E"></a>Bu, bir önceki `std::experimental` sürümüyle uyumsuz olan, oluşturmaksızın desteği, hata düzeltmeleri ve standart-gerekli davranıştaki değişiklikler tarafından ortaya __Ilan__ tamamen yeni bir uygulama. Şu anda \<dosya sistemi > dahil, yeni `std::filesystem` ve önceki `std::experimental::filesystem`sağlar ve \<deneysel/FileSystem > dahil olmak üzere yalnızca eski deneysel uygulamayı sağlar. Deneysel uygulama, kitaplıkların sonraki ABı-kırılımı sürümünde KALDıRıLACAK.
...
<a name="note_C11"></a>__C11__ Evrensel CRT, C99 `strftime()` E/O alternatif Dönüştürme belirticileri, C11 `fopen()` özel mod ve C11 `aligned_alloc()`dışında C++ 17 için gerekli olan C11 standart kitaplığının parçalarını uyguladık. C11 belirtilen Microsoft `free()`uygulamasıyla uyumsuz bir şekilde `aligned_alloc()`, yani `free()`, yüksek oranda hizalanmış ayırmaları işleyebilmelidir. Bu, ikinci olarak uygulanmamalıdır.
