...
description: Visual C++, Visual Studio IDE 'deki Microsoft C++ derleyicisi, kod Düzenleyicisi ve ilgili araçların adıdır. Windows, Linux, Android ve iOS için program geliştirmek üzere Visual C++ kullanın.
ms.date: 07/02/2019
...
> [!NOTE]
> Bu geliştirici belgeleri, Visual Studio 2015 ve üzeri için geçerlidir. Visual Studio 'nun tercih ettiğiniz sürümüne ilişkin belgeleri görmek için, **Sürüm** seçici denetimini kullanın. Bu sayfadaki içindekiler tablosunun üst kısmında bulunur.
>
> Bir programı çalıştırabilmeniz için Visual C++ yeniden dağıtılabilir bir paket arıyorsanız, [Microsoft Indirme merkezi](https://www.microsoft.com/download/) ' ne gidin ve arama kutusuna **Visual C++** girin.

Microsoft Visual C++, genellikle Visual C++ veya MSVC olarak kısaltıldı, Windows üzerinde Visual Studio 'nun bir parçası olarak kullanılabilen C++, C ve derleme dili geliştirme araçları ve kitaplıklarının adıdır. Bu araçlar ve kitaplıklar, Evrensel Windows Platformu (UWP) uygulamaları, yerel Windows Masaüstü ve sunucu uygulamaları, Windows, Linux, Android ve .NET Framework iOS üzerinde çalışan platformlar arası kitaplıklar ve uygulamalar oluşturmanıza olanak sağlar. Basit konsol uygulamalarından herhangi bir şeyi, cihaz sürücülerinden ve işletim sistemi bileşenlerinden mobil cihazlara yönelik platformlar arası oyunlara ve en düşük IoT cihazlarından Azure bulutundaki çok sunuculu yüksek performanslı bilgi işlem cihazlarına yazmak için Visual C++ kullanabilirsiniz.
...
[Visual Studio 'da C++ yenilikleri](what-s-new-for-visual-cpp-in-visual-studio.md)<br/>
Visual Studio 'daki yenilikleri öğrenin.

[Visual Studio 2003 ile 2015 arasındaki C++ yenilikleri](../porting/visual-cpp-what-s-new-2003-through-2015.md)<br/>
2003 ile 2015 arasında Visual Studio 'nun her sürümü için C++ ' daki yenilikleri öğrenin.

[Visual Studio 2017’deki C++ uyumluluk geliştirmeleri](cpp-conformance-improvements.md)<br/>
Visual Studio 'da C++ uyumluluk iyileştirmeleri hakkında bilgi edinin.

[Microsoft C++ dil uygunluğu tablosu](visual-cpp-language-conformance.md)<br/>
...
[Visual Studio 'da C++ geliştirmeye genel bakış](overview-of-cpp-development.md)<br/>
...
[C++ kodu yazma ve yeniden düzenleme](../ide/writing-and-refactoring-code-cpp.md)<br/>
...
[Linux Programlama](../linux/index.yml)<br/>
...
[Etkin Şablon Kütüphanesi (ATL)](../atl/atl-com-desktop-components.md)<br/>
...
[Visual C++ araç takımı ile sorun bildirme](how-to-report-a-problem-with-the-visual-cpp-toolset.md)<br/>
Visual C++ araç takımı (derleyici, bağlayıcı ve diğer araçlarla) ve raporunuzu gönderme yollarındaki etkili hata raporları oluşturmayı öğrenin.
