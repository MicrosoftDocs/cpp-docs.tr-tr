...
Bildirme ve genel yapıları kullanma kuralları Visual C++ dil başvurusunda belirtildiği farklılıklar dışında Genel sınıflar için aynıdır.
