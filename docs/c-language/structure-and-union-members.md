...
2.  İkinci biçiminde *sonek ifadesi* bir yapı veya birleşim, bir işaretçiyi temsil eder ve *tanımlayıcı* belirtilen yapı veya birleşim üyesi adları. Değer budur *tanımlayıcı* ve bir l değeridir.  
