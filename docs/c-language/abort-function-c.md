---
title: Function (C) abort | Microsoft Docs
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
**ANSI 4.10.4.1** davranışını **abort** açık ve geçici dosyalar açısından işlevi  
  
 **Abort** işlevi açık veya geçici dosyaları kapatmaz. Akış arabelleklerini temizlemez.  
