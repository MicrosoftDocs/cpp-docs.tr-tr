...
Aşağıdaki program çarpma işleçlerini gösterir. Her iki işlenenin de bölme öncesinde **float** türünde olması için `10 / 3` işleneninin açıkça **float** türüne dönüştürülmesi gerektiğini unutmayın.
