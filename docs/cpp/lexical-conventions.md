---
title: "Sözcük kuralları | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
-   [Kullanıcı tanımlı değişmez değerler](../cpp/user-defined-literals-cpp.md)  
 ...
 Bu bölümde ayrıca sahip bir [dosya çevirisine genel bakış](../cpp/cpp-built-in-operators-precedence-and-associativity.md) konu.  
