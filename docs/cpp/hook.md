...
*Alıcı* (isteğe bağlı)<br/>
Olay alıcısı sınıfına örneğine bir işaretçi. Bir alıcı belirtmezseniz, alıcı sınıfın veya yapının, varsayılan değer **__hook** çağrılır.
