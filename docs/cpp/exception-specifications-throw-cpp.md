...
Aşağıdaki tabloda, özel durum belirtimleri Visual C++ uygulaması özetlenmektedir:
...
|`throw(type)`| (**c ++ 14 ve daha önceki**) işlevi türünde bir özel durum atabilirsiniz `type`. Microsoft C++ derleyicisi söz dizimini kabul eder, ancak bunu olarak yorumlar `noexcept(false)`. İçinde **/Std: c ++ 17** modu derleyici C5040 uyarı verir.|
