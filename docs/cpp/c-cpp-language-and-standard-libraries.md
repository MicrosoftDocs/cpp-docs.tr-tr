...
|[IDE ve geliştirme araçları](../ide/ide-and-tools-for-visual-cpp-development.md)|Oluşturmak için Visual Studio ve ilgili araçlarını kullanma hakkında bilgi içeren diğer makalelere bağlantılar oluşturun ve C++ uygulamaları dağıtın.|
