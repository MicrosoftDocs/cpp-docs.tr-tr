...
```  
 ...
 Bu tür şimdi bir 32 baytlık hizalama özniteliği vardır. Bu, tüm statik ve otomatik örnekleri 32 baytlık sınırında Başlat anlamına gelir. Bu tür bir üye olarak bildirilen ek yapı türleri bu türü hizalama özniteliğini korumak, diğer bir deyişle, tüm yapısı `Str1` öğenin hizalama özniteliğin en az 32 gerekecektir.  
