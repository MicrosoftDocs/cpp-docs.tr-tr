...
- [Açık tür dönüşümlü ifadeler](explicit-type-conversion-operator-parens.md). Açık tür dönüştürmeleri ya da "atamaları," ifadelerde kullanılabilir.

- [İşaretçi-üye işleçli ifadeler](../cpp/pointer-to-member-operators-dot-star-and-star.md).

- [Atama](../cpp/casting.md). Tür kullanımı uyumlu "atamaları" ifadelerde kullanılabilir.

- [Çalışma zamanı türü bilgileri](../cpp/run-time-type-information.md). Program yürütülmesi sırasında bir nesne türünü belirler.
