...
Kopya Oluşturucu, sınıf <em>-</em>adı türünde bir bağımsız değişken alır <strong>&</strong> ; burada *sınıf adı* , oluşturucunun tanımlandığı sınıfın adıdır. Örnek:
