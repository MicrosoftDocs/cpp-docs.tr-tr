...
:::row:::
    :::column:::
        ...
        [`asm`](../assembler/inline/asm.md)<sup>bir</sup><br/>
    ...
    :::column:::
        ...
        [`using`](using-declaration.md)bağımsız<br/>
        [`using`](namespaces-cpp.md#using_directives)deki<br/>
...
:::row:::
    ...
    :::column:::
        ...
        [`__ptr64`](ptr32-ptr64.md)<sup>a</sup><br/>
        [`__raise`](raise.md)<br/>
        [`__restrict`](extension-restrict.md)<sup>e</sup><br/>
        [`__single_inheritance`](inheritance-keywords.md)<sup>a</sup><br/>
        [`__sptr`](sptr-uptr.md)<sup>a</sup><br/>
