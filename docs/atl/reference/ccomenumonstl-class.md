...
[ATLCollections örneği: Icollectiononstlımpl ve CComEnumOnSTL özel kopyalama İlkesi sınıfları gösterir](../../overview/visual-cpp-samples.md)<br/>
