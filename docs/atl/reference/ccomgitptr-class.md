---
title: Ccomgıtptr sınıfı | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
## <a name="see-also"></a>Ayrıca Bkz.  
 ...
 [Apartmanlar arasında arabirimi erişme](http://msdn.microsoft.com/library/windows/desktop/ms682353)   
