...
Tanıtıcı, yeni oluşturulan iş parçacığına veya NULL'e hatası döndürür. Çağrı [GetLastError](/windows/desktop/api/errhandlingapi/nf-errhandlingapi-getlasterror) genişletilmiş hata bilgilerini almak için.
