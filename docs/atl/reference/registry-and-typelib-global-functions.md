---
title: Kayıt defteri ve TypeLib genel işlevleri | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
### <a name="parameters"></a>Parametreler  
 [out] *pEnabled*  
 TRUE, kayıt defteri bilgilerini Yönlendirilme biçimini gösterir **HKCU** düğüm; FALSE, uygulama varsayılan düğüme kayıt defteri bilgilerini yazar gösterir. Varsayılan düğüm **HKEY_CLASSES_ROOT** (**HKCR**).  
...
## <a name="see-also"></a>Ayrıca Bkz.  
 [İşlevleri](atl-functions.md) [kayıt defteri veri değişimi makroları](registry-data-exchange-macros.md)
