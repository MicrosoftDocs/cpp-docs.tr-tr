...
|[CAtlFile](../../atl/reference/catlfile-class.md)|Bu sınıf, Windows dosya işleme API 'SI etrafında ince bir sarmalayıcı sağlar.|atlfile. h|
...
|[CComAutoCriticalSection](../../atl/reference/ccomautocriticalsection-class.md)|Bu sınıf, kritik bir bölüm nesnesinin sahipliğini almak ve serbest bırakmak için yöntemler sağlar.|atlcore. h|
|[CComAutoThreadModule](../../atl/reference/ccomautothreadmodule-class.md)|ATL 7,0 `CComAutoThreadModule` itibariyle artık kullanılmıyor: daha fazla ayrıntı için bkz. [ATL modülleri](../../atl/atl-module-classes.md) .|atlbase. h|
...
|[CComContainedObject](../../atl/reference/ccomcontainedobject-class.md)|Bu sınıf, [](/windows/win32/api/unknwn/nn-unknwn-iunknown) sahip nesnesine `IUnknown`temsilci seçerek IUnknown uygular.|atlcom. h|
...
|[CComCriticalSection](../../atl/reference/ccomcriticalsection-class.md)|Bu sınıf, kritik bir bölüm nesnesinin sahipliğini almak ve serbest bırakmak için yöntemler sağlar.|atlcore. h|
...
|[CComDynamicUnkArray](../../atl/reference/ccomdynamicunkarray-class.md)|Bu sınıf bir `IUnknown` işaretçiler dizisi depolar.|atlcom. h|
...
|[CComEnumOnSTL](../../atl/reference/ccomenumonstl-class.md)|Bu sınıf, bir C++ standart kitaplık koleksiyonunu temel alan bir com Numaralandırıcı nesnesi tanımlar.|atlcom. h|
...
|[CComModule](../../atl/reference/ccommodule-class.md)|ATL 7,0 `CComModule` itibariyle artık kullanılmıyor: daha fazla ayrıntı için bkz. [ATL modülleri](../../atl/atl-module-classes.md) .|atlbase. h|
...
|[CComObjectGlobal](../../atl/reference/ccomobjectglobal-class.md)|Bu sınıf, `Base` nesnenizin bulunduğu modüldeki başvuru sayısını yönetir.|atlcom. h|
...
|[CComObjectStack](../../atl/reference/ccomobjectstack-class.md)|Bu sınıf, `IUnknown`geçici bir com nesnesi oluşturur ve bunu bir iskelet uygulamasıyla sağlar.|atlcom. h|
...
|[CComSafeArray](../../atl/reference/ccomsafearray-class.md)|Bu sınıf, `SAFEARRAY Data Type` yapı için bir sarmalayıcıdır.|atlsafe. h|
|[CComSafeArrayBound](../../atl/reference/ccomsafearraybound-class.md)|Bu sınıf, bir `SAFEARRAYBOUND` yapının sarmalayıcısıdır.|atlsafe. h|
|[CComSimpleThreadAllocator](../../atl/reference/ccomsimplethreadallocator-class.md)|Bu sınıf [CComAutoThreadModule](../../atl/reference/ccomautothreadmodule-class.md)sınıfı için iş parçacığı seçimini yönetir.|atlbase. h|
...
|[CComUnkArray](../../atl/reference/ccomunkarray-class.md)|Bu sınıf işaretçileri `IUnknown` depolar ve [IConnectionPointImpl](../../atl/reference/iconnectionpointimpl-class.md) şablon sınıfına bir parametre olarak kullanılmak üzere tasarlanmıştır.|atlcom. h|
...
|[CHeapPtrElementTraits Sınıfı](../../atl/reference/cheapptrelementtraits-class.md)|Bu sınıf, yığın işaretçileri koleksiyonları oluştururken yararlı yöntemler, statik işlevler ve tür tanımları sağlar.|atlcoll. h|
...
|[CNoWorkerThread Sınıfı](../../atl/reference/cnoworkerthread-class.md)|Dinamik önbellek bakımını devre dışı bırakmak istiyorsanız bu `MonitorClass` sınıfı şablon parametresi önbellek sınıfları için bağımsız değişken olarak kullanın.|atlutil. h|
...
|[CRBMap](../../atl/reference/crbmap-class.md)|Bu sınıf, bir eşleme yapısını, kırmızı siyah bir ikili ağacı kullanarak temsil eder.|atlcoll. h|
|[CRBMultiMap](../../atl/reference/crbmultimap-class.md)|Bu sınıf, her anahtarın bir kırmızı siyah ikili ağaç kullanılarak birden çok değerle ilişkilendirilmesine izin veren bir eşleme yapısını temsil eder.|atlcoll. h|
|[CRBTree](../../atl/reference/crbtree-class.md)|Bu sınıf, kırmızı siyah ağaç oluşturmak ve kullanmak için yöntemler sağlar.|atlcoll. h|
...
|[CSecurityAttributes](../../atl/reference/csecurityattributes-class.md)|Bu sınıf, `SECURITY_ATTRIBUTES` yapı için ince bir sarmalayıcıdır.|atlsecurity. h|
|[CSecurityDesc](../../atl/reference/csecuritydesc-class.md)|Bu sınıf, `SECURITY_DESCRIPTOR` yapı için bir sarmalayıcıdır.|atlsecurity. h|
...
|[Cstrıngelementnitelikler](../../atl/reference/cstringelementtraits-class.md)|Bu sınıf, nesneleri depolayan `CString` koleksiyon sınıfları tarafından kullanılan statik işlevler sağlar.|CStringT. h|
...
|[CTokenGroups](../../atl/reference/ctokengroups-class.md)|Bu sınıf, `TOKEN_GROUPS` yapı için bir sarmalayıcıdır.|atlsecurity. h|
|[CTokenPrivileges](../../atl/reference/ctokenprivileges-class.md)|Bu sınıf, `TOKEN_PRIVILEGES` yapı için bir sarmalayıcıdır.|atlsecurity. h|
|[CUrl Sınıfı](../../atl/reference/curl-class.md)|Bu sınıf bir URL 'YI temsil eder. Var olan bir URL dizesi ayrıştırıp veya sıfırdan dize oluşturarak, URL 'nin her bir öğesini diğerlerinden bağımsız olarak değiştirmenize olanak sağlar.|atlutil. h|
...
|[IAtlAutoThreadModule](../../atl/reference/iatlautothreadmodule-class.md)|Bu sınıf, bir `CreateInstance` yöntemi arabirimini temsil eder.|atlbase. h|
|[IAtlMemMgr](../../atl/reference/iatlmemmgr-class.md)|Bu sınıf, bir bellek yöneticisinin arabirimini temsil eder.|atlmem. h|
...
|[IDispEventImpl](../../atl/reference/idispeventimpl-class.md)|Bu sınıf `IDispatch` yöntemlerin uygulamalarını sağlar.|atlcom. h|
|[IDispEventSimpleImpl](../../atl/reference/idispeventsimpleimpl-class.md)|Bu sınıf, bir tür kitaplığından `IDispatch` tür bilgilerini almadan yöntemlerin uygulamalarını sağlar.|atlcom. h|
...
|[IEnumOnSTLImpl](../../atl/reference/ienumonstlimpl-class.md)|Bu sınıf, C++ standart kitaplık koleksiyonu temelinde bir Numaralandırıcı arabirimi tanımlar.|atlcom. h|
...
|[IOleControlImpl](../../atl/reference/iolecontrolimpl-class.md)|Bu sınıf, `IOleControl` arabiriminin varsayılan bir uygulamasını sağlar ve uygular `IUnknown`.|atlctl. h|
...
|[IOleObjectImpl](../../atl/reference/ioleobjectimpl-class.md)|Bu sınıf, `IUnknown` bir kapsayıcının bir denetimle iletişim kurduğu Principal arabirimini uygular ve kullanır.|atlctl. h|
...
|[IPointerInactiveImpl](../../atl/reference/ipointerinactiveimpl-class.md)|Bu sınıf ve `IUnknown` , [ıpoıb etkin olmayan](/windows/win32/api/ocidl/nn-ocidl-ipointerinactive) arabirim yöntemlerini uygular.|atlctl. h|
...
|[IRunnableObjectImpl](../../atl/reference/irunnableobjectimpl-class.md)|Bu sınıf, `IUnknown` [irunnableobject](/windows/win32/api/objidl/nn-objidl-irunnableobject) arabiriminin varsayılan bir uygulamasını uygular ve sunar.|atlctl. h|
|[IServiceProviderImpl](../../atl/reference/iserviceproviderimpl-class.md)|Bu sınıf, `IServiceProvider` arabirimin varsayılan bir uygulamasını sağlar.|atlcom. h|
...
|[ISupportErrorInfoImpl](../../atl/reference/isupporterrorinfoimpl-class.md)|Bu sınıf, `ISupportErrorInfo Interface` arabirimin varsayılan bir uygulamasını sağlar ve yalnızca tek bir arabirim bir nesne üzerinde hata oluşturduğunda kullanılabilir.|atlcom. h|
...
|[IWorkerThreadClient Sınıfı](../../atl/reference/iworkerthreadclient-interface.md)|`IWorkerThreadClient`, [CWorkerThread](../../atl/reference/cworkerthread-class.md) sınıfının istemcileri tarafından uygulanan arabirimdir.|atlutil. h|
|[_U_menuorıd](../../atl/reference/u-menuorid-class.md)|Bu sınıf ve `CreateWindow` `CreateWindowEx`için sarmalayıcılar sağlar.|atlwin. h|
...
|[_U_stringorıd](../../atl/reference/u-stringorid-class.md)|Bu bağımsız değişken bağdaştırıcı sınıfı, kaynak adlarının (LPCTSTRs) veya kaynak kimliklerinin (litre), çağıranın KIMLIĞI MAKEINTRESOURCE makrosunu kullanarak bir dizeye dönüştürmek zorunda kalmadan bir işleve geçirilmesini sağlar.|atlwin. h|
