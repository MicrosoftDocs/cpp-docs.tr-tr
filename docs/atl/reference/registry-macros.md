...
`CAtlModuleT`türetilmiş bir sınıfta DECLARE_LIBID kullanın.
...
`CAtlModuleT`türetilmiş bir sınıfta DECLARE_REGISTRY_APPID_RESOURCEID kullanın.
