---
description: 'Daha fazla bilgi edinin: ATL OLE DB Tüketici Sihirbazı'
...
> [!NOTE]
> Bu sihirbaz,  `Class` ve **. h dosya** alanlarına ad girmeden önce bir veri kaynağı seçmek için veri kaynağı düğmesine tıklamaya gerek duyar.
