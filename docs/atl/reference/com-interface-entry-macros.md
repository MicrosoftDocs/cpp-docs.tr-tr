...
|[COM_INTERFACE_ENTRY_FUNC](#com_interface_entry_func)|ATL 'nin `QueryInterface` mantığını aramak için genel bir mekanizma.|
...
ATL 'nin `QueryInterface` mantığını aramak için genel bir mekanizma.
