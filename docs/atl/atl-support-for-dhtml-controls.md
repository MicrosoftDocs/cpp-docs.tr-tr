...
-   WebBrowser nesne ve onun yöntemleri kendi arabirimi aracılığıyla erişen [Iwebbrowser2](https://msdn.microsoft.com/library/aa752127.aspx).  
  
-   C++ kodu ile HTML arasındaki iletişimi yönetir.  
  
 DHTML denetimi bir ek gönderme arabirimi içerir dışında DHTML denetimi diğer ATL Denetim için benzer. Bkz: Şekil [DHTML denetimi proje öğelerini tanımlama](../atl/identifying-the-elements-of-the-dhtml-control-project.md) varsayılan DHTML projesinde sağlanan arabirimleri bir çizimi için.  
...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Derleme ve işlevsellik eklenmiştir denetimin test gösterilmektedir.  
