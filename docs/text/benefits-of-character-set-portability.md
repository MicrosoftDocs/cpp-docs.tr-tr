...
-   Unicode kullanarak Windows için uygulamalarınızı daha verimli hale getirir. Windows Unicode kullandığından, işletim sisteminden geçirilen Unicode olmayan dizeler, da ek yüke neden çevrilmesi gerekir.  
