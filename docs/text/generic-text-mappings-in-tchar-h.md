---
description: "Daha fazla bilgi edinin: Tchar. h 'de Generic-Text eşlemeleri"
title: Tchar. h 'de eşlemeler Generic-Text
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "97118355"
---
# <a name="generic-text-mappings-in-tcharh"></a>Tchar. h 'de eşlemeler Generic-Text
...
### <a name="preprocessor-directives-for-generic-text-mappings"></a>Generic-Text eşlemeleri için Önişlemci yönergeleri
...
|Generic-Text<br /> Veri türü adı|_UNICODE &<br /> _MBCS tanımsız|_MBCS<br /> Tanımlı|_UNICODE<br /> Tanımlı|
|--------------------------------------|----------------------------------------|------------------------|---------------------------|
...
Yordamların, değişkenlerin ve diğer nesnelerin genel metin eşlemelerinin bir listesi için, bkz. Run-Time kitaplığı başvurusunda [Genel metin eşlemeleri](../c-runtime-library/generic-text-mappings.md) .
