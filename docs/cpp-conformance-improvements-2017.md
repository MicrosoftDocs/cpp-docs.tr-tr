...
**Daha fazla kitaplık ifade SFINAE desteği**  
...
**Terse static_assert** (bulunan **/Std: c ++ 17**)  
C ++ 17 static_assert iletisi parametresi isteğe bağlıdır. Daha fazla bilgi için bkz: [geniletmek static_assert, v2](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2014/n3928.pdf).

**[[fallthrough]] özniteliği** (bulunan **/Std: c ++ 17**)  
[[Fallthrough]] özniteliği switch deyimleri bağlamında başarısızlığı davranışı geçmesini derleyici ipucu olarak kullanılabilir. Bu, derleyici uyarıları bu gibi durumlarda vermesini engeller. Daha fazla bilgi için bkz: [[[fallthrough]] özniteliği için ifadesi](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0188r0.pdf).
...
**varsa işlevi şablonlarındaki constexpr**  
...
**Seçim deyimleri ile başlatıcıları**  
...
**Yineleme olmadan özniteliği ad alanlarını kullanma**  
Bir öznitelik listesinde yalnızca bir tek bir ad tanımlayıcısı etkinleştirmek için yeni söz dizimi'ı seçin. Daha fazla bilgi için bkz: [C++ öznitelikleri](cpp/attributes2.md).

**Yapılandırılmış bağlamaları**  
...
**Enum sınıfı değerleri için yapım kuralları**  
...
**Yeni derleyici geçiş için extern constexpr**  
...
**Dinamik özel durum belirtimleri kaldırma**  
...
**Enable_shared_from_this uygun sözcükler kullanmak**  
...
**Boşluklarına ayıran eşlemeleri ve kümeleri**  
...
**Onaysız kılınmadan Vestigial kitaplığı bölümleri**  
...
**Destek ayırıcısı olarak std::function kaldırma**  
...
`std::tr2::sys` Ad alanında `<experimental/filesystem>` artık kullanımdan kaldırma uyarısı/Std: c altında yayar ++ 14 varsayılan olarak ve şimdi altında kaldırılır **/Std: c ++ 17** varsayılan olarak.
