...
## <a name="remarks"></a>Açıklamalar  
 Bu seçenek, belirtilen hakkında bilgi için çıkış kısıtlar *bölüm*. Kullanım [/HEADERS](../../build/reference/headers.md) dosyasındaki bölümlerinin listesini almak için seçeneği.  
