...
Erişim hakkında daha fazla bilgi için **komut satırı** özellik sayfalarına bakın [Visual Studio'da ayarlayın C++ derleyicisi ve derleme özellikleri](../working-with-project-properties.md).
