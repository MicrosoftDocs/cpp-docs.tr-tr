...
Erişim hakkında daha fazla bilgi için **çıkış** özellik sayfasında **MIDL** klasörüne bakın [Visual Studio'da ayarlayın C++ derleyicisi ve derleme özellikleri](../working-with-project-properties.md).
