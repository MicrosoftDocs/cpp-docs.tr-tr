...
|[/FM](fm-name-mapfile.md)|Eşleme dosyası oluşturur.|
...
|[/GM derlemeyi](gm-enable-minimal-rebuild.md)|Kullanım dışı. Minimum yeniden oluşturmayı etkinleştirir.|
...
|[/ hotpatch](hotpatch-create-hotpatchable-image.md)|Çalışırken düzeltme eki eklenebilen görüntü oluşturur.|
...
|[/ OpenMP](openmp-enable-openmp-2-0-support.md)|Sağlar [ `#pragma omp` ](../../preprocessor/omp.md) kaynak kodundaki yönergesi.|
...
|[/ Qıfist](qifist-suppress-ftol.md)|Kullanım dışı. Bastırır `_ftol` gerekli (yalnızca x86) olduğunda bir kayan nokta türünden bir tamsayı türüne dönüştürme.|
...
|[{1&gt;/Wall&lt;1}](compiler-option-warning-level.md)|Varsayılan olarak devre dışıdır uyarılar dahil olmak üzere tüm uyarıları etkinleştirir.|
