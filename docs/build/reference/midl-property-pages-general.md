...
Erişim hakkında daha fazla bilgi için **genel** özellik sayfasında **MIDL** klasörüne bakın [Visual Studio'da ayarlayın C++ derleyicisi ve derleme özellikleri](../working-with-project-properties.md).
