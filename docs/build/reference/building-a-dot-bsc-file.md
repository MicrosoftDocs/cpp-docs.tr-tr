---
title: Derleme bir. BSC dosya | Microsoft Docs
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
-   [.Sbr dosyası oluşturma](../../build/reference/creating-an-dot-sbr-file.md)  
  
-   [BSCMAKE .bsc dosyasını nasıl derler](../../build/reference/how-bscmake-builds-a-dot-bsc-file.md)  
