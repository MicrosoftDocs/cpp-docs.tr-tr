...
[Derleme görevleri dosyası önişleme yönergeleri](makefile-preprocessing-directives.md)

[Derleme görevleri dosyası önişlemlerindeki ifadeler](expressions-in-makefile-preprocessing.md)
