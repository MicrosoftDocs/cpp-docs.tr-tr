...
ms.locfileid: "34225225"
---
# <a name="register-usage"></a>YAZMAÇ kullanımı

16 XMM/YMM yanı sıra (tamsayı kayıtları olarak bundan böyle olarak adlandırılır) 16 genel amaçlı kayıtları mimarisi sağlayan x64 kayan nokta kullanıma kaydeder. Geçici kayıtları çağrıyla yok edilmesi için çağıran tarafından karalama kayıtlardır. Kalıcı Yazmaçları değerlerine bir işlev aramasıyla korumak için gereklidir ve kullanılırsa Aranan tarafından kaydedilmesi gerekir.

## <a name="register-volatility-and-preservation"></a>Kayıt volatilite ve koruma
...
İşlevi çıkış ve C çalışma zamanı kitaplığı çağrıları ve Windows sistem çağrıları işlevi giriş, CPU yön bayrağı bayrakları kayıt temizlenmiş olması beklenir.
