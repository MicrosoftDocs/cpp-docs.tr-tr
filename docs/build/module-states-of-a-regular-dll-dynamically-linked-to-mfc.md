---
description: "Hakkında daha fazla bilgi edinin: MFC 'ye dinamik olarak bağlı normal MFC DLL 'nin modül durumları"
...
Bu yapılandırma, geçerli nesneye yönelik işaretçi ve tanıtıcı haritaları gibi MFC genel verileriyle ilgili bir sorun doğurur `CWinApp` .
...
Çözüm, her modülün (uygulama veya normal MFC DLL) Bu genel durum bilgilerinin kendi kopyasını vermektir. Bu nedenle, normal MFC DLL içindeki **AfxGetApp** öğesine yapılan bir çağrı, `CWinApp` çalıştırılabilir dosyada değil, dll 'deki nesnesine bir işaretçi döndürür. MFC genel verilerinin modül başına bu kopyası, modül durumu olarak bilinir ve [MFC teknik not58](../mfc/tn058-mfc-module-state-implementation.md)' te açıklanmaktadır.
