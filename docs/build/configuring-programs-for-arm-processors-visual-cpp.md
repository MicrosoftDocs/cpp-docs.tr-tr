---
title: "Visual C++ ARM işlemcileri için yapılandırma | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Bu bölüm belgelerin ARM donanım hedeflemek için Visual C++ derleme araçları kullanma hakkında bilgi içerir.  
