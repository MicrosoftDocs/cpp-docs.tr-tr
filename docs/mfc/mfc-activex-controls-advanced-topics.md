...
7.  İçin **uygulama** türüne tıklayın **Get/Set yöntemleri**.  
  
8.  İçinde **alma işlevi** ve **ayarlamak işlevi** kutuları, Al ve Ayarla işlevleri için benzersiz adlarını yazabilir veya varsayılan adı kabul edin.  
