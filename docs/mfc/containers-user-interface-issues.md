---
title: 'Kapsayıcılar: Kullanıcı arabirimi sorunları'
ms.date: 11/04/2016
helpviewer_keywords:
...
|Boyama bağlantılı veya katıştırılmış öğeleri|[Kapsayıcı örneği](../overview/visual-cpp-samples.md)|
