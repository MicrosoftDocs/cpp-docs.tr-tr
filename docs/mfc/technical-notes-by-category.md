...
|[TN003: İşleyicilerini nesnelere eşleme](../mfc/tn003-mapping-of-windows-handles-to-objects.md)|  
|[TN017: Pencere nesnelerini yok etme](../mfc/tn017-destroying-window-objects.md)|  
|[TN051: Şimdi ve gelecekte CTL3D kullanma](../mfc/tn051-using-ctl3d-now-and-in-the-future.md)|  
...
|[TN046: Kuralları MFC sınıfları için yorum oluşturma kuralları](../mfc/tn046-commenting-conventions-for-the-mfc-classes.md)|  
...
|[TN054: MFC DAO sınıflarını kullanırken doğrudan DAO çağırma](../mfc/tn054-calling-dao-directly-while-using-mfc-dao-classes.md)|  
...
||  
|-|  
|[TN063: Internet MFC uzantı DLL'leri hata ayıklama](../mfc/tn063-debugging-internet-extension-dlls.md)|
