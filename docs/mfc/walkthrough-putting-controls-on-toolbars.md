...
1. AFX_WM_RESETTOOLBAR iletiyi işleyen ileti işleyicisi, aşağıdakileri yapın:
...
1. Düğme ve kendi komutları için uygulama kaynakları ekleyin:
   ...
   1. Id_edıt_fınd komutu kimliği ile yeni bir menü öğesi oluşturma
