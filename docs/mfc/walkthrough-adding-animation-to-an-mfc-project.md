...
3.  Menü çubuğunda, **burada türü** kutusuna `A&nimation` bir animasyon menü oluşturmak için.  
  
4.  Altında **animasyon**, **burada türü** kutusuna `Start &Forward` bir ileri Başlat komutu oluşturmak için.  
  
5.  Altında **İleri Başlat**, **burada türü** kutusuna `Start &Backward`.  
  
6.  Altında **Başlat geriye dönük**, **burada türü** kutusuna `S&top` Durdur komutu oluşturmak için.  
