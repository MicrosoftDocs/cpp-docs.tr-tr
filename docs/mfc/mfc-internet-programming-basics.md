---
description: 'Daha fazla bilgi edinin: MFC Internet Programlama Temelleri'
...
[World Wide Web Konsorsiyumu (W3C)](https://www.w3.org/) , HTML, http, CGI ve diğer World Wide Web teknolojileri için belirtimleri yayımlar.
