...
- Bir iletişim kutusu, kullanıcı arabirimi olan bir uygulama oluşturun: bkz [CMNCTRL1](../visual-cpp-samples.md) veya [CMNCTRL2](../visual-cpp-samples.md) örnek programlar. Uygulama Sihirbazı'nı bu seçeneği de sağlar.
