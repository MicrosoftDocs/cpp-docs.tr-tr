...
2.  Sınıf Görünümü'nde sağ tıklayın, ActiveX denetim sınıfı kısayol menüsünü açın.  
  
3.  Kısayol menüsünden tıklayın **Ekle** ve ardından **olay Ekle**.  
