...
> [!NOTE]
>  Liste Görünümü denetimi LVS_SHAREIMAGELISTS stiliyle oluşturduysanız, artık kullanımda olduğunda, görüntü listeleri yok etme için sorumludur. Birden çok liste görünümü denetimleri aynı görüntü atadığınızda, bu stili listeler belirtin; Aksi takdirde, birden fazla denetim aynı resim listesi yok etmek deneyebilirsiniz.  
