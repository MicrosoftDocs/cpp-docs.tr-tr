...
### [Özel Durumlar: Özel Durumlardaki Nesneleri Boşaltma](exceptions-freeing-objects-in-exceptions.md)
### [Özel Durumlar: Kendi İşlevlerinizden Özel Durumlar Oluşturma](exceptions-throwing-exceptions-from-your-own-functions.md)
### [Özel Durumlar: Oluşturuculardaki Özel Durumlar](exceptions-exceptions-in-constructors.md)
...
##### [Otomasyon İstemcileri: Tür Kitaplıkları Kullanma](automation-clients-using-type-libraries.md)
...
#### [Kapsayıcılar: Kapsayıcı Uygulama](containers-implementing-a-container.md)
...
#### [Sürükleme ve Bırakma: Bırakma Kaynağı Uygulama](drag-and-drop-implementing-a-drop-source.md)
#### [Sürükleme ve Bırakma: Bırakma Hedefi Uygulama](drag-and-drop-implementing-a-drop-target.md)
#### [Sürükleme ve Bırakma: Özelleştirme](drag-and-drop-customizing.md)
...
#### [İzleyiciler: OLE Uygulamanızda İzleyiciler Uygulama](trackers-implementing-trackers-in-your-ole-application.md)
...
### [Serileştirme: Seri Hale Getirilebilir Sınıf Oluşturma](serialization-making-a-serializable-class.md)
### [Serileştirme: Nesneyi Seri Hale Getirme](serialization-serializing-an-object.md)
...
### [Serileştirme: Serileştirme Veritabanı Giriş-Çıkış Karşılaştırması](serialization-serialization-vs-database-input-output.md)
...
##### [MFC ActiveX Denetimleri: ActiveX Denetimi Boyama](mfc-activex-controls-painting-an-activex-control.md)
##### [MFC ActiveX Denetimleri: ](mfc-activex-controls-events.md)Etkinlikler
##### [MFC ActiveX Denetimleri: ActiveX Denetimine Stok Olayları Ekleme](mfc-activex-controls-adding-stock-events-to-an-activex-control.md)
...
##### [MFC ActiveX Denetimleri: Yöntemden Hata Kodları Döndürme](mfc-activex-controls-returning-error-codes-from-a-method.md)
...
##### [MFC ActiveX Denetimleri: Stok Özelliği Sayfaları Kullanma](mfc-activex-controls-using-stock-property-pages.md)
##### [MFC ActiveX Denetimleri: Otomasyon Sunucusu Oluşturma](mfc-activex-controls-creating-an-automation-server.md)
##### [MFC ActiveX Denetimleri: Yazı Tipleri Kullanma](mfc-activex-controls-using-fonts.md)
##### [MFC ActiveX Denetimleri: ActiveX Denetiminde Resimler Kullanma](mfc-activex-controls-using-pictures-in-an-activex-control.md)
...
##### [MFC ActiveX Denetimleri: ActiveX Denetimi Lisanslama](mfc-activex-controls-licensing-an-activex-control.md)
##### [MFC ActiveX Denetimleri: ActiveX Denetimi Yerelleştirme](mfc-activex-controls-localizing-an-activex-control.md)
##### [MFC ActiveX Denetimleri: Seri Hale Getirme](mfc-activex-controls-serializing.md)
##### [MFC ActiveX Denetimleri: Windows Denetimlerinin Alt Sınıfını Oluşturma](mfc-activex-controls-subclassing-a-windows-control.md)
###### [Yansımış Pencere İletisi Kimlikleri](reflected-window-message-ids.md)
##### [MFC ActiveX Denetimleri: ActiveX Denetiminde Veri Bağlama Kullanma](mfc-activex-controls-using-data-binding-in-an-activex-control.md)
...
##### [ActiveX Denetimi Kapsayıcıları: Denetim Kapsayıcısı Uygulamasına Denetim Ekleme](inserting-a-control-into-a-control-container-application.md)
##### [ActiveX Denetimi Kapsayıcıları: Bir Üye Değişkenine ActiveX Denetimi Bağlama](activex-control-containers-connecting-an-activex-control-to-a-member-variable.md)
##### [ActiveX Denetimi Kapsayıcıları: ActiveX Denetimindeki Olayları İşleme](activex-control-containers-handling-events-from-an-activex-control.md)
##### [ActiveX Denetimi Kapsayıcıları: Denetim Özelliklerini Görüntüleme ve Değiştirme](activex-control-containers-viewing-and-modifying-control-properties.md)
##### [ActiveX Denetimi Kapsayıcıları: ActiveX Denetimi Kapsayıcısındaki ActiveX Denetimlerini Programlama](programming-activex-controls-in-a-activex-control-container.md)
##### [ActiveX Denetimi Kapsayıcıları: Denetimleri İletişim Kutusu Olmayan Kapsayıcılarda Kullanma](activex-control-containers-using-controls-in-a-non-dialog-container.md)
#### [Test Kapsayıcısı ile Özellikleri ve Olayları Test Etme](testing-properties-and-events-with-test-container.md)
### [Pano](clipboard.md)
#### [Pano: Her Pano Mekanizmasının Kullanılma Zamanı](clipboard-when-to-use-each-clipboard-mechanism.md)
...
#### [Örnek: İletişim Kutusunu Menü Komutu ile Görüntüleme](example-displaying-a-dialog-box-via-a-menu-command.md)
...
#### [İzlenecek yol: Uygulamaya CTaskDialog Ekleme](walkthrough-adding-a-ctaskdialog-to-an-application.md)
...
#### [Nasıl yapılır: Mevcut MFC Şeridini Şerit Kaynağına Dönüştürme](how-to-convert-an-existing-mfc-ribbon-to-a-ribbon-resource.md)
...
#### [Nasıl yapılır: MFC Uygulamasından Şerit Kaynağı Yükleme](how-to-load-a-ribbon-resource-from-an-mfc-application.md)
...
#### [Windows Yuvaları: Arşivler Kullanan Yuvalara Örnek](windows-sockets-example-of-sockets-using-archives.md)
#### [Windows Yuvaları: Yuvaları Arşivlerle Kullanma](windows-sockets-how-sockets-with-archives-work.md)
#### [Windows Yuvaları: CAsyncSocket Sınıfını Kullanma](windows-sockets-using-class-casyncsocket.md)
...
## [TN011: Bir DLL'in Parçası Olarak MFC Kullanma](tn011-using-mfc-as-part-of-a-dll.md)
## [TN014: Özel Denetimler](tn014-custom-controls.md)
## [TN016: MFC'de C++ Birden Çok Devralma Kullanma](tn016-using-cpp-multiple-inheritance-with-mfc.md)
...
## [TN022: Standart Komutlar Uygulama](tn022-standard-commands-implementation.md)
...
## [TN026: DDX ve DDV Yordamları](tn026-ddx-and-ddv-routines.md)
## [TN028: Bağlama Duyarlı Yardım Desteği](tn028-context-sensitive-help-support.md)
## [TN029: Ayırıcı Pencereler](tn029-splitter-windows.md)
...
## [TN035: Visual C++ ile Birden Çok Kaynak Dosya ve Üstbilgi Dosyası Kullanma](tn035-using-multiple-resource-files-and-header-files-with-visual-cpp.md)
## [TN036: CFormView'u AppWizard ve ClassWizard ile Kullanma](tn036-using-cformview-with-appwizard-and-classwizard.md)
## [TN037: Çok İş Parçacıklı MFC 2.1 Uygulamaları](tn037-multithreaded-mfc-2-1-applications.md)
## [TN038: MFC-OLE IUnknown Uygulama](tn038-mfc-ole-iunknown-implementation.md)
## [TN039: MFC-OLE Otomasyonu Uygulama](tn039-mfc-ole-automation-implementation.md)
## [TN040: MFC-OLE Yerinde Yeniden Boyutlandırma ve Yakınlaştırma](tn040-mfc-ole-in-place-resizing-and-zooming.md)
## [TN041: MFC-OLE1'den MFC-OLE 2'ye Geçiş](tn041-mfc-ole1-migration-to-mfc-ole-2.md)
## [TN042: ODBC Sürücüsü Geliştirici Önerileri](tn042-odbc-driver-developer-recommendations.md)
## [TN043: RFX Yordamları](tn043-rfx-routines.md)
## [TN044: DBCS için MFC Desteği](tn044-mfc-support-for-dbcs.md)
## [TN045: Uzun Değişken Karakter-Değişken İkili için MFC-Veritabanı Desteği](tn045-mfc-database-support-for-long-varchar-varbinary.md)
## [TN046: MFC Sınıfları için Yorum Yapma Kuralları](tn046-commenting-conventions-for-the-mfc-classes.md)
## [TN047: Veritabanı İşlem Gereksinimlerini Esnetme](tn047-relaxing-database-transaction-requirements.md)
...
## [TN051: Şimdi ve Gelecekte CTL3D Kullanma](tn051-using-ctl3d-now-and-in-the-future.md)
## [TN053: DAO Veritabanı Sınıfları için Özel DFX Yordamları](tn053-custom-dfx-routines-for-dao-database-classes.md)
## [TN054: MFC DAO Sınıfları Kullanırken DAO'yu Doğrudan Çağırma](tn054-calling-dao-directly-while-using-mfc-dao-classes.md)
...
## [TN056: Yerelleştirilmiş MFC Bileşenlerinin Yüklenmesi](tn056-installation-of-localized-mfc-components.md)
## [TN057: MFC Bileşenlerinin Yerelleştirilmesi](tn057-localization-of-mfc-components.md)
## [TN058: MFC Modül Durumu Uygulama](tn058-mfc-module-state-implementation.md)
## [TN059: MFC MBCS-Unicode Dönüştürme Makroları Kullanma](tn059-using-mfc-mbcs-unicode-conversion-macros.md)
...
## [TN064: ActiveX Denetimlerinde Apartman Modeli İş Parçacığı Oluşturma](tn064-apartment-model-threading-in-activex-controls.md)
## [TN065: OLE Otomasyon Sunucuları için Çift Arabirim Desteği](tn065-dual-interface-support-for-ole-automation-servers.md)
## [TN066: Genel MFC 3.x'ten 4.0'a Taşıma Oluşturma Sorunları](tn066-common-mfc-3-x-to-4-0-porting-issues.md)
## [TN068: Microsoft Access 7 ODBC Sürücüsü ile İşlem Gerçekleştirme](tn068-performing-transactions-with-the-microsoft-access-7-odbc-driver.md)
## [TN070: MFC Pencere Sınıfı Adları](tn070-mfc-window-class-names.md)
## [TN071: MFC IOleCommandTarget Uygulama](tn071-mfc-iolecommandtarget-implementation.md)
...
## [Kök Sınıflar: CObject](root-class-cobject.md)
...
## [İzlenecek yol: MFC Projesine D2D Nesnesi Ekleme](walkthrough-adding-a-d2d-object-to-an-mfc-project.md)
