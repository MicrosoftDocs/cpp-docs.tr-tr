...
5.  İçinde **özellik adı** kutusunun **yazı tipi**.  
...
5.  İçinde **özellik adı** kutusunun **açıklamalı alt yazı**.  
...
7.  İçinde **özellik türü** kutusunda **IDispatch** <strong>\*</strong> özelliğin türü.  
...
###  <a name="_core_processing_font_notifications"></a> Yazı tipi bildirimlerini işleme  
 ...
 ![Birden çok yazı tipi nesne arabirimleri uygulama](../mfc/media/vc373q1.gif "vc373q1")  
