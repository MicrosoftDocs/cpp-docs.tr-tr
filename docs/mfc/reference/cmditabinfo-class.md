...
|STYLE_3D_SCROLLED|Dikdörtgen sekme etiketleri ile 3B stili.  |
|STYLE_FLAT_SHARED_HORZ_SCROLL|Paylaşılan yatay kaydırma çubuklu düz stili.  |
|STYLE_3D_ROUNDED_SCROLL|Yuvarlak sekme etiketleri ile 3B stili.  |
