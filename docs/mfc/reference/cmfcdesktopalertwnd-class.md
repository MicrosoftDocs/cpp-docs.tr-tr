...
2.  Alt iletişim kutusu şablondan kaynakları oluşturun.  
  
3.  Çağrı [CMFCDesktopAlertWnd::Create](#create) iletişim kutusu şablonu ve çalışma zamanı sınıf bilgileri türetilmiş sınıfın bir işaretçisi kaynak Kimliğini kullanıyor.  
  
4.  Bu bildirimleri doğrudan işlemek için barındırılan denetimleri program veya program barındırılan denetimlerden gelen tüm bildirimler işlemek için özel bir iletişim kutusu.  
