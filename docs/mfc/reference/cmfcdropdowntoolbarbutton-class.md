...
|`CMFCDropDownToolbarButton::OnCancelMode`|İşlemek için framework tarafından çağırılır [WM_CANCELMODE](/windows/desktop/winmsg/wm-cancelmode) ileti. (Geçersiz kılmaları `CMCToolBarButton::OnCancelMode`.)|
...
*lpszName*<br/>
[in] Düğmenin varsayılan metin.

*pToolBar*<br/>
[in] Bir işaretçi `CMFCDropDownToolBar` kullanıcı düğmeye bastığında görüntülenen nesne.
...
Aşağıdaki örnek, bir nesne oluşturmak gösterilmiştir `CMFCDropDownToolbarButton` sınıfı. Bu kod parçacığı parçasıdır [Visual Studio gösterim örneği](../../overview/visual-cpp-samples.md).
...
*pWnd*<br/>
[in] Aşağı açılan çerçeve ya da açılan araç çubuğu düğmesini ana pencerenin kullanmak için NULL üst pencere.
...
*bSelected*<br/>
[in] Düğme seçili. Bu parametre TRUE ise düğmesi seçilir. Bu parametre FALSE ise, düğme seçili değilse.
