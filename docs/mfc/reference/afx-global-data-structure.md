---
description: 'Daha fazla bilgi edinin: AFX_GLOBAL_DATA yapısı'
...
|[AFX_GLOBAL_DATA:: GetDirect2dFactory](#getdirect2dfactory)|`ID2D1Factory`Genel verilerde depolanan arabirime yönelik bir işaretçi döndürür. Arabirim başlatılmamışsa, oluşturulur ve Varsayılan parametrelere sahiptir.|
|[AFX_GLOBAL_DATA:: GetHandCursor](#gethandcursor)|Bir el ile benzeyen ve tanımlayıcısı olan önceden tanımlanmış imleci alır `IDC_HAND` .|
...
|[AFX_GLOBAL_DATA:: GetWICFactory](#getwicfactory)|`IWICImagingFactory`Genel verilerde depolanan arabirime yönelik bir işaretçi döndürür. Arabirim başlatılmamışsa, oluşturulur ve Varsayılan parametrelere sahiptir.|
|[AFX_GLOBAL_DATA:: GetWriteFactory](#getwritefactory)|`IDWriteFactory`Genel verilerde depolanan arabirime yönelik bir işaretçi döndürür. Arabirim başlatılmamışsa, oluşturulur ve Varsayılan parametrelere sahiptir.|
|[AFX_GLOBAL_DATA:: InitD2D](#initd2d)|`D2D`, `DirectWrite` Ve `WIC` fabrikaları başlatır. Ana pencere başlatılmadan önce bu yöntemi çağırın.|
...
|[AFX_GLOBAL_DATA:: IsD2DInitialized](#isd2dinitialized)|' Nin başlatılmış olup olmadığını belirler `D2D` .|
...
Yapı içindeki verilerin çoğu `AFX_GLOBAL_DATA` uygulamanız başlatıldığında başlatılır.
...
## <a name="afx_global_datadrawtextonglass"></a><a name="drawtextonglass"></a> AFX_GLOBAL_DATA::D Rawtextoncam
...
## <a name="afx_global_datagetnonclientmetrics"></a><a name="getnonclientmetrics"></a> AFX_GLOBAL_DATA:: Getnonclientmetrikleri
...
## <a name="afx_global_dataisdwmcompositionenabled"></a><a name="isdwmcompositionenabled"></a> AFX_GLOBAL_DATA:: Isdwmkompozisyontionenabled
...
## <a name="afx_global_dataishighcontrastmode"></a><a name="ishighcontrastmode"></a> AFX_GLOBAL_DATA:: ıshighınstmode
...
## <a name="afx_global_dataiswindowslayersupportavailable"></a><a name="iswindowslayersupportavailable"></a> AFX_GLOBAL_DATA:: ıswindowslayersupportavailable
...
TRUE, Framework 'ün 32 bitlik renk simgeleri kullanmasını belirtir; FALSE, daha düşük çözünürlüklü simgeler belirtir. `AFX_GLOBAL_DATA::AFX_GLOBAL_DATA`Oluşturucu bu üyeyı doğru olarak başlatır.
...
DOĞRU, bir sistem yazı tipinin kullanılacağını belirtir; Aksi takdirde, FALSE. `AFX_GLOBAL_DATA::AFX_GLOBAL_DATA`Oluşturucu bu üyeyı false olarak başlatır.
...
## <a name="afx_global_dataresume"></a><a name="resume"></a> AFX_GLOBAL_DATA:: özgeçmişi
...
Genel verilerde arabirime yönelik bir işaretçi oluşturur ve depolar `ITaskBarList` .
...
`ITaskbarList`Görev çubuğu listesi nesnesinin oluşturulması başarılı olursa arabirime yönelik bir işaretçi. Oluşturma başarısız olursa veya geçerli Işletim sistemi Windows 7 ' den azsa NULL olur.

## <a name="afx_global_datagetitaskbarlist3"></a><a name="getitaskbarlist3"></a> AFX_GLOBAL_DATA:: GetITaskbarList3

Genel verilerde arabirime yönelik bir işaretçi oluşturur ve depolar `ITaskBarList3` .
...
`ITaskbarList3`Görev çubuğu listesi nesnesinin oluşturulması başarılı olursa arabirime yönelik bir işaretçi. Oluşturma başarısız olursa veya geçerli Işletim sistemi Windows 7 ' den azsa NULL olur.

## <a name="afx_global_datagetshellautohidebars"></a><a name="getshellautohidebars"></a> AFX_GLOBAL_DATA:: Getshellautohideçubuklarının
...
Ve yöntemleri aracılığıyla elde edilen arabirimleri yayınlar `GetITaskbarList` `GetITaskbarList3` .

```cpp
void ReleaseTaskBarRefs();
```

## <a name="afx_global_datashellcreateitemfromparsingname"></a><a name="shellcreateitemfromparsingname"></a> AFX_GLOBAL_DATA:: Shellcreateıtemfromparsingname
...
*PPV*<br/>
dışı Bu işlev döndüğünde, *riıd* içinde istenen arabirim işaretçisini içerir. Bu genellikle veya olur `IShellItem` `IShellItem2` .
