...
1.  Her ikisinde **Çözüm Gezgini** veya [sınıf görünümü](https://msdn.microsoft.com/8d7430a9-3e33-454c-a9e1-a85e3d2db925), sınıfa eklemek istediğiniz proje adına sağ tıklayın.  
