---
description: 'Daha fazla bilgi edinin: CMFCTabCtrl sınıfı'
...
ms.locfileid: "97306813"
---
# <a name="cmfctabctrl-class"></a>CMFCTabCtrl sınıfı

`CMFCTabCtrl`Sınıfı, bir sekme denetimi için işlevsellik sağlar. Sekme denetimi, üst veya alt tarafında düz veya üç boyutlu sekmeler içeren bir yerleştirilebilir pencere görüntüler. Sekmeler metin ve görüntü görüntüleyebilir ve etkin olduğunda rengi değiştirebilir.
...
|[CMFCTabCtrl:: Calcrectedıt](#calcrectedit)|Belirtilen sekme alanının boyutunu ertetir. (Geçersiz kılmalar `CMFCBaseTabCtrl::CalcRectEdit` .)|
...
|[CMFCTabCtrl:: SetActiveTab](#setactivetab)|Bir sekmeyi etkinleştirir. ( [CMFCBaseTabCtrl:: SetActiveTab](../../mfc/reference/cmfcbasetabctrl-class.md#setactivetab)' i geçersiz kılar.)|
...
Yerleşik denetim çubuğu olarak sekmeli pencerenin nasıl oluşturulacağı hakkında bir örnek için bkz. [CTabbedPane sınıfı](../../mfc/reference/ctabbedpane-class.md). `CMFCTabCtrl`Takma olmayan bir denetim olarak kullanmak için, bir nesne oluşturun `CMFCTabCtrl` ve ardından [CMFCTabCtrl:: Create](#create)' ı çağırın.
...
## <a name="cmfctabctrlautosizewindow"></a><a name="autosizewindow"></a> CMFCTabCtrl:: oto Sizewindow
...
*konumuna*<br/>
'ndaki Sekmelerin konumu. Varsayılan değer LOCATION_BOTTOM. Daha fazla bilgi için bkz. açıklamalar.
...
Aşağıdaki örnek, sınıfında yönteminin nasıl kullanılacağını gösterir `Create` `CMFCTabCtrl` . Bu örnek, [durum toplama örneğinin](../../overview/visual-cpp-samples.md)bir parçasıdır.

[!code-cpp[NVC_MFC_StateCollection#1](../../mfc/reference/codesnippet/cpp/cmfctabctrl-class_1.h)]
[!code-cpp[NVC_MFC_StateCollection#2](../../mfc/reference/codesnippet/cpp/cmfctabctrl-class_3.cpp)]

## <a name="cmfctabctrlcalcrectedit"></a><a name="calcrectedit"></a> CMFCTabCtrl:: Calcrectedıt
...
`CMFCTabCtrl::ResizeMode`Sekme denetiminin nasıl yeniden boyutlandırılabileceğini belirten sabit listesi değerlerinden biri. Olası değerler listesi için [CMFCTabCtrl:: SetResizeMode](#setresizemode) yönteminin açıklamalar bölümüne bakın.
...
Bir kaydırma çubuğu nesnesine bir işaretçi veya sekme denetimi STYLE_FLAT_SHARED_HORZ_SCROLL stili kullanılarak oluşturulmadıysa NULL.

### <a name="remarks"></a>Açıklamalar

Sekme denetiminin katıştırılmış kaydırma çubuğuna erişmek için bu yöntemi kullanın. Yalnızca Tab denetiminin STYLE_FLAT_SHARED_HORZ_SCROLL stili olduğunda bir kaydırma çubuğu nesnesi oluşturulur.
...
## <a name="cmfctabctrlhideinactivewindow"></a><a name="hideinactivewindow"></a> CMFCTabCtrl:: Hideınactivewindow
...
## <a name="cmfctabctrlhidenotabs"></a><a name="hidenotabs"></a> CMFCTabCtrl:: Hinominal sekmeler
...
## <a name="cmfctabctrlisactiveinmditabgroup"></a><a name="isactiveinmditabgroup"></a> CMFCTabCtrl:: Isactiveınmdıtabgroup
...
## <a name="cmfctabctrlisactivetabboldfont"></a><a name="isactivetabboldfont"></a> CMFCTabCtrl:: Isactivetabbold yazı tipi
...
## <a name="cmfctabctrlisdrawframe"></a><a name="isdrawframe"></a> CMFCTabCtrl:: ısdrawframe
...
## <a name="cmfctabctrlisflatframe"></a><a name="isflatframe"></a> CMFCTabCtrl:: ısflatframe
...
## <a name="cmfctabctrlisflattab"></a><a name="isflattab"></a> CMFCTabCtrl:: ısyataytab
...
## <a name="cmfctabctrlisleftrightrounded"></a><a name="isleftrightrounded"></a> CMFCTabCtrl:: Isleftrightroınmet
...
## <a name="cmfctabctrlismditabgroup"></a><a name="ismditabgroup"></a> CMFCTabCtrl:: ısmdıtabgroup
...
## <a name="cmfctabctrlissharedscroll"></a><a name="issharedscroll"></a> CMFCTabCtrl:: ıssharedscroll
...
Bu yöntem, [CMFCTabCtrl:: Create](#create) yönteminin *Style* parametresi STYLE_FLAT_SHARED_HORZ_SCROLL true değerini döndürür.
...
Odak genellikle sekme yerleştirildiğinde ve etkin hale geldiğinde yeni bir sekmeli pencere tarafından alınır. `CMFCTabCtrl::m_bEnableActivate`Özgün odağı sürdürmek için üye DEĞIŞKENINI false olarak ayarlayın. Varsayılan değer TRUE 'dur.
...
Her zaman DROPEFFECT_NONE, bırakma hedefinin verileri kabul edemeyeceği anlamına gelir.
...
## <a name="cmfctabctrlsetactiveinmditabgroup"></a><a name="setactiveinmditabgroup"></a> CMFCTabCtrl:: Setactiveınmdıtabgroup
...
Bu, `AFX_WM_CHANGE_ACTIVE_TAB` bildirimi üst pencereye ve üst öğenin sekme denetiminin çerçevesine gönderir.

`SetActiveTab`Yöntemi, ekranın yanıp sönmesini engellemek Için [CMFCTabCtrl:: HideActiveWindowHorzScrollBar](#hideactivewindowhorzscrollbar) yöntemini otomatik olarak çağırır.

## <a name="cmfctabctrlsetactivetabboldfont"></a><a name="setactivetabboldfont"></a> CMFCTabCtrl:: Setactivetabbold yazı tipi
...
*resizeMode*<br/>
'ndaki `CMFCTabCtrl::ResizeMode` Sekme denetiminin nasıl yeniden boyutlandırılabileceğini belirten sabit listesi değerlerinden biri. Olası değerler listesi için, açıklamalar ' daki tabloya bakın.
