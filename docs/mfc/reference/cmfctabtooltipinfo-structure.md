...
## <a name="remarks"></a>Açıklamalar  
 Bir işaretçi bir `CMFCTabToolTipInfo` yapısı AFX_WM_ON_GET_TAB_TOOLTIP iletisinin parametre olarak geçirilir. Bu ileti MDI sekmeleri etkinleştirilir ve kullanıcı bir sekme denetimi gezinen oluşturulur.  
