...
|AFX_WM_CHECKEMPTYMINIFRAME|Yalnızca iç kullanım içindir.|Uygulanamaz.|Uygulanamaz.|Uygulanamaz.|
...
|AFX_WM_GETDRAGBOUNDS|Yalnızca iç kullanım içindir.|Uygulanamaz.|Uygulanamaz.|Uygulanamaz.|
...
|AFX_WM_ON_CANCELTABMOVE|Yalnızca iç kullanım içindir.|Uygulanamaz.|Uygulanamaz.||
...
|AFX_WM_ON_DRAGCOMPLETE|Yalnızca iç kullanım içindir.|Uygulanamaz.|Uygulanamaz.|Uygulanamaz.|
...
|AFX_WM_ON_MOVETABCOMPLETE|Yalnızca iç kullanım içindir.|Uygulanamaz.|Uygulanamaz.|Uygulanamaz.|
...
|AFX_WM_ON_TABGROUPMOUSEMOVE|Yalnızca iç kullanım içindir.|Uygulanamaz.|Uygulanamaz.|Uygulanamaz.|
