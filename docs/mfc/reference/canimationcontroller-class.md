...
|[CAnimationController::~CAnimationController](#_dtorcanimationcontroller)|Yıkıcı. Animasyon denetleyicisini nesne yok ediliyorken çağırılır.|
