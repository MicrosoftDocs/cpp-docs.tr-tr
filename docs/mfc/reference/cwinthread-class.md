...
*lpSecurityAttrs*<br/>
İşaret eden bir [SECURITY_ATTRIBUTES](/previous-versions/windows/desktop/legacy/aa379560\(v=vs.85\)) iş parçacığı için güvenlik özniteliklerini belirten yapısı.
