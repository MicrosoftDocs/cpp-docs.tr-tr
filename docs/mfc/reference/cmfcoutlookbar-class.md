...
1.  Embed bir `CMFCOutlookBar` ana çerçeve pencere sınıfı nesnesine.  
 ...
 ... };  
 ```  
2.  Ana çerçevede WM_CREATE iletiyi işlerken çağırmak [CMFCOutlookBar::Create](#create) Outlook sekme denetimi çubuğu oluşturmak için yöntemi.  
