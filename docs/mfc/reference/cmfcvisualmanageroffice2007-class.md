...
Aşağıdaki örnek, Office 2007 visual manager'nin nasıl kullanılacağını gösterir. Bu kod parçacığı parçasıdır [Masaüstü uyarı gösterim örneği](../../overview/visual-cpp-samples.md).
