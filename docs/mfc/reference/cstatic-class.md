...
*lpDrawItemStruct*<br/>
Bir işaretçi bir [DRAWITEMSTRUCT](../../mfc/reference/drawitemstruct-structure.md) yapısı. Yapı çizilecek öğesi ve gerekli çizim türü hakkında bilgi içerir.
