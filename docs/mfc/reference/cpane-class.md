...
Öğesinden bir sınıfı türettiğinizde `CPane` , bir [Cdocksitesine](../../mfc/reference/cdocksite-class.md) yerleştirilebilir ve bir [Cbölmesi framewnd](../../mfc/reference/cpaneframewnd-class.md)içinde eklenebilir.
