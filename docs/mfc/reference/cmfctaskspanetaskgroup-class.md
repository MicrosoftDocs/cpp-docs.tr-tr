...
### <a name="parameters"></a>Parametreler  
 [in] *pParent*  
 Geçerli görev grubunun ana pencereyi temsil eder.  
  
 [out] *veri*  
 Bir nesne türü `CAccessibilityData` geçerli görev grubunun erişilebilirlik verilerle doldurulur.  
