...
INT_PTR dönüş değeri gerçekten HRESULT:. Dönüş değerleri bölümüne bakın [PrintDlgEx](/previous-versions/windows/desktop/legacy/ms646942\(v=vs.85\)) Windows SDK.
