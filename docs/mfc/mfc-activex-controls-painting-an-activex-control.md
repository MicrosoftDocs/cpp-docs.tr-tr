...
2.  İçinde **yeni denetimi Ekle** kutusunda, istediğiniz denetimi seçin ve tıklayın **Tamam**.  
  
     Denetim Test kapsayıcısında görünür.  
  
3.  Üzerinde **denetimi** menüsünde tıklatın **çizmek meta**.  
