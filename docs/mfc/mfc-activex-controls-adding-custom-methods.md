...
4.  Kısayol menüsünden tıklayın **Ekle** ve ardından **Ekle yöntemi**.  
...
7.  İçinde **dönüş türü** kutusunun **varıant_bool** yöntemin dönüş türü.  
  
8.  Kullanarak **parametre türü** ve **parametre adı** denetimleri ekleme adlı bir parametreyi *xCoord* (tür *OLE_XPOS_PIXELS*).  
