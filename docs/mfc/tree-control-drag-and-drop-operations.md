---
description: 'Daha fazla bilgi edinin: ağaç denetimi sürükle ve bırak Işlemleri'
...
Bir öğenin bir sürükle ve bırak işleminin hedefi olduğunu, durumu değere ayarlamak için [SetItem](../mfc/reference/ctreectrl-class.md#setitem) üye işlevini çağırarak belirtebilirsiniz `TVIS_DROPHILITED` . Bu duruma sahip bir öğe, sürükle ve bırak hedefini göstermek için kullanılan stilde çizilir.
