...
ms.locfileid: "46424345"
---
# <a name="norm4-class"></a>norm_4 Sınıfı

Dört normal sayıdan oluşan bir kısa vektörü temsil eder.
...
|Ad|Açıklama|
|----------|-----------------|
|[norm_4 Oluşturucusu](#ctor)|Fazla Yüklendi. Varsayılan Oluşturucu tüm öğeleri 0 ile başlatır.|
