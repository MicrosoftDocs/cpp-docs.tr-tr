---
description: 'Hakkında daha fazla bilgi edinin: uint_4 sınıfı'
title: uint_4 Sınıfı
ms.date: 03/27/2019
f1_keywords:
...
ms.locfileid: "97326409"
---
# <a name="uint_4-class"></a>uint_4 Sınıfı

Dört işaretsiz tamsayının kısa vektörünü temsil eder.
