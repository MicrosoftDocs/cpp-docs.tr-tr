...
## <a name="erf"></a><a name="erf"></a> işlevi
...
## <a name="floor"></a><a name="floor"></a> sını
...
## <a name="fmod-function-c-amp"></a><a name="fmod"></a> fmod Işlevi (C++ AMP)
...
*_Iptr*<br/>
dışı `_X`Kayan nokta değeri olarak öğesinin tamsayı kısmı.

### <a name="return-value"></a>Dönüş Değeri

Öğesinin işaretli kesirli kısmı `_X` .
...
*_Iptr*<br/>
`_X`Kayan nokta değeri olarak öğesinin tamsayı kısmı.

### <a name="return-value"></a>Dönüş Değeri

Öğesinin işaretli kesirli kısmını döndürür `_X` .

## <a name="nan"></a><a name="nan"></a> nBir
...
## <a name="remainder"></a><a name="remainder"></a> geri kalanında
...
*_Quo*<br/>
dışı Kesirli bitleri tarafından bölünen kesirli bitlerin bölümünü döndürmek için kullanılan bir tamsayının adresi `_X` `_Y` .

### <a name="return-value"></a>Dönüş Değeri

Kalanı `_X` tarafından bölünen geri kalanını döndürür `_Y` .
...
## <a name="round"></a><a name="round"></a> gidiş
...
Pi _X 'in tanjant değerini döndürür \*
...
[Eşzamanlılık::p recise_math ad alanı](concurrency-precise-math-namespace.md)
