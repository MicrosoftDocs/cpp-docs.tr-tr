...
```  
### <a name="parameters"></a>Parametreler
_Rhs modulus bulmak için göre bölüneceği sayı.
...
### <a name="parameters"></a>Parametreler
_Index 0 ile boyut sayısı eksi 1 arasında bir tamsayı.
...
``` 
### <a name="parameters"></a>Parametreler
_Diğer kopyalamak için dizin nesnesi.
