---
title: "uint_2 sınıfı | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Kısa bir vektör iki imzasız tamsayı değerini temsil eder.  
...
|Ad|Açıklama|  
|----------|-----------------|  
|[uint_2 Constructor](#ctor)|Fazla Yüklendi. Varsayılan Oluşturucu, tüm öğeleri 0 ile başlatır.|  
