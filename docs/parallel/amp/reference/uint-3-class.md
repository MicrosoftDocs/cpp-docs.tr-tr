---
description: 'Hakkında daha fazla bilgi edinin: uint_3 sınıfı'
title: uint_3 Sınıfı
ms.date: 11/04/2016
f1_keywords:
...
ms.locfileid: "97325803"
---
# <a name="uint_3-class"></a>uint_3 Sınıfı

Üç işaretsiz tamsayının kısa vektörünü temsil eder.
...
## <a name="size"></a><a name="uint_3__size"></a> boyutla
