---
description: 'Daha fazla bilgi: Görev Paralelliği (Eşzamanlılık Çalışma Zamanı)'
...
- [Değer tabanlı ve Task-Based devamlılıkları](#value-versus-task)
...
## <a name="value-based-versus-task-based-continuations"></a><a name="value-versus-task"></a> Value-Based ve Task-Based devamlılıkları
