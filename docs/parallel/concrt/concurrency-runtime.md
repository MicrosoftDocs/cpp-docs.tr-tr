...
|[İzlenecek yol: Aracı Tabanlı Uygulama Oluşturma](../../parallel/concrt/walkthrough-creating-an-agent-based-application.md)<br /><br /> [İzlenecek yol: Veri Akış Aracısı Oluşturma](../../parallel/concrt/walkthrough-creating-a-dataflow-agent.md)|Temel aracı tabanlı uygulamalar oluşturma işlemi gösterilmektedir.|
...
|[İzlenecek yol: Özel İleti Bloğu Oluşturma](../../parallel/concrt/walkthrough-creating-a-custom-message-block.md)|Gelen iletileri öncelik sırasına göre sıralayan bir özel ileti bloğu türünün nasıl oluşturulacağını gösterir.|
