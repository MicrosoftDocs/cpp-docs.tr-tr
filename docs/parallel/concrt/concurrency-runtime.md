...
|[Windows Çalışma Zamanı uygulama örnekleri](https://docs.microsoft.com/samples/browse/?languages=cpp&expanded=windows&products=windows-uwp)|Windows Çalışma Zamanı için indirilebilir kod örnekleri ve Tanıtım uygulamaları içerir.|
