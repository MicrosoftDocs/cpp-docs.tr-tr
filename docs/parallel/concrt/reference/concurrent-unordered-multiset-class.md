...
|Ad|Açıklama|
|----------|-----------------|
|[concurrent_unordered_multiset](#ctor)|Fazla Yüklendi. Eşzamanlı olarak sıralı bir çoklu küme oluşturur.|
...
|[ekleyin](#insert)|Fazla Yüklendi. `concurrent_unordered_multiset` nesnesine öğe ekler.|
...
|[unsafe_erase](#unsafe_erase)|Fazla Yüklendi. Belirtilen konumlarda `concurrent_unordered_multiset` öğeleri kaldırır. Bu yöntem eşzamanlılık açısından güvenli değildir.|

### <a name="public-operators"></a>Ortak İşleçler

|Ad|Açıklama|
|----------|-----------------|
|[işleç =](#operator_eq)|Fazla Yüklendi. Başka bir `concurrent_unordered_multiset` nesnesinin içeriğini buna atar. Bu yöntem eşzamanlılık açısından güvenli değildir.|
