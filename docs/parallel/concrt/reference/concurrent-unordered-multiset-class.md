---
description: 'Hakkında daha fazla bilgi edinin: concurrent_unordered_multiset sınıfı'
...
*_Allocator_type*<br/>
Eşzamanlı vektör için bellek ayırma ve ayırmayı kaldırma hakkındaki ayrıntıları kapsülleyen saklı ayırıcı nesnesini temsil eden tür. Bu bağımsız değişken isteğe bağlıdır ve varsayılan değerdir `std::allocator<K>` .
...
|[ekleyin](#insert)|Fazla Yüklendi. Nesneye öğe ekler `concurrent_unordered_multiset` .|
|[key_eq](#key_eq)|Depolanan eşitlik karşılaştırma işlevi nesnesi.|
|[Kur](#swap)|İki nesnenin içeriğini değiştirir `concurrent_unordered_multiset` . Bu yöntem eşzamanlılık açısından güvenli değildir.|
|[unsafe_erase](#unsafe_erase)|Fazla Yüklendi. Belirtilen konumlarda öğeleri kaldırır `concurrent_unordered_multiset` . Bu yöntem eşzamanlılık açısından güvenli değildir.|

### <a name="public-operators"></a>Ortak İşleçler

|Ad|Açıklama|
|----------|-----------------|
|[işleç =](#operator_eq)|Fazla Yüklendi. Başka bir `concurrent_unordered_multiset` nesnenin içeriğini buna atar. Bu yöntem eşzamanlılık açısından güvenli değildir.|

## <a name="remarks"></a>Açıklamalar

Sınıfıyla ilgili ayrıntılı bilgi için `concurrent_unordered_multiset` bkz. [paralel kapsayıcılar ve nesneler](../../../parallel/concrt/parallel-containers-and-objects.md).
...
*soyadına*<br/>
*_Uset*<br/>
`concurrent_unordered_multiset`Öğelerin taşınacağı kaynak nesne.

### <a name="remarks"></a>Açıklamalar

Tüm oluşturucular bir ayırıcı nesnesi depolar `_Allocator` ve sıralanmamış çoklu küme 'yi başlatır.
...
Dördüncü ve beşinci oluşturucular, eşzamanlı sıralanmamış çoklu küme 'nin bir kopyasını belirtir `_Uset` .

Son Oluşturucu, eşzamanlı sıralanmamış çoklu kümeli bir taşıma belirtir `_Uset` .
...
Nesneye öğe ekler `concurrent_unordered_multiset` .
...
Başka bir `concurrent_unordered_multiset` nesnenin içeriğini buna atar. Bu yöntem eşzamanlılık açısından güvenli değildir.
...
Bu nesneye bir başvuru `concurrent_unordered_multiset` .

### <a name="remarks"></a>Açıklamalar

Eş zamanlı sıralanmamış bir çoklu kümeli mevcut öğeleri sildikten sonra, `operator=` içeriğini kopyalar veya `_Uset` eşzamanlı sıralanmamış çoklu küme içine taşısın.
...
İki nesnenin içeriğini değiştirir `concurrent_unordered_multiset` . Bu yöntem eşzamanlılık açısından güvenli değildir.
...
*_Uset*<br/>
`concurrent_unordered_multiset`İle takas edilecek nesne.
...
Belirtilen konumlarda öğeleri kaldırır `concurrent_unordered_multiset` . Bu yöntem eşzamanlılık açısından güvenli değildir.
