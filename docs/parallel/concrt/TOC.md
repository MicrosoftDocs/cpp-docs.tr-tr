...
### [Nasıl yapılır: Paralel Sıralama Yordamı Yazmak için parallel_invoke Kullanma](how-to-use-parallel-invoke-to-write-a-parallel-sort-routine.md)
...
### [Nasıl yapılır: Gecikmeden Sonra Tamamlanan Bir Görev Oluşturma](how-to-create-a-task-that-completes-after-a-delay.md)
## [Paralel Algoritmalar](parallel-algorithms.md)
### [Nasıl yapılır: parallel_for Döngüsü Yazma](how-to-write-a-parallel-for-loop.md)
### [Nasıl yapılır: parallel_for Döngüsü Yazma](how-to-write-a-parallel-for-each-loop.md)
...
### [Nasıl yapılır: Etkinliği Artırmak için Paralel Kapsayıcılar Kullanma](how-to-use-parallel-containers-to-increase-efficiency.md)
### [Nasıl yapılır: Performansı Geliştirmek için combinable Kullanma](how-to-use-combinable-to-improve-performance.md)
...
### [Nasıl yapılır: Paralel Döngüden Kurtulmak için İptal Kullanma](how-to-use-cancellation-to-break-from-a-parallel-loop.md)
### [Nasıl yapılır: Paralel Döngüden Kurtulmak için Özel Durum İşlemeyi Kullanma](how-to-use-exception-handling-to-break-from-a-parallel-loop.md)
...
### [Nasıl yapılır: Bağlam Sınıfını İşbirliğine Dayalı Semafor Uygulamak için Kullanma](how-to-use-the-context-class-to-implement-a-cooperative-semaphore.md)
...
## [İzlenecek yol: Aracı Tabanlı Uygulama Oluşturma](walkthrough-creating-an-agent-based-application.md)
## [İzlenecek yol: Veri Akış Aracısı Oluşturma](walkthrough-creating-a-dataflow-agent.md)
...
## [İzlenecek yol: Özel İleti Bloğu Oluşturma](walkthrough-creating-a-custom-message-block.md)
