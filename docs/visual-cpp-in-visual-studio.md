...
[Windows çalışma zamanı Şablon kitaplığı (WRL)](http://msdn.microsoft.com/library/windows/apps/hh438466.aspx)<br/>
...
[Visual C++ öğrenin](http://msdn.microsoft.com/vstudio/hh386302.aspx)<br/>
