...
1. Çözüm Gezgini görünür değilse **Çözüm Gezgini** üzerinde **görünümü** menüsü.

1. Yeni bir kaynak dosyası projeye ekleyin:

   - Sağ **kaynak dosyaları** klasör Çözüm Gezgini'nde işaret **Ekle** tıklatıp **yeni öğe**.

   - Tıklayın **C++ dosyası (.cpp)** ve bir dosya adı yazın ve ardından **Ekle**.

   **.Cpp** dosya görünür **kaynak dosyaları** klasör Çözüm Gezgini'nde ve sekmeli pencere görünür, kod yazdığınız yerdir, bu dosyada istediğiniz.
...
9. Programı çalıştırdığınızda örnek programı kullandıysanız bir metin dosyasının oluşturulduğunu belirten bir komut penceresi görüntülenir. Komut penceresini kapatmak için herhangi bir tuşa basın.
