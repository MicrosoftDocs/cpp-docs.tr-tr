...
Bu izlenecek yollar tamamladığınızda, kendi projenizi oluşturmaya başlamak hazırsınız. Daha fazla bilgi ve kaynaklar için Visual C++ geliştirme için bkz. [Visual Studio'da Visual C++](../overview/visual-cpp-in-visual-studio.md).
