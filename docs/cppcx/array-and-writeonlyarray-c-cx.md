...
4.  dönüş değeri Platform::Array ^  
 ...
 PassArray  
 Arayan bir dizi yönteme başarılı olduğunda kullanılır. C++ giriş parametre türü hatalı `const` [Platform::Array](../cppcx/platform-array-class.md)\<T >.  
  
 FillArray  
 Fill yöntemi için bir dizi çağırana başarılı olduğunda kullanılır. C++ giriş parametre türü hatalı [Platform::WriteOnlyArray](../cppcx/platform-writeonlyarray-class.md)\<T >.  
  
 ReceiveArray  
 Arayan yöntemi ayıran bir dizi aldığında kullanılır. C + +/ CX dönüş değeri olarak bir dizi içinde dizi dönebilirsiniz ^ veya, bunu bir out parametresi dizi türü olarak dönebilirsiniz ^ *.  
