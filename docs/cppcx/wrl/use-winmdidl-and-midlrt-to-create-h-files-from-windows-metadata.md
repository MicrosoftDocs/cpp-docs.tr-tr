...
Bu araçlar yalnızca Custom. winmd dosyalarını ayrıştırmak için gereklidir. Windows işletim sistemi bileşenleri için. IDL ve. h dosyaları zaten sizin için oluşturulmuştur. Varsayılan olarak Windows 8.1, \Program Files (x86) \Windows Kits\8.1\ınclude\wınrt\\konumundadır.

## <a name="location-of-the-tools"></a>Araçların konumu

[Windows 8.1, winmdıdl. exe ve MIDLRT. exe ' de varsayılan olarak C:\Program Files (x86) \Windows Kits\8.1\\konumundadır. Araçların sürümleri, \bin\x86\ ve \bin\x64\ klasörlerinde de mevcuttur.
