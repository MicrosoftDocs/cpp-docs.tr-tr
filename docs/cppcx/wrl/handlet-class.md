...
*HandleTraits*<br/>
Örneği [HandleTraits](handletraits-structure.md) ortak bir tanıtıcı özelliklerini tanımlayan bir yapıda.
...
**doğru** varsa `HandleT` temsil eden bir işleyici; Aksi takdirde **false**.
