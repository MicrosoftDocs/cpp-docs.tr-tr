...
Ad                                          | Açıklama
--------------------------------------------- | ------------------------------------------------------------------------------------------------------
[CreatorMap::activationId](#activationid)     | Bir klasik COM sınıfı kimliği veya bir Windows çalışma zamanı adı tanımlanmış bir nesne kimliği temsil eder.
...
*currentflags*<br/>
Aşağıdakilerden birini [RuntimeClassType](runtimeclasstype-enumeration.md) numaralandırıcılar.
