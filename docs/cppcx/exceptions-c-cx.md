...
|FailureException|E\_BAŞARISIZ|Bir işlem başarısız olduğunda oluşturulur.|
...
|NullReferenceException|E\_İŞARETÇİ|XML'deki bir null Nesne başvuru kaynağı girişimi olduğunda oluşturulur.|
