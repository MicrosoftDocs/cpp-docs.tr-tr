...
description: C++ Build Insights SDK 'Sı EVENT_ID enum başvurusu.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
`EVENT_ID`Sabit listesi.

## <a name="members"></a>Üyeler

| Ad | Değer | Olay ayrıntıları URL 'SI |
|--|--|--|
...
| `EVENT_ID_FUNCTION` | 15 (0x000000F) | [ÇALıŞMAYACAKTıR](../event-table.md#function) |
